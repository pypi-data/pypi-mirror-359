...
class IterativeRecon(Recon):
    ...
    def _iterativeReconPython(self,withTumor):
        SMatrix = np.zeros((self.experiment.AcousticFields.field.shape[0], self.experiment.AcousticFields.shape[1], self.experiment.AcousticFields.shape[2],len(self.experiment.AcousticFields)))
