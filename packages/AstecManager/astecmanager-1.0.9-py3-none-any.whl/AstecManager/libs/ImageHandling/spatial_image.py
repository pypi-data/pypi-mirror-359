...
def random_vector_field_like(spatial_image, smooth=0, max_=1):
    ...
    :param spatial_image: 
    :param smooth:  (Default value = 0)
    :param max_:  (Default value = 1)
...
def checkerboard(nx=9, ny=8, nz=5, size=10, vs=(1.,1.,1.), dtype=np.uint8):
    ...
    :param nx:  (Default value = 9)
    :param ny:  (Default value = 8)
    :param nz:  (Default value = 5)
    :param size:  (Default value = 10)
    :param vs:  (Default value = (1.)
    :param 1.: 
    :param 1.): 
    :param dtype:  (Default value = np.uint8)
