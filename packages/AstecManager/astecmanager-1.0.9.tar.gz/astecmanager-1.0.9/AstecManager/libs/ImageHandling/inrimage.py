...
def write_inrimage_to_stream(stream, img,voxel_size=(1,1,1)):
    """
    ...
    info["VX"],info["VY"],info["VZ"] = ("%f" % val for val in voxel_size)
...
def write_inrimage (filename, img,voxel_size=(1,1,1)) :
    ...
    try:
        write_inrimage_to_stream(f, img,voxel_size=voxel_size)
    except:
