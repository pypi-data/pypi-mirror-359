from dataflow.Eval.Text import DeitaComplexityScorer
from dataflow.core import TextFilter
import numpy as np
from dataflow.utils.registry import PROCESSOR_REGISTRY

@PROCESSOR_REGISTRY.register()
class DeitaComplexityFilter(TextFilter):
    def __init__(self, args_dict: dict):
        ...
        self.scorer = DeitaComplexityScorer(scorer_args)
        self.filter_name = 'DeitaComplexityFilter'
