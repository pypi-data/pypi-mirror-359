from dataflow.Eval.Text import PerspectiveScorer
from dataflow.core import TextFilter
import numpy as np
from dataflow.utils.registry import PROCESSOR_REGISTRY

@PROCESSOR_REGISTRY.register()
class PerspectiveFilter(TextFilter):
    def __init__(self, args_dict: dict):
        ...
        self.scorer = PerspectiveScorer(scorer_args)
        self.filter_name = 'PerspectiveFilter'
