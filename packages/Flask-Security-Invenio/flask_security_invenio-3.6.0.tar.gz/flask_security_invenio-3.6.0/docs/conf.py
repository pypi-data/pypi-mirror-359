...
project = "Flask-Security-Invenio"
...
latex_documents = [
    (
        "index",
        "Flask-Security-Invenio.tex",
        "Flask-Security-Invenio Documentation",
        "Matt Wright",
        "manual",
    ),
]
...
man_pages = [
    ("index", "flask-security", "Flask-Security Documentation", ["Matt Wright"], 1)
]
