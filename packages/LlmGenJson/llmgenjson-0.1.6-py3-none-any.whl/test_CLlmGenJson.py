...
def mainClassOne():
    ...
    # _NaturalLanguageToJson('识别定时任务时间参数', '每天早八点晚五点获取天气预报')
    # _NaturalLanguageToJson('识别定时任务时间参数', '每周一8点半,11点四十五，17点获取天气预报')
    _NaturalLanguageToJson('识别定时任务时间参数', '每周一8:30,11:45,17:00获取天气预报')
    # _NaturalLanguageToJson('识别定时任务时间参数', '在6月17日9月15日上午10点下午5点获取天气预报')
    # _NaturalLanguageToJson('识别定时任务时间参数', '每月8日、18日、28日下午五点获取新闻列表')
    # _NaturalLanguageToJson('识别定时任务时间参数', '周五每5小时获取天气预报')
