...
from pygments_tldr.modeline import get_filetype_from_buffer
from pygments_tldr.plugin import find_plugin_lexers
from pygments_tldr.util import ClassNotFound, guess_decode
