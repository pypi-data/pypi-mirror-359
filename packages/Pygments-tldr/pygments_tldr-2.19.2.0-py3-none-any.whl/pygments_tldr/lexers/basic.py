...
from pygments_tldr.lexer import RegexLexer, bygroups, default, words, include
from pygments_tldr.token import Comment, Error, Keyword, Name, Number, \
    Punctuation, Operator, String, Text, Whitespace
from pygments_tldr.lexers import _vbscript_builtins
