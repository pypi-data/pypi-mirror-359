...
from pygments_tldr.lexer import Lexer, RegexLexer, bygroups, do_insertions, \
    words, include
from pygments_tldr.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Generic, Whitespace
from pygments_tldr.util import shebang_matches
from pygments_tldr.lexers._julia_builtins import OPERATORS_LIST, DOTTED_OPERATORS_LIST, \
