...
from pygments_tldr.lexer import RegexLexer, include, bygroups, using, this, words, \
    inherit, default
from pygments_tldr.token import Text, Keyword, Name, String, Operator, \
...
def objective(baselexer):
    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        def get_tokens_unprocessed(self, text, stack=('root',)):
            from pygments_tldr.lexers._cocoa_builtins import COCOA_INTERFACES, \
