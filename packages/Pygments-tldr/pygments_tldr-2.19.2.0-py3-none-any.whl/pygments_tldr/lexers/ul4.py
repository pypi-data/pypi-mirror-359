...
from pygments_tldr.lexer import RegexLexer, DelegatingLexer, bygroups, words, include
from pygments_tldr.token import Comment, Text, Keyword, String, Number, Literal, \
    Name, Other, Operator
from pygments_tldr.lexers.web import HtmlLexer, XmlLexer, CssLexer, JavascriptLexer
