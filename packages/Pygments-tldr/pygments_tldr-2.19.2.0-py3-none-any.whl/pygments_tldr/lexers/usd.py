...
from pygments_tldr.lexer import RegexLexer, bygroups
from pygments_tldr.lexer import words as words_
from pygments_tldr.lexers._usd_builtins import COMMON_ATTRIBUTES, KEYWORDS, \
    OPERATORS, SPECIAL_NAMES, TYPES
from pygments_tldr.token import Comment, Keyword, Name, Number, Operator, \
