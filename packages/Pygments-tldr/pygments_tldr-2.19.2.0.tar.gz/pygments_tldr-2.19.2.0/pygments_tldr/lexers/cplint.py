...
from pygments_tldr.lexer import bygroups, inherit, words
from pygments_tldr.lexers import PrologLexer
from pygments_tldr.token import Operator, Keyword, Name, String, Punctuation
