...
from pygments_tldr.lexer import RegexLexer, DelegatingLexer, bygroups
from pygments_tldr.lexers.mime import MIMELexer
from pygments_tldr.token import Text, Keyword, Name, String, Number, Comment
