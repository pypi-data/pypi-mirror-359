...
from pygments_tldr.lexers import guess_lexer, get_lexer_by_name
from pygments_tldr.lexer import RegexLexer, bygroups, default, include
...
class HttpLexer(RegexLexer):
    ...
    def content_callback(self, match):
        ...
        offset = match.start()
        if content_type:
            from pygments_tldr.lexers import get_lexer_for_mimetype
