...
from pygments_tldr.lexer import ExtendedRegexLexer, words, default, include, bygroups
from pygments_tldr.token import Comment, Error, Keyword, Literal, Name, Number, \
