...
from pygments_tldr.lexer import RegexLexer, DelegatingLexer, bygroups, include, \
    using, this, default, words
from pygments_tldr.token import Punctuation, Text, Comment, Operator, Keyword, \
    Name, String, Number, Literal, Other, Whitespace
from pygments_tldr.util import get_choice_opt
