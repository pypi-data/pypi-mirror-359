...
from pygments_tldr.lexer import RegexLexer, words, include, bygroups, using, \
    this, default
from pygments_tldr.token import Text, Comment, Operator, Keyword, Name, \
...
class AsymptoteLexer(RegexLexer):
    ...
    def get_tokens_unprocessed(self, text):
        from pygments_tldr.lexers._asy_builtins import ASYFUNCNAME, ASYVARNAME
