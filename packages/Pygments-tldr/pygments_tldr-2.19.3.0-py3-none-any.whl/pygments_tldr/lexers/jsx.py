...
from pygments_tldr.lexer import bygroups, default, include, inherit
from pygments_tldr.lexers.javascript import JavascriptLexer, TypeScriptLexer
from pygments_tldr.token import Name, Operator, Punctuation, String, Text, \
    Whitespace
