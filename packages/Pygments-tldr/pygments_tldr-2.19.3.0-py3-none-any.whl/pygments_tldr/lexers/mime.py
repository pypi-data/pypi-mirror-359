...
from pygments_tldr.lexer import RegexLexer, include
from pygments_tldr.lexers import get_lexer_for_mimetype
from pygments_tldr.token import Text, Name, String, Operator, Comment, Other
from pygments_tldr.util import get_int_opt, ClassNotFound
