...
from pygments_tldr.lexer import RegexLexer, bygroups, words, include
from pygments_tldr.token import Text, Comment, Punctuation, Operator, Keyword, Name, Number, Whitespace, Literal, String
