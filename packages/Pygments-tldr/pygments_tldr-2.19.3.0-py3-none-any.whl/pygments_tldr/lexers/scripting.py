...
from pygments_tldr.lexer import RegexLexer, include, bygroups, default, combined, \
    words
from pygments_tldr.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Error, Whitespace, Other
from pygments_tldr.util import get_bool_opt, get_list_opt
...
def all_lua_builtins():
    from pygments_tldr.lexers._lua_builtins import MODULES
...
class LuauLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.include_luau_builtins:
            from pygments_tldr.lexers._luau_builtins import LUAU_BUILTINS
            self._builtins.update(LUAU_BUILTINS)
        if self.include_roblox_builtins:
            from pygments_tldr.lexers._luau_builtins import ROBLOX_BUILTINS
