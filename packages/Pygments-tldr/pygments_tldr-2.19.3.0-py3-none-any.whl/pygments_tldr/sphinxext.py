...
class PygmentsDoc(Directive):
    ...
    def document_lexers_overview(self):
        ...
        from pygments_tldr.lexers._mapping import LEXERS
        ...
        for classname, data in sorted(LEXERS.items(), key=lambda x: x[1][1].lower()):
            lexer_cls = pygments_tldr.lexers.find_lexer_class(data[1])
    ...
    def document_lexers(self):
        ...
        for classname, data in sorted(LEXERS.items(), key=lambda x: x[0]):
            ...
            if example_file:
                p = pathlib.Path(inspect.getabsfile(pygments_tldr)).parent.parent /\
    ...
    def document_formatters(self):
        from pygments_tldr.formatters import FORMATTERS
    ...
    def document_filters(self):
        from pygments_tldr.filters import FILTERS
