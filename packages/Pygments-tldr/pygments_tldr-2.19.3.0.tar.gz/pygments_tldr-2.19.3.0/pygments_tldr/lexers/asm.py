...
from pygments_tldr.lexer import RegexLexer, include, bygroups, using, words, \
    DelegatingLexer, default
from pygments_tldr.lexers.c_cpp import CppLexer, CLexer
from pygments_tldr.lexers.d import DLexer
from pygments_tldr.token import Text, Name, Number, String, Comment, Punctuation, \
