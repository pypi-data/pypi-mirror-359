...
from pygments_tldr.lexer import RegexLexer, bygroups, default, include, using, words
from pygments_tldr.token import Comment, Error, Keyword, Name, Number, Operator, Punctuation, \
    String, Text, Whitespace
from pygments_tldr.lexers._csound_builtins import OPCODES, DEPRECATED_OPCODES, REMOVED_OPCODES
from pygments_tldr.lexers.html import HtmlLexer
from pygments_tldr.lexers.python import PythonLexer
from pygments_tldr.lexers.scripting import LuaLexer
