...
from pygments_tldr.lexer import ExtendedRegexLexer, RegexLexer, include, bygroups, \
    default, words, inherit
from pygments_tldr.token import Comment, Operator, Keyword, Name, String, Number, \
    Punctuation, Whitespace
from pygments_tldr.lexers._css_builtins import _css_properties
