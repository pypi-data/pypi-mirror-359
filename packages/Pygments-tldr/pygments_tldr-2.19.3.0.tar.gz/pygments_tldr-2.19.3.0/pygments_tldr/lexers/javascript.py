...
from pygments_tldr.lexer import bygroups, combined, default, do_insertions, include, \
...
from pygments_tldr.util import get_bool_opt
import pygments_tldr.unistring as uni
...
class LassoLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.builtinshighlighting:
            from pygments_tldr.lexers._lasso_builtins import BUILTINS, MEMBERS
