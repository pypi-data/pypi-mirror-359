...
from pygments_tldr.lexer import RegexLexer, include, bygroups, words, default
...
from pygments_tldr.lexers._scheme_builtins import scheme_keywords, scheme_builtins
...
class CommonLispLexer(RegexLexer):
    ...
    def __init__(self, **options):
        from pygments_tldr.lexers._cl_builtins import BUILTIN_FUNCTIONS, \
