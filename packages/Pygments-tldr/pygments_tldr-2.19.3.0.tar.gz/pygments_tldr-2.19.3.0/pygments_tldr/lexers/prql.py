...
from pygments_tldr.lexer import RegexLexer, combined, words, include, bygroups
from pygments_tldr.token import Comment, Literal, Keyword, Name, Number, Operator, \
