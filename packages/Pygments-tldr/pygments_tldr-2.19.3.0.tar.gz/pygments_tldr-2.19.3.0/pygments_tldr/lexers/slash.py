...
from pygments_tldr.lexer import ExtendedRegexLexer, bygroups, DelegatingLexer
from pygments_tldr.token import Name, Number, String, Comment, Punctuation, \
...
class SlashLexer(DelegatingLexer):
    ...
    def __init__(self, **options):
        from pygments_tldr.lexers.web import HtmlLexer
