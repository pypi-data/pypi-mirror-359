...
import re
from pygments_tldr.lexer import RegexLexer, default, include, words
from pygments_tldr.token import Comment, Keyword, Name, Number, \
    String, Text, Operator

from pygments_tldr.lexers._stata_builtins import builtins_base, builtins_functions
