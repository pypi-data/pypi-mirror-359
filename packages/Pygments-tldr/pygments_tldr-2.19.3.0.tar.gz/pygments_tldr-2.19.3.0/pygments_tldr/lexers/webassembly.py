...
from pygments_tldr.lexer import RegexLexer, words, bygroups, default
from pygments_tldr.token import Text, Comment, Operator, Keyword, String, Number, Punctuation, Name
