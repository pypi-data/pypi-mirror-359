...
class ImageProcessorApp(QWidget):
    ...
    def init_right_panel(self):
        ...
        self.original_widget = FitAndCrop(self.processed_widget, 700, 700, filter_200_button=self.filter_200_button, filter_150_button=self.filter_150_button)
    ...
    def run_auto_dl_process(self):
        ...
        if not self.model_path:
            print("Aucun modèle sélectionné. Annulation.")
            return
        ...
        mask = self.ellipse_predictor.predict_mask(img)

        # ✏️ Fit et warp
        result_img = self.ellipse_predictor.fit_and_warp(orig_img, mask)
