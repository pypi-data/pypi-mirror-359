...
- **🤖 Comprehensive Algorithm Collection**: Integrates 21 detection algorithms and supports 15 widely-used datasets, with continuous updates to include emerging methods
...
- **PromptSED**: An evolving, topic-enhanced social event detection framework that dynamically integrates topic information from social streams without manual labeling. By combining prompt learning with selective topic injection, PromptSED achieves superior performance in incremental and real-time event detection, setting new benchmarks.
- **DAMe**: Personalized Federated Social Event Detection with Dual Aggregation Mechanism introduces a novel federated learning framework incorporating local aggregation through Bayesian optimization and global aggregation based on structural entropy. DAMe enhances model performance by preserving local characteristics while integrating external knowledge, achieving robustness against injection attacks.
...
| PromptSED | 2025 | PLMs | Online | Supervised | [Yu2025promptsed](https://ssrn.com/abstract=5120706) |
| DAMe | 2024 | GNNs | Online | Supervised | [Yu2024dame](https://dblp.org/rec/journals/corr/abs-2409-00614) |
