...
class Git:
    ...
    def parse_version(self, vstring: str | None = None) -> str:
        ...
        if not vstring or vstring == "release":
    ...
    def archive(self, version: str, outpath: Path) -> bool:
        ...
        cmd = ["git", "archive", f"--prefix=src/", version, "--output", str(zip_path)]
    ...
    def parse_version(self, vstring: str | None = None) -> str:
        ...
        try:
            ...
            if isinstance(self.strategy, Git):
                ...
                fallback = FileSystemArchiver(project_root, exclude_patterns)
                try:
