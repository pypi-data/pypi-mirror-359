...
class ProjectInitializer:
    ...
    def init_project(self, interactive: bool = True) -> None:
        ...
        print("🚀 Run 'uv run aadt build' to build your add-on")
...
def show_about() -> None:
    ...
    showInfo(
        ...
        f"<p>This is a template add-on created with aadt.</p>"
...
An Anki add-on created with [Anki Add-on Builder (aadt)](https://github.com/glutanimate/anki-addon-builder).
...
This project uses aadt for building and development.
