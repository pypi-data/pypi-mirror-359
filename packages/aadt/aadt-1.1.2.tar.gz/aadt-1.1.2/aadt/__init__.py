"""
Anki Add-on Development Tools (AADT)
...
try:
    ...
    # Python < 3.8 fallback
    import importlib_metadata as pkg_metadata  # type: ignore[no-redef]
    ...
    try:
        ...
        return {
            ...
            "description": package_metadata.get(
                "Summary", "Anki Add-on Development Tools"
            ),
        ...
        return {
            "name": "aadt",
            "version": "1.0.0",
            "description": "Anki Add-on Development Tools",
...
__title__ = _metadata.get("description", "Anki Add-on Development Tools")
...
PATH_DIST = PATH_PROJECT_ROOT / "build" / "dist"  # Build output directory
