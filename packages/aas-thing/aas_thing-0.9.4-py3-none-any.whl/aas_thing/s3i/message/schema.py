                                            ...
                                            "items": {
                                                ...
                                                "properties": {
                                                    ...
                                                    "value": {
                                                        "type": "string",
                                                        "enum": [
                                                            "https://admin-shell.io/aas/API/InvokeOperationSync/inputArgument/3/0",
                                                            "https://admin-shell.io/aas/API/InvokeOperationAsync/inputArgument/3/0",
                                                        ],
                                                    },
                                                },
                                                "required": ["type", "value"],
