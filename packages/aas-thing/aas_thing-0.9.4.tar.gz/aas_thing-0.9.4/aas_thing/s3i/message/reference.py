...
class I40MessageGlobalReferenceValues:
    ...
    invoke_operation_sync_input_argument = "https://admin-shell.io/aas/API/InvokeOperationSync/inputArgument/3/0"
    invoke_operation_async_input_argument = "https://admin-shell.io/aas/API/InvokeOperationAsync/inputArgument/3/0"
    ...
    invoke_operation_sync_output_argument = "https://admin-shell.io/aas/API/InvokeOperationSync/ouputArgument/3/0"
    invoke_operation_async_output_argument = "https://admin-shell.io/aas/API/InvokeOperationAsync/ouputArgument/3/0"
...
class I40MessageGlobalReferenceKeys:
    ...
    invoke_operation_sync_input_argument = Key(type_=KeyTypes.GLOBAL_REFERENCE,
                                               value=I40MessageGlobalReferenceValues.invoke_operation_sync_input_argument)

    invoke_operation_async_input_argument = Key(type_=KeyTypes.GLOBAL_REFERENCE,
                                                value=I40MessageGlobalReferenceValues.invoke_operation_async_input_argument)
    ...
    invoke_operation_sync_output_argument = Key(type_=KeyTypes.GLOBAL_REFERENCE,
                                                value=I40MessageGlobalReferenceValues.invoke_operation_sync_output_argument)

    invoke_operation_async_output_argument = Key(type_=KeyTypes.GLOBAL_REFERENCE,
                                                 value=I40MessageGlobalReferenceValues.invoke_operation_async_output_argument)
...
class I40MessageSemanticProtocols:
    ...
    invoke_operation_sync_request_input_argument = ExternalReference(key=(I40MessageGlobalReferenceKeys.invoke_operation_sync_input_argument,))
    invoke_operation_async_request_input_argument = ExternalReference(key=(I40MessageGlobalReferenceKeys.invoke_operation_async_input_argument,))
    ...
    invoke_operation_sync_output_argument = ExternalReference(key=(I40MessageGlobalReferenceKeys.invoke_operation_sync_output_argument,))
    invoke_operation_async_output_argument = ExternalReference(key=(I40MessageGlobalReferenceKeys.invoke_operation_async_output_argument,))
