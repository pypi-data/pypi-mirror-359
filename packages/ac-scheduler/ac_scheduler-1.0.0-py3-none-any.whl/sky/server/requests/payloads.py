...
class GrantClusterAccessBody(RequestBody):
    """The request body for granting cluster access."""
    cluster_name: str
...
class RevokeClusterAccessBody(RequestBody):
    """The request body for revoking cluster access."""
    grant_id: str


class ClusterGrantsBody(RequestBody):
    """The request body for getting cluster grants."""
    cluster_name: str
