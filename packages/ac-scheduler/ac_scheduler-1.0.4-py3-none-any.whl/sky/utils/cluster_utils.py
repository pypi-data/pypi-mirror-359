...
class SSHConfigHelper(object):
    ...
    def add_cluster(
        ...
        node_specific_proxy_commands = auth_config.get(
            'node_specific_proxy_commands', None)
        ...
        for i, ip in enumerate(ips):
            ...
            # Use node-specific proxy command if available
            if node_specific_proxy_commands and i < len(
                    node_specific_proxy_commands):
                node_proxy_command = node_specific_proxy_commands[i]
            else:
                node_proxy_command = proxy_command
            ...
            codegen += cls._get_generated_config(
                ...
                node_proxy_command, port, docker_proxy_command) + '\n'
