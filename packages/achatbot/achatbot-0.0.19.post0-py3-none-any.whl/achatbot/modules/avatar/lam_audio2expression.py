...
from achatbot.common.types import RESOURCES_DIR, MODELS_DIR, ASSETS_DIR
from achatbot.common.factory import EngineClass
from achatbot.modules.avatar.interface import IFaceAvatar
from achatbot.types.avatar.lam_audio2expression import LAMAudio2ExpressionAvatarArgs
...
try:
    ...
    import torch
    from achatbot.LAM_Audio2Expression.engines.defaults import (
        default_config_parser,
        default_setup,
    )
    from achatbot.LAM_Audio2Expression.engines.infer import (
        INFER,
