...
class DefaultExecutorConfig(ConfigModel):
    ...
    executor_instance_id: Optional[str]
...
class DefaultExecutor(Executor):
    ...
    def execute_task(
        ...
        if self._config.executor_instance_id is not None:
            identity_message = f"Task claimed by executor instance {self._config.executor_instance_id}"
            if self._config.executor_version is not None:
                identity_message = f"{identity_message}; version = {self._config.executor_version}"
