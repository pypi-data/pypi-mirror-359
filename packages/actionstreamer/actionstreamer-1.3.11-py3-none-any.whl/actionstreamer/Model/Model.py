...
class MultiplexStopRecordingArgs:
    ...
    def __init__(self, deviceID: int = 0, **kwargs):
...
class MultiplexConferenceArgs:
    ...
    def __init__(self, url: str, roomName: str, displayName: str, videoWidth: int = 1280, videoHeight: int = 720, framerate: float = 30, videoBitrate: int = 1000000, sendVideo: bool = True, sendAudio: bool = True, receiveVideo: bool = True, receiveAudio: bool = True, rotationDegrees: int = 0, returnAudioIPAddress: str = '', returnAudioPort:int = 0, deviceID: int = 0, **kwargs):
        self.url = url
        self.roomName = roomName
        self.displayName = displayName
        self.videoHeight = videoHeight
        ...
        self.receiveAudio = receiveAudio
        self.rotationDegrees = rotationDegrees
        self.returnAudioIPAddress = returnAudioIPAddress
        self.returnAudioPort = returnAudioPort
        self.deviceID = deviceID
        # Store or ignore unknown fields
        self.extra_fields = kwargs  # Optionally, store unknown fields for debugging or logging
