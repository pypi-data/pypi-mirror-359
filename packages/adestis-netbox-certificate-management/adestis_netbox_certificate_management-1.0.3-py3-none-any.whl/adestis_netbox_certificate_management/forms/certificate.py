...
class CertificateCSVForm(NetBoxModelImportForm):
    ...
    class Meta:
        model = Certificate
        fields = ['status', 'name', 'valid_from', 'valid_to', 'contact_group', 'supplier_product', 'subject', 'subject_alternative_name', 'key_technology', 'predecessor_certificate', 'successor_certificate', 'device', 'virtual_machine', 'cluster', 'cluster_group', 'contact', 'issuer', 'installedapplication', 'comments', 'description', 'certificate', 'tags']
        default_return_url = 'plugins:adestis_netbox_certificate_management:certificate_list'
