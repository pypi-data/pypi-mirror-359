...
def add_agent_deployment(
    ...
    data = {
        ...
        "name": name,
        "description": description,
        "cpu_request": to_bytes_4_multipart(cpu_request),
        "cpu_limit": to_bytes_4_multipart(cpu_limit),
        "mem_request": to_bytes_4_multipart(mem_request),
        "mem_limit": to_bytes_4_multipart(mem_limit),
        "min_replicas": to_bytes_4_multipart(min_replicas),
        "max_replicas": to_bytes_4_multipart(max_replicas),
        "workers_per_core": to_bytes_4_multipart(workers_per_core),
        "use_external_registry": "true" if use_external_registry else "false",
    }
