...
from .exceptions import ResourceError, ResourceNotFoundError, DownloadError
...
class ResourceManager:
    ...
    def __init__(self, path_manager: PathManager, cache_enabled: bool = True, cache_ttl: int = DEFAULT_CACHE_TTL):
        """初始化资源管理器
