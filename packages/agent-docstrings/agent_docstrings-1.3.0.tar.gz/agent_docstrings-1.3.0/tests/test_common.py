...
"""
    ...
    Classes/Functions:
        - TestDataClasses (line 43):
            - test_signature_info_creation() -> None (line 46)
            - test_class_info_creation() -> None (line 52)
            - test_comment_style_creation() -> None (line 71)
        - TestCommentStyles (line 80):
            - test_all_supported_languages_have_styles() -> None (line 83)
            - test_comment_style_values(language: str, expected_start: str, expected_end: str, expected_prefix: str, expected_indent: str) -> None (line 100)
        - TestHeaderStripping (line 116):
            - test_strip_python_header() -> None (line 119)
            - test_strip_block_comment_header() -> None (line 144)
            - test_strip_c_style_comment_header() -> None (line 162)
            - test_no_header_to_strip() -> None (line 180)
            - test_preserve_shebang_when_stripping() -> None (line 189)
            - test_strip_header_with_various_whitespace() -> None (line 202)
            - test_strip_only_first_matching_header() -> None (line 210)
            - test_strip_header_edge_cases() -> None (line 226)
            - test_header_not_at_start() -> None (line 238)
            - test_invalid_language_patterns(language: str) -> None (line 252)
