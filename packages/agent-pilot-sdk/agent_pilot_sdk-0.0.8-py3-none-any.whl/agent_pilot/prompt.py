...
def get_metric(task_id: str, version: str, api_key: Optional[str] = None, api_url: Optional[str] = None) -> Metric:
    """
...
def create_task(
    ...
    try:
        ...
        response_data, _ = get_http_client().post(
            action=action, data=create_task_request.model_dump(), api_key=api_key, api_url=api_url
        )
