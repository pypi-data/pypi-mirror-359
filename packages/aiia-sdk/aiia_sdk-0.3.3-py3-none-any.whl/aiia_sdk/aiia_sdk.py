...
class AIIA:
    ...
    def __init__(self, api_key: Optional[str] = None, client_secret: Optional[str] = None, 
        ...
        self.auto_detect_actions = auto_detect_actions
        if auto_detect_actions:
            try:
                self.auto_interceptor = AIIAAutoInterceptor(self)
                self.auto_interceptor.start_auto_detection()
            except Exception as e:
                print(f"[AIIA SDK] ⚠️ Auto-detection failed: {e}")
                print("[AIIA SDK] Continuing without auto-detection. Use log_action() manually.")
                self.auto_interceptor = None
        else:
            self.auto_interceptor = None
            print("[AIIA SDK] Auto-detection disabled. Use log_action() manually.")
