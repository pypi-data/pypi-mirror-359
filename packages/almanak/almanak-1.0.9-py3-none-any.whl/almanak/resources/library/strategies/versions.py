...
class Versions(SyncAPIResource):
    def list(self, strategy_name: str, *, limit: int = 100, offset: int = 0, **kwargs) -> SyncPage[ArtifactVersion]:
    ...
    def download(self, strategy_name: str, version: str, **kwargs) -> ArtifactDownloadUrl:
        return self._get(
    ...
    def get_uris(self, strategy_name: str, version: str, **kwargs) -> ArtifactFileReturn:
        return self._get(
    ...
    def upload(self, strategy_name: str, version: str, files: builtins.list[str], **kwargs) -> ArtifactUploadUrl:
        all_files = []
