...
import amazon_sagemaker_jupyter_scheduler
...
from amazon_sagemaker_jupyter_scheduler.handlers import AdvancedEnvironmentsHandler

# TODO: need to add unit test, for now manually testing
# @pytest.mark.asyncio
# @patch.object(SageMakerAdvancedEnvironments, "get_advanced_environments")
# @patch(
#     "amazon_sagemaker_jupyter_scheduler.internal_metadata_adapter.JupyterLabEnvironmentDetector",
#     autospec=True,
# )
# async def test_advanced_environment_timeout(mock_detector, mock_advanced):
#     TEST_TIMEOUT_SECS = 2
#     amazon_sagemaker_jupyter_scheduler.handlers.MAX_WAIT_TIME_FOR_API_CALL_SECS = (
#         TEST_TIMEOUT_SECS
#     )
