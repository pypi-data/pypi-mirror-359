...
from analytics_ingest.batching import Batcher
from analytics_ingest.mutations import GraphQLMutations
...
class TestAnalyticsIngestClientIntegration(unittest.TestCase):
    ...
    def test_create_configuration_success(self):
        ...
        response = self.client.executor.execute(GraphQLMutations.create_configuration(), variables)
    ...
    def test_create_configuration_failure(self):
        ...
        with self.assertRaises(RuntimeError) as context:
            self.client.executor.execute(GraphQLMutations.create_configuration(), variables)
