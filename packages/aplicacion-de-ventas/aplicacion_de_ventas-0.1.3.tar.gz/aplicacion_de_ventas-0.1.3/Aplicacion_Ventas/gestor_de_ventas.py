from Aplicacion_Ventas.descuentos import Descuentos
from Aplicacion_Ventas.impuestos import Impuestos
from Aplicacion_Ventas.precios import Precios
...
class GestorVentas:
    ...
    def calcular_precio_final(self):
        ...
        precio_final = Precios.calcula_precio_final(self.precio_base,impuesto_aplicado,\
                                                    descuento_aplicado)
