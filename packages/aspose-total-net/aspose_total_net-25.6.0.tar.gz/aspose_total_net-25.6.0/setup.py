...
REQUIRES = ["aspose-3d==25.6.0",
            "aspose-barcode-for-python-via-net==25.6",
            "aspose-cells-python==25.6.0",
            "aspose-diagram-python==25.6",
            "Aspose.Email-for-Python-via-NET==25.6",
            "aspose-finance==25.3",
            "aspose-gis-net==25.6.0",
            "aspose-html-net==25.6.0",
            "aspose-imaging-python-net==25.6.0",
            "aspose-ocr-python-net==25.6.0",
            "aspose-page==25.6.0",
            "aspose-pdf==25.6.0",
            "aspose-psd==25.6.0",
            "Aspose.Slides==25.6.0",
            "aspose-svg-net==25.6.0",
            "aspose-tasks==25.6.0",
