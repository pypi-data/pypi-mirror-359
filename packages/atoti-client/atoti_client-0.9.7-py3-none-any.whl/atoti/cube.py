...
class Cube(HasIdentifier[CubeIdentifier], ReprJsonable):
    ...
    def aggregate_cache(self, aggregate_cache: AggregateCache, /) -> None:
        ...
        self._client._require_graphql_client().update_cube(input=mutation_input)

    @aggregate_cache.deleter
    def aggregate_cache(self) -> None:
        mutation_input = UpdateCubeInput(aggregate_cache=None, cube_name=self.name)
        self._client._require_graphql_client().update_cube(input=mutation_input)
    ...
    def updateable_cells(self) -> None:
        mutation_input = UpdateCubeInput(cube_name=self.name, updateable_cells=None)
        self._client._require_graphql_client().update_cube(input=mutation_input)
    ...
    def create_parameter_hierarchy_from_members(
        ...
        *,
        ...
        create_table_field = Mutation.create_table(
            CreateTableInput(
                columns=[
                    CreateTableColumnInput(
        ...
        graphql_client.mutation(
            create_table_field, operation_name="CreateParameterTable"
        )
