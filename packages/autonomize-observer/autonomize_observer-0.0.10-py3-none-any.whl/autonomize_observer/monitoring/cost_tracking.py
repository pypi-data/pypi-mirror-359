...
class CostTracker:
    ...
    def clean_model_name(self, model_name: str) -> str:
        ...
        if not cleaned:  # Handle whitespace-only strings
            return "unknown"
        ...
        # Anthropic models
            ...
            if (
                "-4-" in cleaned
                or "opus-4" in cleaned
                or "sonnet-4" in cleaned
                or cleaned.endswith("-4")
            ):
                if "opus" in cleaned:
        ...
        # Google models
            ...
            if "pro" in cleaned and not any(
                v in cleaned for v in ["1.0", "1.5", "2.0", "2.5"]
            ):
                return "gemini-pro"
        ...
        # Meta Llama models
            ...
            if "4" in cleaned:
                ...
                if "nemotron" in cleaned:
                    return "llama-3.3-nemotron"
        ...
        # Mistral models
            ...
            if "multilingual" in cleaned:
                return "codestral-multilingual"
            elif "mamba" in cleaned:
        ...
        # Other providers
            ...
            if "plus" in cleaned:
                return "qwen-plus"
            elif "turbo" in cleaned:
                return "qwen-turbo"
            elif "3" in cleaned:
                return "qwen-3-235b"
            elif "2.5" in cleaned or "qwen2.5" in cleaned:
                if "72b" in cleaned:
                    return "qwen2.5-72b"
                elif "32b" in cleaned:
                    return "qwen-2.5-32b"
            ...
            return cleaned  # Return as-is for standalone nemotron models

        # Remove quantization suffixes like :q4, :q8, etc.
        if ":" in cleaned:
    ...
    def get_model_rates(self, model_name: str) -> Dict[str, float]:
        ...
        # Anthropic models
            ...
            if "4" in model_lower:
                ...
                logger.info(f"🔄 Using claude-3.5-haiku rates for variant: {model_name}")
