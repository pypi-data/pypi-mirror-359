...
class ProviderFactory:
    ...
    def _detect_provider_from_client(cls, client: Any) -> ProviderType:
        ...
        # Anthropic detection (check first to avoid false positives)
        if "anthropic" in client_class or "anthropic" in client_module:
        ...
        # Additional checks if name/module didn't match
