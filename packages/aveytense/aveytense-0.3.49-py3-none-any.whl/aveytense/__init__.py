...
class Tense( # 0.3.24
    ...
    def flatten(self, i: __.Iterable[__.Iterable[_T]], /):
        ...
        # my version of 'itertools.chain.from_iterable()' was circa 14-15 times slower
        # give a look
        
        if True:
            l = self.cast(list(i), list[_T])
            
            if reckon(l) == 0:
                return l
            
            self.clear(l)
            l = self.cast(self.extend(l, *[([e] if isinstance(e, (str, bytes)) else e) for e in i]), list[_T])
            return l
    ...
    def probability2(self, x: _T1 = 1, y: _T2 = 0, frequency: int = 1, length: _ProbabilityLengthType = 10000):
        ...
        https://aveyzan.xyz/aveytense/py/method.probability.html#2
