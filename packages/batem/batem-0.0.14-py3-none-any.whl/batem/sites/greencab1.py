...
from batem.core.siggen import SignalGenerator, Merger, ModeSetpointSiggen, WEEKDAYS
...
occupancy_siggen = SignalGenerator(dp.series('datetime'), constant=0)
occupancy_siggen.daily([WEEKDAYS.MONDAY, WEEKDAYS.TUESDAY, WEEKDAYS.WEDNESDAY, WEEKDAYS.THURSDAY, WEEKDAYS.FRIDAY], {0: 0, 8: 3, 18: 0}, merger=Merger(max))
...
mode_setpoint_siggen = ModeSetpointSiggen(dp.datetimes, heating_period=('16/11', '15/3'), cooling_period=('16/3', '15/11'))
