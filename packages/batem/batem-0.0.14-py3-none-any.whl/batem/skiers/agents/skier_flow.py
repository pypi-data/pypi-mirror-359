...
# Example usage
def run_simulation(skier_count: int = 200, random_agent: bool = False):

    # python batem/skiers/agents/skier_flow.py

    # Initialize skilifts
    skilifts = {
        'Lift A': SkiliftState('Lift A', capacity=30, current_queue=0,
                               wait_time=0, difficulty='easy'),
        'Lift B': SkiliftState('Lift B', capacity=30, current_queue=0,
                               wait_time=0, difficulty='intermediate'),
        'Lift C': SkiliftState('Lift C', capacity=30, current_queue=0,
