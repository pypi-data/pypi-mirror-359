...
* The draft content doesn't need to be exactly the same as the existing file; the assistant may skip unchanged lines using comments like `
...
* IMPORTANT: Start the content with a comment in the format:
