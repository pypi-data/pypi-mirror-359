...
class CLIRuntime(Runtime):
    ...
    def browse(self, action) -> Observation:  # BrowseURLAction removed for CLI-only deployment
        """Not implemented for CLI runtime."""
        return ErrorObservation(
            'Browser functionality is not implemented in CLIRuntime'
        )

    def browse_interactive(self, action) -> Observation:  # BrowseInteractiveAction removed for CLI-only deployment
        """Not implemented for CLI runtime."""
        return ErrorObservation(
            'Browser functionality is not implemented in CLIRuntime'
        )
