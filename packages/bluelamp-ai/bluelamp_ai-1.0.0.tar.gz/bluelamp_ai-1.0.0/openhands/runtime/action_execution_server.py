...
class ActionExecutor:
    ...
    def __init__(
        ...
        # BrowserGym functionality removed for CLI-only deployment
    ...
    async def _init_browser_async(self):
        ...
        logger.debug('Browser initialization skipped for CLI-only deployment')
        self.browser = None
...
if __name__ == '__main__':
    ...
    # BrowserGym arguments removed for CLI-only deployment
    ...
    async def lifespan(app: FastAPI):
        ...
        client = ActionExecutor(
            ...
            # browsergym_eval_env removed for CLI-only deployment
        )
        await client.ainit()
