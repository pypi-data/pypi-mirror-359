...
class MessengerBotChat(Obj):
    ...
    async def find_by_message_date_and_user_name(self, date, user_name, *, _form="Item", _action=None, **kwargs):
        return await self.find_one({"bot_id": self.bot_id, "title": user_name, "messages.date": date}, _form=_form, **kwargs)
