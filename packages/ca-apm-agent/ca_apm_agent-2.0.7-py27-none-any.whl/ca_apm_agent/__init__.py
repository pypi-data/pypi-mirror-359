...
import getopt
import sys
from ca_apm_agent.global_constants import PRINT_PREFIX, CONTAINERID
...
def main():
    ...
    # get containerId and store in environ for further retrieval
    environ[CONTAINERID] = str(getcontainerid())
