...
class VaultSecretsDynamicSecret(
    ...
    def __init__(
        ...
        *,
        ...
        :param app_name: Vault Secrets application name that owns the secret. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#app_name VaultSecretsDynamicSecret#app_name}
        :param integration_name: The Vault Secrets integration name with the capability to manage the secret's lifecycle. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#integration_name VaultSecretsDynamicSecret#integration_name}
        :param name: The Vault Secrets secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#name VaultSecretsDynamicSecret#name}
        :param secret_provider: The third party platform the dynamic credentials give access to. One of ``aws`` or ``gcp``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#secret_provider VaultSecretsDynamicSecret#secret_provider}
        :param aws_assume_role: AWS configuration to generate dynamic credentials by assuming an IAM role. Required if ``secret_provider`` is ``aws``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#aws_assume_role VaultSecretsDynamicSecret#aws_assume_role}
        :param default_ttl: TTL the generated credentials will be valid for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#default_ttl VaultSecretsDynamicSecret#default_ttl}
        :param gcp_impersonate_service_account: GCP configuration to generate dynamic credentials by impersonating a service account. Required if ``secret_provider`` is ``gcp``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#gcp_impersonate_service_account VaultSecretsDynamicSecret#gcp_impersonate_service_account}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing VaultSecretsDynamicSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#import import section} in the documentation of this resource for the id to use
    ...
    def put_aws_assume_role(self, *, iam_role_arn: builtins.str) -> None:
        '''
        :param iam_role_arn: AWS IAM role ARN to assume when generating credentials. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#iam_role_arn VaultSecretsDynamicSecret#iam_role_arn}
        '''
    ...
    def put_gcp_impersonate_service_account(
        ...
        *,
        ...
        '''
        :param service_account_email: GCP service account email to impersonate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_dynamic_secret#service_account_email VaultSecretsDynamicSecret#service_account_email}
        '''
