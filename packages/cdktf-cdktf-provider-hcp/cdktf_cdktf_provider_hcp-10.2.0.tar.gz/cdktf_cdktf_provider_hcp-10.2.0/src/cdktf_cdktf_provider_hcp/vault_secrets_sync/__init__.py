...
class VaultSecretsSync(
    ...
    def __init__(
        ...
        *,
        ...
        :param integration_name: The Vault Secrets integration name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#integration_name VaultSecretsSync#integration_name}
        :param name: The Vault Secrets Sync name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#name VaultSecretsSync#name}
        :param gitlab_config: Configuration parameters used to determine the sync destination. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#gitlab_config VaultSecretsSync#gitlab_config}
        :param project_id: HCP project ID that owns the HCP Vault Secrets integration. Inferred from the provider configuration if omitted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#project_id VaultSecretsSync#project_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing VaultSecretsSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#import import section} in the documentation of this resource for the id to use
    ...
    def put_gitlab_config(
        ...
        *,
        ...
        '''
        :param group_id: ID of the group, if the scope is GROUP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#group_id VaultSecretsSync#group_id}
        :param project_id: ID of the project, if the scope is PROJECT. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#project_id VaultSecretsSync#project_id}
        :param scope: The scope to which sync applies. Defaults to GROUP. The valid options are GROUP and PROJECT. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#scope VaultSecretsSync#scope}
        '''
