...
class WaypointAddOn(
    ...
    def __init__(
        ...
        *,
        ...
        :param application_id: The ID of the Application that this Add-on is created for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#application_id WaypointAddOn#application_id}
        :param definition_id: The ID of the Add-on Definition that this Add-on is created from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#definition_id WaypointAddOn#definition_id}
        :param name: The name of the Add-on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#name WaypointAddOn#name}
        :param add_on_input_variables: Input variables set for the add-on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#add_on_input_variables WaypointAddOn#add_on_input_variables}
        :param project_id: The ID of the HCP project where the Waypoint AddOn is located. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#project_id WaypointAddOn#project_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing WaypointAddOn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#import import section} in the documentation of this resource for the id to use
...
class WaypointAddOnAddOnDefinitionInputVariables:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Variable name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#name WaypointAddOn#name}
        :param value: Variable value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#value WaypointAddOn#value}
        :param variable_type: Variable type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/waypoint_add_on#variable_type WaypointAddOn#variable_type}
        '''
        if __debug__:
