...
class SearchValueCountsInputBodyTypedDict(TypedDict):
    and_count_conditions: Nullable[List[Nullable[List[FieldValuePairTypedDict]]]]
    r"""Conditions that are AND-ed together to determine what to count"""


class SearchValueCountsInputBody(BaseModel):
    and_count_conditions: Nullable[List[Nullable[List[FieldValuePair]]]]
    r"""Conditions that are AND-ed together to determine what to count"""
