...
class ChatIdeyalabsConfig:
    ...
    def _load_config(self):
        ...
        self.mongodb_database = os.getenv('CHATIDEYALABS_MONGODB_DATABASE', 'DB Name')
        self.mongodb_collection = os.getenv('CHATIDEYALABS_MONGODB_COLLECTION', 'Collection Name')
