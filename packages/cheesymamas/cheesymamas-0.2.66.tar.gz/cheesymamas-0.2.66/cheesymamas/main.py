...
Exec=bash -c 'echo "[launch] $(date)" >> ~/cheesymamas.log; echo "Python: $(which python3)" >> ~/cheesymamas.log; echo "PWD: $PWD" >> ~/cheesymamas.log; python3 -m cheesymamas >> ~/cheesymamas.log 2>&1'
Icon=CheesyMamas
Terminal=false
Type=Application
