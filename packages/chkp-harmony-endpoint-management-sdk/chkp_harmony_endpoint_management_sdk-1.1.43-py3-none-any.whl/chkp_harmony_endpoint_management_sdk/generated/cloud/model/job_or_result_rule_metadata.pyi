...
class JobOrResultRuleMetadata(
    ...
    Either an object containing a Job ID *OR* schema 'RuleMetadata'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>RuleMetadata</em></p>
    """
