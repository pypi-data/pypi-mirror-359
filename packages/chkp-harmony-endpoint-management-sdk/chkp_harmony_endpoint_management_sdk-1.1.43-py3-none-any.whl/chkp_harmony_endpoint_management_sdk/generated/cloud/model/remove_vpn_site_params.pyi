...
class RemoveVpnSiteParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["informUser"], typing_extensions.Literal["allowPostpone"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["displayName"], typing_extensions.Literal["informUser"], typing_extensions.Literal["allowPostpone"], ]):
