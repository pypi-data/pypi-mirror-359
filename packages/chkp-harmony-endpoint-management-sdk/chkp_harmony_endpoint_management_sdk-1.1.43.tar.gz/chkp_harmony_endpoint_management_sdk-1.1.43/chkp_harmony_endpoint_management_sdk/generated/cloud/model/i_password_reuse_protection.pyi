...
class IPasswordReuseProtection(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            enablePasswordManagement = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enablePasswordManagement"]) -> MetaOapg.properties.enablePasswordManagement: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["protectionMode"], typing_extensions.Literal["allowDismissAlert"], typing_extensions.Literal["enablePasswordManagement"], typing_extensions.Literal["protectedDomains"], typing_extensions.Literal["protectedIPs"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enablePasswordManagement"]) -> typing.Union[MetaOapg.properties.enablePasswordManagement, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["protectionMode"], typing_extensions.Literal["allowDismissAlert"], typing_extensions.Literal["enablePasswordManagement"], typing_extensions.Literal["protectedDomains"], typing_extensions.Literal["protectedIPs"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        enablePasswordManagement: typing.Union[MetaOapg.properties.enablePasswordManagement, bool, schemas.Unset] = schemas.unset,
