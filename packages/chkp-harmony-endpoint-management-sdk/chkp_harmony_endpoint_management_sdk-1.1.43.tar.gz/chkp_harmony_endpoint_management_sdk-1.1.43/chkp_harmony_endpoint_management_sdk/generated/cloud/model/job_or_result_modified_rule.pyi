...
class JobOrResultModifiedRule(
    ...
    Either an object containing a Job ID *OR* schema 'ModifiedRule'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>ModifiedRule</em></p>
    """
