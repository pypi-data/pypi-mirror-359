...
class PolicySettingsIFilesProtectionBladeThreatEmulation(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['IFilesProtection']:
                return IFilesProtection
    ...
    settings: 'IFilesProtection'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'IFilesProtection': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'IFilesProtection': ...
    ...
    ) -> 'PolicySettingsIFilesProtectionBladeThreatEmulation':
