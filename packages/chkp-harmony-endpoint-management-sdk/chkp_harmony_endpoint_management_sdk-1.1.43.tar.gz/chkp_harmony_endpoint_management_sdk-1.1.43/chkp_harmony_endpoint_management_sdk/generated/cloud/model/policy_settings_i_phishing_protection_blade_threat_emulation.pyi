...
class PolicySettingsIPhishingProtectionBladeThreatEmulation(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['IPhishingProtection']:
                return IPhishingProtection
    ...
    settings: 'IPhishingProtection'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'IPhishingProtection': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'IPhishingProtection': ...
    ...
    ) -> 'PolicySettingsIPhishingProtectionBladeThreatEmulation':
