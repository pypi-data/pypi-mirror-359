...
class PolicySettingsISearchProtectionBladeAntiBot(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['ISearchProtection']:
                return ISearchProtection
    ...
    settings: 'ISearchProtection'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'ISearchProtection': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'ISearchProtection': ...
    ...
    ) -> 'PolicySettingsISearchProtectionBladeAntiBot':
