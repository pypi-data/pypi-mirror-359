...
conf = chkp_harmony_endpoint_management_sdk.generated.saas.Configuration(
    ...
    def __init__(
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("chkp_harmony_endpoint_management_sdk.generated.saas")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'cloudInfraJwt' in self.api_key:
            auth['cloudInfraJwt'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-access-token',
        ...
        if 'msspSession' in self.api_key:
            auth['msspSession'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-mgmt-mssp-session',
                'value': self.get_api_key_with_prefix(
                    'msspSession',
                ),
            }
