...
class AMUpdateOn(
    ...
    amUpdateOn: MetaOapg.properties.amUpdateOn
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["amUpdateOn"]) -> MetaOapg.properties.amUpdateOn: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalCount"]) -> MetaOapg.properties.totalCount: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amUpdateOn"], typing_extensions.Literal["totalCount"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["amUpdateOn"]) -> MetaOapg.properties.amUpdateOn: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amUpdateOn"], typing_extensions.Literal["totalCount"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        amUpdateOn: typing.Union[MetaOapg.properties.amUpdateOn, list, tuple, ],
