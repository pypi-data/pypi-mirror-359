...
class JobOrResultId(
    ...
    Either an object containing a Job ID *OR* schema 'Id'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>Id</em></p>
    """
