...
class JobOrResultRuleAssignmentArray(
    ...
    Either an object containing a Job ID *OR* schema 'RuleAssignment-Array'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>RuleAssignment-Array</em></p>
    """
    ...
    ) -> 'JobOrResultRuleAssignmentArray':
        return super().__new__(
            cls,
            *_args,
            _configuration=_configuration,
