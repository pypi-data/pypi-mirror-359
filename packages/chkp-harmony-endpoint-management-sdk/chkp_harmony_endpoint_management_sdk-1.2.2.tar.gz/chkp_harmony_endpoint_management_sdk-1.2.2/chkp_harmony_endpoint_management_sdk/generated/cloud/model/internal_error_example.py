...
class InternalErrorExample(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['ErrorTypesGeneric']:
                return ErrorTypesGeneric
            ...
            class title(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "An internal error has occurred": "AN_INTERNAL_ERROR_HAS_OCCURRED",
                    }
                
                @schemas.classproperty
                def AN_INTERNAL_ERROR_HAS_OCCURRED(cls):
                    return cls("An internal error has occurred")
            ...
            class detail(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "An internal error has occurred- {Error Details}": "AN_INTERNAL_ERROR_HAS_OCCURRED_ERROR_DETAILS",
                    }
                
                @schemas.classproperty
                def AN_INTERNAL_ERROR_HAS_OCCURRED_ERROR_DETAILS(cls):
                    return cls("An internal error has occurred- {Error Details}")
            ...
            class instance(
                ...
                @schemas.classproperty
                def BASE_SERVER(cls):
                    return cls("base/server")
        
            @staticmethod
            def source() -> typing.Type['ErrorSourceUnknown']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["source"]) -> 'ErrorSourceUnknown': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'ErrorTypesGeneric': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["source"]) -> 'ErrorSourceUnknown': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'ErrorTypesGeneric': ...
