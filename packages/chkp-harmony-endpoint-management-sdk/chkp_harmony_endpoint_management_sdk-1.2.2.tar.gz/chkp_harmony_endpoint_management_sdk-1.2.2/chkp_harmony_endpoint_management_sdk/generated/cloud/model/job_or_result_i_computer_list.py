...
class JobOrResultIComputerList(
    ...
    Either an object containing a Job ID *OR* schema 'IComputerList'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>IComputerList</em></p>
    """
