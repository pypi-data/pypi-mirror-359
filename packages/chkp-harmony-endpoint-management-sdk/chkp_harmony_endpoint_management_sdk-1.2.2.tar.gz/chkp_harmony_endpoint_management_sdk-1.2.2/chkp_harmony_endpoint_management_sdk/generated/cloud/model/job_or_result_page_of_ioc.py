...
class JobOrResultPageOfIoc(
    ...
    Either an object containing a Job ID *OR* schema 'PageOfIoc'
...
<p>When set to '<em>OFF</em>', operations will run synchronously and return a concrete response of type <em>PageOfIoc</em></p>
    """
