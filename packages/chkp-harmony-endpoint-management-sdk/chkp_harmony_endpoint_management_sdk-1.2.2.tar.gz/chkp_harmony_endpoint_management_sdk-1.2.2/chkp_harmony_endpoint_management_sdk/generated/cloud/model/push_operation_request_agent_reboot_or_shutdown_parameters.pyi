...
class PushOperationRequestAgentRebootOrShutdownParameters(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def operationParameters() -> typing.Type['AgentRebootOrShutdownParameters']:
                return AgentRebootOrShutdownParameters
            __annotations__ = {
                "targets": targets,
                "comment": comment,
                "timing": timing,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["operationParameters"]) -> 'AgentRebootOrShutdownParameters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["operationParameters"]) -> typing.Union['AgentRebootOrShutdownParameters', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        operationParameters: typing.Union['AgentRebootOrShutdownParameters', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PushOperationRequestAgentRebootOrShutdownParameters':
