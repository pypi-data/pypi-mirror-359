...
class PushOperationRequestCollectProcessInformationParams(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def operationParameters() -> typing.Type['CollectProcessInformationParams']:
                return CollectProcessInformationParams
            __annotations__ = {
                "targets": targets,
                "comment": comment,
                "timing": timing,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["operationParameters"]) -> 'CollectProcessInformationParams': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["operationParameters"]) -> typing.Union['CollectProcessInformationParams', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        operationParameters: typing.Union['CollectProcessInformationParams', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PushOperationRequestCollectProcessInformationParams':
