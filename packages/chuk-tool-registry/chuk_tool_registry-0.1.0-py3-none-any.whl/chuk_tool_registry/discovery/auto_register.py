# chuk_tool_registry/discovery/auto_register.py
"""
    ...
    *,
    ...
    class _Tool:  # noqa: D401, N801 - internal auto-wrapper
        ...
        async def execute(self, **kwargs: Any) -> Any:
            ...
            # off-load blocking sync work to thread
            # anyio.to_thread.run_sync doesn't accept **kwargs, so we need to wrap it
            def _run_func():
                return func(**kwargs)
            return await anyio.to_thread.run_sync(_run_func)
