...
from ...models.cc_connection_approved_country_input_dto import CCConnectionApprovedCountryInputDto
...
def _get_kwargs(
    connection_id: str,
    *,
    body: CCConnectionApprovedCountryInputDto,
    tenant_id: str,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Approve country
     ...
     Approve a country for a given connection
