...
T = TypeVar("T", bound="CCPaginatedMs365DefenseUserIsoCountryResponseDto")


@_attrs_define
class CCPaginatedMs365DefenseUserIsoCountryResponseDto:
    """
    Attributes:
        items (list['CCMs365DefenseUserIsoCountry']): Items returned from the database
    ...
    items: list["CCMs365DefenseUserIsoCountry"]
    start: float
    end: float
    total: float
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = CCMs365DefenseUserIsoCountry.from_dict(items_item_data)
        ...
        cc_paginated_ms_365_defense_user_iso_country_response_dto = cls(
            items=items,
            start=start,
            end=end,
            total=total,
        ...
        cc_paginated_ms_365_defense_user_iso_country_response_dto.additional_properties = d
        return cc_paginated_ms_365_defense_user_iso_country_response_dto
