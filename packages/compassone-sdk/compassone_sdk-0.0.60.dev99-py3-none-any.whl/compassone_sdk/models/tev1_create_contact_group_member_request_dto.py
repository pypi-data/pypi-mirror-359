...
T = TypeVar("T", bound="TEV1CreateContactGroupMemberRequestDto")


@_attrs_define
class TEV1CreateContactGroupMemberRequestDto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tev1_create_contact_group_member_request_dto = cls(
            availability=availability,
            name=name,
        ...
        tev1_create_contact_group_member_request_dto.additional_properties = d
        return tev1_create_contact_group_member_request_dto
