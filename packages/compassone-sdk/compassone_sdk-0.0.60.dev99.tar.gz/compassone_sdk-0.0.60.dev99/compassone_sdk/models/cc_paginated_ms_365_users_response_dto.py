...
T = TypeVar("T", bound="CCPaginatedMs365UsersResponseDto")


@_attrs_define
class CCPaginatedMs365UsersResponseDto:
    """
    Attributes:
        items (list['CCMs365DefenseUser']): Items returned from the database
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = CCMs365DefenseUser.from_dict(items_item_data)
        ...
        cc_paginated_ms_365_users_response_dto = cls(
            items=items,
            start=start,
            end=end,
            total=total,
        ...
        cc_paginated_ms_365_users_response_dto.additional_properties = d
        return cc_paginated_ms_365_users_response_dto
