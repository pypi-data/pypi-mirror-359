...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/v1/cloud/cisco/onboardings/{onboarding_id}/complete",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Complete Cisco onboarding

     Completes the onboarding by verifying everything was set up appropriately
