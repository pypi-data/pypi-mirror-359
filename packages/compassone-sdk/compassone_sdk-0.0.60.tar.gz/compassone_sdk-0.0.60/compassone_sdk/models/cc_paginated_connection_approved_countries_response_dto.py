...
T = TypeVar("T", bound="CCPaginatedConnectionApprovedCountriesResponseDto")


@_attrs_define
class CCPaginatedConnectionApprovedCountriesResponseDto:
    """
    Attributes:
        items (list['CCConnectionApprovedCountryResponseDto']): Items returned from the database
    ...
    items: list["CCConnectionApprovedCountryResponseDto"]
    start: float
    end: float
    total: float
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = CCConnectionApprovedCountryResponseDto.from_dict(items_item_data)
        ...
        cc_paginated_connection_approved_countries_response_dto = cls(
            items=items,
            start=start,
            end=end,
            total=total,
        ...
        cc_paginated_connection_approved_countries_response_dto.additional_properties = d
        return cc_paginated_connection_approved_countries_response_dto
