...
class AdaptiveScheduler:
    ...
    def __init__(self, config: BrassConfig):
        ...
        self.base_interval = config.get('base_interval', 300)  # 5 minutes
    ...
    async def _start_periodic_scheduling(self):
        ...
        if self.scheduler:
            ...
            briefing_time = self.config.get('morning_briefing_time', '09:00')
            self.scheduler.add_job(
    ...
    async def _morning_briefing(self):
        ...
        try:
            ...
            stats = self.storage.get_activity_stats(since=since)
