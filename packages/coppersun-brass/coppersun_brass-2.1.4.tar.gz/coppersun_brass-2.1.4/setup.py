...
setup(
    ...
    install_requires=[
        ...
        # Lightweight ML Dependencies (required for automatic monitoring)
        "numpy>=1.24",  # CRITICAL: Required for ML pipeline (50MB)
        "sqlalchemy>=2.0.0",  # CRITICAL: Required for learning system (5MB)
        "onnxruntime>=1.16",  # CRITICAL: Required for 257KB pre-trained model
        "tokenizers>=0.14",  # CRITICAL: Required for 14KB code tokenizer
