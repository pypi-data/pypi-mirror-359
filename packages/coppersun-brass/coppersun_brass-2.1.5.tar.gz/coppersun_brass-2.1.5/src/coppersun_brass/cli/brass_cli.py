...
_brass'''
    ...
    def _setup_ml_models(self):
        """Set up ML models on first initialization."""
        try:
            from ..ml.create_ultra_lightweight_model import main as setup_models
            import logging
            
            # Temporarily suppress logs to keep init clean
            ...
            try:
                setup_models()
                print("   ✅ AI models ready (129KB total - ultra-lightweight!)")
            except Exception as e:
                print(f"   ⚠️ Model setup skipped: {e}")
                print("   💡 Models will be created on first analysis run")
            finally:
            ...
            print("   💡 Install with: pipx inject coppersun-brass onnx tokenizers")
