...
environment_configuration = (
    ...
    .with_environment_variables(
        LOCAL_DEVELOPMENT_STORAGE_CONFIG, 
        in_docker=False,  # Only apply to local machine
...
azure_management_configuration: AzureManagementConfiguration = (
    ...
    .with_keyvault(vault_url=primary_key_vault_uri, name="default")  # Primary key vault
...
storage_account = azure_resource_configuration.storage_accounts.get("default")
