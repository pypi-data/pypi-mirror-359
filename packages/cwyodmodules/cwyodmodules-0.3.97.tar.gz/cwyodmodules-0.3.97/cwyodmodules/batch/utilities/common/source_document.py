...
class SourceDocument:
    ...
    def get_markdown_url(self):
        ...
        if "_SAS_TOKEN_PLACEHOLDER_" in url and storage_account:
            ...
            container_sas = "?" + generate_container_sas(
                ...
                user_delegation_key=storage_account.get_user_delegation_key() if hasattr(storage_account, 'get_user_delegation_key') else None,
                account_key=getattr(storage_account, 'account_key', None),
                permission="r",
