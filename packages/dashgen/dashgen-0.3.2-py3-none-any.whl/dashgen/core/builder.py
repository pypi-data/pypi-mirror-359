...
class Dashboard:
    ...
    def generate(self, output_path, *, jupyter=False):
        """Generate images for one or multiple pages.

        If ``jupyter=True`` the generated image(s) will be displayed using
        ``IPython.display`` when available.
        """
