...
class ContentV1DatasourcePreset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "author", "description", "title", "iconURL", "autoloader", "bronze", "silver", "gold", "versionNumber", "latestVersion", "bronze_event_expr", "silver_table_event_mappings", "gold_table_event_mappings"]
