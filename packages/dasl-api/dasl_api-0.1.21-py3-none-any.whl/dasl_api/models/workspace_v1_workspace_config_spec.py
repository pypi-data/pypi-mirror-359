...
class WorkspaceV1WorkspaceConfigSpec(BaseModel):
    ...
    default_rule_schedule: Optional[CoreV1Schedule] = Field(default=None, description="A default schedule for detections. If a detection is created without a schedule, it will inherit the schedule provided here. Note that, should this schedule be updated, it will affect all detections inheriting it. ", alias="defaultRuleSchedule")
    ...
    __properties: ClassVar[List[str]] = ["systemTablesConfig", "defaultSQLWarehouse", "detectionRuleMetadata", "notableExport", "operationalAlertExport", "exportSchedule", "observables", "daslStoragePath", "daslCustomPresetsPath", "defaultRuleSchedule", "defaultConfig", "managedRetention"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultRuleSchedule": CoreV1Schedule.from_dict(obj["defaultRuleSchedule"]) if obj.get("defaultRuleSchedule") is not None else None,
