...
class DataLabCompute13(
    RootModel[Union[DataLabCompute, DataLabCompute15, DataLabCompute16]]
):
    root: Union[DataLabCompute, DataLabCompute15, DataLabCompute16]


class DataLabComputeOrUnknown(RootModel[Optional[DataLabCompute13]]):
    root: Optional[DataLabCompute13]
