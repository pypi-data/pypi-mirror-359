...
class DataScienceDataRoomV15(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV1(
    RootModel[Union[DataScienceDataRoomV14, DataScienceDataRoomV15]]
):
    root: Union[DataScienceDataRoomV14, DataScienceDataRoomV15]
