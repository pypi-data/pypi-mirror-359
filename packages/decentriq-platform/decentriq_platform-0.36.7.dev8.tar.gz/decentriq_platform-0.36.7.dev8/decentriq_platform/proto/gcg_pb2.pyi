...
class AuthenticatedRequest(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["createPolicy", "secretStore", "updateStatus", "getVerificationKey", "dcrAction", "createApiToken", "getApiTokens", "deleteApiToken"] | None: ...
    @typing.overload
...
class AuthenticatedResponse(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["response", b"response"]) -> typing.Literal["createPolicy", "secretStore", "updateStatus", "getVerificationKey", "dcrAction", "createApiToken", "getApiTokens", "deleteApiToken"] | None: ...
