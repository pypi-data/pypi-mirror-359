...
class PlatformApiClient:
    ...
    @property
    def vrm_bulk(self) -> VrmBulkClient:
        """
        ...
        Returns:
            VrmBulkClient: Ready-to-use bulk operations client
        """
        if self._vrm_bulk is None:
            api_client = self._get_authenticated_api_client()
            self._vrm_bulk = VrmBulkClient(api_client)
    ...
    def __repr__(self) -> str:
        return f"PlatformApiClient(environment='{self.environment}', base_url='{self.base_url}')"
