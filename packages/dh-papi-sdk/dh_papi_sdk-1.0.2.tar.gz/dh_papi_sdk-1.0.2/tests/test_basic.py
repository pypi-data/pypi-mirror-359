...
def test_imports_work():
    ...
    from papi_sdk import PlatformApiClient, AuthClient, VrmBulkClient
    assert PlatformApiClient is not None
    assert AuthClient is not None
    assert VrmBulkClient is not None
...
def test_vrm_bulk_client():
    ...
    from papi_sdk.vrm_bulk_client import VrmBulkClient
    ...
    with patch('papi_sdk.vrm_bulk_client.VrmBulkApi') as mock_api:
        ...
        client = VrmBulkClient(mock_api_client)
...
@patch('papi_sdk.client.AuthClient')  
@patch('papi_sdk.client.VrmBulkClient')
