...
class CreateDocumentByTextRequestBodyDataBuilder:
    def __init__(self):
        create_document_by_file_request_body_data = CreateDocumentByTextRequestBodyData()
    ...
    def original_document_id(self, original_document_id: str) -> CreateDocumentByTextRequestBodyDataBuilder:
    ...
    def process_rule(self, process_rule: DocumentRequestProcessRule) -> CreateDocumentByTextRequestBodyDataBuilder:
