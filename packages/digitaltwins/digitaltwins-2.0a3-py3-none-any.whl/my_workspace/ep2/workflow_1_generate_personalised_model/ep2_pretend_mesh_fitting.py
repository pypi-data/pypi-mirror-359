...
def mesh_fitting(assay_seek_id, workspace, platform_config_file):
    import time
    time.sleep(5)
    pass
...
def exec(**kwargs):
    ...
    mesh_fitting(assay_seek_id=assay_seek_id, workspace=workspace, platform_config_file=platform_config_file)


def get_task(dag: DAG):
    task_id = "mesh_fitting"
