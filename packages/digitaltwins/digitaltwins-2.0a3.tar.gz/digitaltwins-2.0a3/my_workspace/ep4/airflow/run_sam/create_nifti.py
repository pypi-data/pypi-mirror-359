...
def exec(**kwargs):
    ...
    try:
        dicom_dir = kwargs['dag_run'].conf.get('dicom_dir', kwargs['params'].get('dicom_dir'))
    except:
        dicom_dir = kwargs['dicom_dir']

    try:
        workspace = kwargs['dag_run'].conf.get('workspace', kwargs['params'].get('workspace'))
        workspace_nifti = os.path.join(workspace, "nifti")
    except:
        workspace_nifti = kwargs['workspace']
...
if __name__ == '__main__':
    ...
    workspace = "/home/clin864/opt/digitaltwins-api/my_workspace/ep4/airflow/run_sam/out/sam-001001/nifti"
