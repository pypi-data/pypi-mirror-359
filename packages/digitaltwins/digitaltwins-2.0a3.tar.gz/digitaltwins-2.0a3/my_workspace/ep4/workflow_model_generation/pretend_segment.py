...
def segment(assay_seek_id, workspace, platform_config_file):
    import time
    time.sleep(5)
...
def exec(**kwargs):
    ...
    segment(assay_seek_id=assay_seek_id, workspace=workspace, platform_config_file=platform_config_file)
