(function () {
    ...
    (function ($) {
        ...
        function setThemeCookie(theme) {
            ...
            document.cookie = `dashub_theme=${theme}; path=/; expires=${expiryDate.toUTCString()}`;
        }
        ...
        function handleThemeChange() {
            ...
            setThemeCookie(currentThemeChoice);
        ...
        if (window.tinymce) {
            tinymce.on('AddEditor', function (e) {
                console.log(`Adding TinyMCE editor with ID: ${e.editor.id}`);
