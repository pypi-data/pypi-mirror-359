...
from .utils import hex_to_rgb, resolve_dynamic_value
...
DYNAMIC_SETTINGS_KEYS = [
    'site_logo', 'site_icon', 'theme_color',
]
...
def get_resolved_settings(request: WSGIRequest = None) -> Dict:
    ...
    for key in DYNAMIC_SETTINGS_KEYS:
        if key in settings_dict:
            settings_dict[key] = resolve_dynamic_value(settings_dict[key], request)
