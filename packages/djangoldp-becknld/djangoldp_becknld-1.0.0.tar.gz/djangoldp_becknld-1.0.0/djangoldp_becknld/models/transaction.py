...
def tidgen():
    # TODO: What's the format of a transaction's id?
    import uuid
...
class Transaction(baseModel):
    ...
    # When a transaction without a transaction_id is created, bap_id is self.urlid + "inbox/"
    ...
    # When a transaction with a transaction_id, bpp_id is is self.urlid + "inbox/"
    ...
    class Meta(baseModel.Meta):
        ...
        nested_fields = baseModel.Meta.nested_fields + ["initiators"]
