...
class SteelMemberLocalSectionReduction(_message.Message):
    ...
    class ComponentsTable(_message.Message):
        ...
        rows: _containers.RepeatedCompositeFieldContainer[SteelMemberLocalSectionReduction.ComponentsRow]
        def __init__(self, rows: _Optional[_Iterable[_Union[SteelMemberLocalSectionReduction.ComponentsRow, _Mapping]]] = ...) -> None: ...
    class ComponentsRow(_message.Message):
        ...
        class ReductionType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            REDUCTION_TYPE_UNKNOWN: _ClassVar[SteelMemberLocalSectionReduction.ComponentsRow.ReductionType]
            REDUCTION_TYPE_REDUCTION_COMPONENT_TYPE_DESIGN_PARAMETERS: _ClassVar[SteelMemberLocalSectionReduction.ComponentsRow.ReductionType]
        REDUCTION_TYPE_UNKNOWN: SteelMemberLocalSectionReduction.ComponentsRow.ReductionType
        REDUCTION_TYPE_REDUCTION_COMPONENT_TYPE_DESIGN_PARAMETERS: SteelMemberLocalSectionReduction.ComponentsRow.ReductionType
        class MultipleOffsetDefinitionType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            MULTIPLE_OFFSET_DEFINITION_TYPE_ABSOLUTE: _ClassVar[SteelMemberLocalSectionReduction.ComponentsRow.MultipleOffsetDefinitionType]
            MULTIPLE_OFFSET_DEFINITION_TYPE_RELATIVE: _ClassVar[SteelMemberLocalSectionReduction.ComponentsRow.MultipleOffsetDefinitionType]
        MULTIPLE_OFFSET_DEFINITION_TYPE_ABSOLUTE: SteelMemberLocalSectionReduction.ComponentsRow.MultipleOffsetDefinitionType
        MULTIPLE_OFFSET_DEFINITION_TYPE_RELATIVE: SteelMemberLocalSectionReduction.ComponentsRow.MultipleOffsetDefinitionType
        class FastenerDefinitionType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            FASTENER_DEFINITION_TYPE_ABSOLUTE: _ClassVar[SteelMemberLocalSectionReduction.ComponentsRow.FastenerDefinitionType]
            FASTENER_DEFINITION_TYPE_RELATIVE: _ClassVar[SteelMemberLocalSectionReduction.ComponentsRow.FastenerDefinitionType]
        FASTENER_DEFINITION_TYPE_ABSOLUTE: SteelMemberLocalSectionReduction.ComponentsRow.FastenerDefinitionType
        FASTENER_DEFINITION_TYPE_RELATIVE: SteelMemberLocalSectionReduction.ComponentsRow.FastenerDefinitionType
        ...
        no: int
        description: str
        reduction_type: SteelMemberLocalSectionReduction.ComponentsRow.ReductionType
        position: float
        multiple: bool
        note: str
        multiple_number: int
        multiple_offset_definition_type: SteelMemberLocalSectionReduction.ComponentsRow.MultipleOffsetDefinitionType
        multiple_offset: float
        fastener_definition_type: SteelMemberLocalSectionReduction.ComponentsRow.FastenerDefinitionType
