...
from .ddict import PosixCheckpointPersister, DAOSCheckpointPersister
from ... import fli
...
class Orchestrator:
    ...
    def _prepare(self):
        ...
        if self._restore_from is None and self._persister == DAOSCheckpointPersister:
            ...
            subprocess.run(f"daos cont destroy {self._persist_path} {self._name}", shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
