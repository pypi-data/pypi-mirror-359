...
class ConfigItem:
    ...
    def formatted_description(self) -> str:
        """Combines descripton and comment."""
    ...
    def matches_search_term(self, search_term: str) -> bool:
        """Check if the search term matches either the raw_name, category, description
        or comment.
    ...
    def validate_value(self, val: Union[int, float, str, bool, list, dict]) -> None:
        """Validate a given value against the expected type and raises an expection
...
def get_updated_signature(
    ...
    """Get an updated inspect.Signature object by combining the parameters from the
    ...
    added before the variable keyword argument (**kwargs) or replaced if present.
     ...
     Args:
         func: the function to reterieve the original parameters from
