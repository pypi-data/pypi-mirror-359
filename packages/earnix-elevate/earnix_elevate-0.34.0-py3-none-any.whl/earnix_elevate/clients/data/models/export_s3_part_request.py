...
class ExportS3PartRequest(BaseModel):
    ...
    parts_urls: Optional[List[StrictStr]] = Field(default=None, alias="partsUrls")
    ...
    __properties: ClassVar[List[str]] = ["partsUrls", "columns", "castBooleanToInteger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "partsUrls": obj.get("partsUrls"),
                "columns": obj.get("columns"),
                "castBooleanToInteger": obj.get("castBooleanToInteger")
