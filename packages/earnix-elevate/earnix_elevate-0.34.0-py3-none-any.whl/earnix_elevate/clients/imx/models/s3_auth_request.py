...
class S3AuthRequest(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        "s3_secret_key": "S3SecretKeyAuthRequest"
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[S3SecretKeyAuthRequest]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[S3SecretKeyAuthRequest]]:
