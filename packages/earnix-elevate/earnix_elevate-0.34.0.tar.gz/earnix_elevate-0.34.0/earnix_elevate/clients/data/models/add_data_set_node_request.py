...
class AddDataSetNodeRequest(BaseModel):
    ...
    data_set_id: StrictInt = Field(alias="dataSetId")
    __properties: ClassVar[List[str]] = ["nodeType", "dataSetId"]

    @field_validator("node_type")
    def node_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["TABLE", "RECIPE"]):
    ...
    def from_json(
        cls, json_str: str
    ) -> Optional[Union[AddDataSetRecipeNodeRequest, AddDataSetDataTableNodeRequest]]:
