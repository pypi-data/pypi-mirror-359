...
class AddDataSetNodeRequest(BaseModel):
    ...
    node_type: StrictStr = Field(default=..., alias="nodeType")
    data_set_id: StrictInt = Field(default=..., alias="dataSetId")
    ...
    def from_json(cls, json_str: str) -> Union(
        AddDataSetDataTableNodeRequest, AddDataSetRecipeNodeRequest
    ):
