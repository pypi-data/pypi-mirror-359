...
class ExportS3Properties(BaseModel):
    """
    ExportS3Properties
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportS3Properties:
        """Create an instance of ExportS3Properties from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportS3Properties:
        """Create an instance of ExportS3Properties from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportS3Properties.parse_obj(obj)

        _obj = ExportS3Properties.parse_obj(
            {
