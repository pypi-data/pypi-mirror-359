...
class UpdateDataSetNodeRequest(BaseModel):
    ...
    __discriminator_value_class_map = {"RECIPE": "UpdateDataSetRecipeNodeRequest"}
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(UpdateDataSetRecipeNodeRequest):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(UpdateDataSetRecipeNodeRequest):
