...
class CreateDataSetVersionRequest(BaseModel):
    ...
    source_data_set_version_number: Optional[StrictInt] = Field(
        default=None, alias="sourceDataSetVersionNumber"
    )
    __properties = ["dataSetId", "sourceDataSetVersionNumber"]
        ...
        _obj = CreateDataSetVersionRequest.parse_obj(
            {
                ...
                "source_data_set_version_number": obj.get("sourceDataSetVersionNumber"),
            }
        )
        return _obj
