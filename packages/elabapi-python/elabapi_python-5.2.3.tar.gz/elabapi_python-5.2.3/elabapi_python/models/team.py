...
class Team(object):
    ...
    def __init__(self, id=None, name=None, common_template=None, common_template_md=None, user_create_tag=None, force_exp_tpl=None, created_at=None, orgid=None, visible=None, announcement=None, onboarding_email_active=None, onboarding_email_body=None, onboarding_email_subject=None):  # noqa: E501
