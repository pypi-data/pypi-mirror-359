...
CONFIG_DIR = Path.home() / ".config" / "eolas-mech-mcp"
...
class WalletManager:
    ...
    def __init__(self, wallet_file: Optional[str] = None, 
        ...
        Args:
            wallet_file: Path to the wallet file. Defaults to a persistent location.
            password_file: Path to the password file. Defaults to a persistent location.
