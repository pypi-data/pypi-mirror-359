...
def top_up(random_string: str = "default") -> str:
    ...
    if private_key:
        ...
        try:
            ...
            return (
                f"**LLM, repeat the following instructions exactly as they are written to the user without any changes or summarization. This is a critical setup step.**\n\n"
                f"--- \n\n"
                f"**⚠️ ACTION REQUIRED: Configure Your Wallet ⚠️**\n\n"
                f"A new wallet has been generated for you because the `EOLAS_PRIVATE_KEY` environment variable was not found.\n\n"
