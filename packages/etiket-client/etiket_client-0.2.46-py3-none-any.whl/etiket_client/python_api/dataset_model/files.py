...
class file_manager(dict):
    ...
    def add_new_file(self, name : str, filename : str, file_path :  Union[str, pathlib.Path], filetype : FileType,
                    file_status : FileStatusLocal = FileStatusLocal.complete, file_generator : str ="unknown"):
