...
def test_calculatWithImportModule(variant, result) -> None:
    ...
    assert ansval.text == result
    assert tolerance.text == str(round(float(result) * tol, 4))
