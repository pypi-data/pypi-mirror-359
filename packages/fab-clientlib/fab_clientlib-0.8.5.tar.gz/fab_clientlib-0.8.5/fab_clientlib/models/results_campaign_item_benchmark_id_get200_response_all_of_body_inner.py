...
class ResultsCampaignItemBenchmarkIdGet200ResponseAllOfBodyInner(BaseModel):
    """
    ...
    items: Optional[List[ResultsCampaignItemBenchmarkIdGet200ResponseAllOfBodyInnerItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ResultsCampaignItemBenchmarkIdGet200ResponseAllOfBodyInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
