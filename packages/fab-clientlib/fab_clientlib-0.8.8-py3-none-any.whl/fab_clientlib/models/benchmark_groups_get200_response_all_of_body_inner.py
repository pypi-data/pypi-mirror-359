...
class BenchmarkGroupsGet200ResponseAllOfBodyInner(BaseModel):
    ...
    benchmark_definition_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "setup", "benchmark_definition_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "setup": obj.get("setup"),
            "benchmark_definition_ids": obj.get("benchmark_definition_ids")
        })
        return _obj
