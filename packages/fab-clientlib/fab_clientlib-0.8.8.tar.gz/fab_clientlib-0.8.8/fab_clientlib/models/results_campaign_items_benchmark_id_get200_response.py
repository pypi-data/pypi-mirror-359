...
class ResultsCampaignItemsBenchmarkIdGet200Response(BaseModel):
    """
    ResultsCampaignItemsBenchmarkIdGet200Response
    """ # noqa: E501
    error: Optional[ApiResponseError] = None
    body: Optional[List[ResultsCampaignItemsBenchmarkIdGet200ResponseAllOfBodyInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "body": [ResultsCampaignItemsBenchmarkIdGet200ResponseAllOfBodyInner.from_dict(_item) for _item in obj["body"]] if obj.get("body") is not None else None
        })
        return _obj
