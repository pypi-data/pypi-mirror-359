...
class ResultsSubmissionsSubmissionIdGet200ResponseAllOfBodyInnerTestScoringsInner(BaseModel):
    """
    ...
    scenario_scorings: Optional[List[ResultsSubmissionsSubmissionIdGet200ResponseAllOfBodyInnerTestScoringsInnerScenarioScoringsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scenario_scorings": [ResultsSubmissionsSubmissionIdGet200ResponseAllOfBodyInnerTestScoringsInnerScenarioScoringsInner.from_dict(_item) for _item in obj["scenario_scorings"]] if obj.get("scenario_scorings") is not None else None
        })
        return _obj
