...
class ResultsSubmissionsSubmissionIdTestsTestIdGet200Response(BaseModel):
    """
    ResultsSubmissionsSubmissionIdTestsTestIdGet200Response
    """ # noqa: E501
    error: Optional[ApiResponseError] = None
    body: Optional[ResultsSubmissionsSubmissionIdGet200ResponseAllOfBodyInnerTestScoringsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "body": ResultsSubmissionsSubmissionIdGet200ResponseAllOfBodyInnerTestScoringsInner.from_dict(obj["body"]) if obj.get("body") is not None else None
        })
        return _obj
