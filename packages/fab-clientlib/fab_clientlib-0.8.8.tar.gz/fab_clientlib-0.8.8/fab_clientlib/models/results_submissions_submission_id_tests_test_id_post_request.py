...
class ResultsSubmissionsSubmissionIdTestsTestIdPostRequest(BaseModel):
    """
    ResultsSubmissionsSubmissionIdTestsTestIdPostRequest
    """ # noqa: E501
    data: Optional[List[ResultsSubmissionsSubmissionIdTestsTestIdPostRequestDataInner]] = Field(default=None, description="Results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ResultsSubmissionsSubmissionIdTestsTestIdPostRequestDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
