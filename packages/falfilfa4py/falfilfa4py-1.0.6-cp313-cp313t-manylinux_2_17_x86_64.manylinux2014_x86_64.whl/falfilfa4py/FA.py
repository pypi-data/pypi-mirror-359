...
def get_fa_limits():
    """
    Get FA limits : truncation, latitudes, levels, simultaneous files, simultaneous headers,
    max X/Y ratio
...
@ctypesFF()
def set_fa_limits(JPXTRO=0, JPXLAT=0, JPXNIV=0, JPNXFA=0, JPNXCA=0, JPXRATIO=0):
    """
    Set FA limits : truncation, latitudes, levels, simultaneous files, simultaneous headers,
    max X/Y ratio.
    Using default value 0 will use FA actual default value from FA_MOD
    ...
    6) JPXRATIO
    """
    return ([JPXTRO, JPXLAT, JPXNIV, JPNXFA, JPNXCA, JPXRATIO],
            [(np.int64, None, IN),
             (np.int64, None, IN),
             (np.int64, None, IN),
             (np.int64, None, IN),
