...
class CrudToolsModule(FastPluggyBaseModule):
    ...
    def on_load_complete(self, fast_pluggy: Annotated[FastPluggy, InjectDependency]) -> None:
        ...
        from .filters.filtered_table import FilteredTableModelView
        FastPluggyWidgets.register_plugin_widgets('crud_tools', [FilteredTableModelView])
