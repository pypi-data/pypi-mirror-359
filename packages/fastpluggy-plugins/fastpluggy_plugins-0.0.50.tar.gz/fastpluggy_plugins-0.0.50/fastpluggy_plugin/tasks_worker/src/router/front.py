    ...
    return view_builder.generate(
        ...
        widgets=[
            ButtonListWidget(buttons=[
                ...
                AutoLinkView(label="Task Duration Analytics", route_name="task_duration_analytics"),
                AutoLinkView(label="Scheduled Task Monitoring", route_name="scheduled_task_monitoring"),
