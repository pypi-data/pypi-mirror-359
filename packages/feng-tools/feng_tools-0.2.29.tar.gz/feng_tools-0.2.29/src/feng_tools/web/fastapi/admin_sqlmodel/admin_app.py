...
from feng_tools.web.fastapi.admin_sqlmodel.AmisModelAdminPage import AmisModelAdminPage
from feng_tools.web.fastapi.admin_sqlmodel.model_admin_api_processor import ModelAdminApiProcessor
...
class AdminApp(FastAPI):
    ...
    def _create_model_admin_page(self, api_tools: ApiTools, model_admin_page_class: type[ModelAdminPage],
                                 model_admin_settings: SqlModelModelAdminSettings):
        """创建模型的管理页面"""
    ...
    def register_model_admin(self, model_admin_settings: SqlModelModelAdminSettings,
