...
from sqlalchemy import func, Engine, delete
...
from feng_tools.web.fastapi.admin_sqlmodel import schema_tools
...
class ModelAdminApiProcessor(ModelAdminApi):
    def __init__(self, api_tools: ApiTools, db_engine: Engine, model_admin_settings: SqlModelModelAdminSettings,
