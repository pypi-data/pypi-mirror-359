...
class FinancialRatios:
    ...
    @staticmethod
    def __safe_division(market_cap:float=None, last_roll:float=None):
        """
    ...
    @staticmethod
    def extract_closest_quarter(data_list:list, date):
        """
    ...
    @staticmethod
    def calculate_ratios(market_cap, roll_values_dict:dict):
        """
        Computes financial ratios on basis of company_dict's roll_values
        T/C : Fixed Number of Roll values and ratios thus  O(1) * 6
        """
        try:
            ratios = {}
    ...
    def __calculate_roll(self, column_name:str, window=4):
        """
    ...
    def roll_pat(self, window=4):
        ...
        try:
            ...
            if "pat" not in columns and "profit_after_tax" not in columns:
    ...
    def roll_adj_pat(self, window=4):
        """
    ...
    def extract_rolling_values(self):
        """
