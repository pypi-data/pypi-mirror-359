...
class FinancialEngine:
    ...
    async def get_ratio(self, alpha_code:str, date:datetime):
        """
        ...
        try:
            ...
            ## 2. Extract Trading View data (:TODO:)
            ...
            final_result = {"alpha_code":alpha_code, "calculation_date":date, "market_cap":market_cap ,**roll_values, **ratio_values}
            ...
            logging.error(f"ERROR FinancialEnginer -> (get_ratio): {e}")
            return None


    async def get_ratio_range(self, alpha_code:str, start_date:datetime, end_date:datetime):
        """
        ...
        try:
            ...
            return {
                "time":(end-start),
                "results":pd.DataFrame(final_result_dict)
            }
    ...
    ########## HELPER FUNCTIONS ##########
    async def __extract_mongo_data(self, alpha_code:str):
        """
    ...
    @staticmethod
    async def __extract_parsed_document(alpha_code:str, company_document:dict, date:datetime):
        """
