...
# Core dependencies needed for basic API functionality (web-friendly)
core_deps = [
    "requests>=2.25.1",
...
setup(
    ...
    python_requires=">=3.7",
    install_requires=core_deps,  # Minimal installation by default (web-friendly)
    extras_require={
        "full": [
            "openpyxl>=3.0.7",  # For Excel export in CLI/GUI
        ],
        "web": [],  # Explicit web-only installation (same as default)
    },
    entry_points={
        "console_scripts": [
    ...
    zip_safe=False,
    keywords="finance, scraping, stocks, financial-data, cli, api, finviz, yahoo-finance, web",
) 