...
def analyze_entity(
    entity: EntityProxy, resolve_mentions: bool | None = settings.resolve_mentions
    ...
    """
    analyzer = Analyzer(entity, resolve_mentions)
...
def analyze_entities(
    ...
    for e in logged_items(entities, "Analyze", item_name="Entity", logger=log):
        yield from analyze_entity(e, resolve_mentions)
