...
if not TYPE_CHECKING:
    dvlinfobase = _load_me("func_adl_servicex_xaodr22.DataModel_detail.dvlinfobase")
    dvliteratorbase = _load_me("func_adl_servicex_xaodr22.DataModel_detail.dvliteratorbase")
else:
