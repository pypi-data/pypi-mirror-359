...
if not TYPE_CHECKING:
    ibaseparam = _load_me("func_adl_servicex_xaodr22.ROOT.Math.ibaseparam")
    ioptions = _load_me("func_adl_servicex_xaodr22.ROOT.Math.ioptions")
    minimizer = _load_me("func_adl_servicex_xaodr22.ROOT.Math.minimizer")
    minimizeroptions = _load_me("func_adl_servicex_xaodr22.ROOT.Math.minimizeroptions")
    trandomengine = _load_me("func_adl_servicex_xaodr22.ROOT.Math.trandomengine")
else:
