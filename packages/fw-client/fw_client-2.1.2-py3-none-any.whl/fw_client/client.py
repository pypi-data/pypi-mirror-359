        ...
        **kwargs,
        ...
        def retry_send(send, **kwargs):
            def retry_when(response: httpx.Response):
                ...
                retry_method = response.request.method in kwargs["retry_methods"]
                retry_status = response.status_code in kwargs["retry_statuses"]
                return byte_stream and retry_method and retry_status
