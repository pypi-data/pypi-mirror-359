...
class Pipeline(Sequence):
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            workflow (Optional[Workflow]): The workflow configuration for the pipeline. Defaults to None.
    ...
    def set_workflow(self, workflow: Optional[Workflow]) -> None:
        """Set the workflow configuration for the pipeline.

        Args:
            workflow (Optional[Workflow]): The workflow configuration to set.
        """
        self._workflow = workflow
