...
class GenderAPI:
    ...
    def get_gender_by_name(self, name, country=None):
        """
        ...
        """
        return self._post_request("/api", {"name": name, "country": country})

    def get_gender_by_email(self, email, country=None):
        """
        ...
        :return: JSON response as dict
        """
        return self._post_request("/api/email", {"email": email, "country": country})

    def get_gender_by_username(self, username, country=None):
        """
        ...
        :return: JSON response as dict
        """
        return self._post_request("/api/username", {"username": username, "country": country})
