"""IssueTypeRemovedEvent model class."""
...
@dataclass
class IssueTypeRemovedEvent(Event):
    """Event representing an issue type being removed from an issue."""
    ...
    @classmethod
    def from_response(cls, data: Dict[str, Any]) -> "IssueTypeRemovedEvent":
        """Create an IssueTypeRemovedEvent instance from API response data."""
