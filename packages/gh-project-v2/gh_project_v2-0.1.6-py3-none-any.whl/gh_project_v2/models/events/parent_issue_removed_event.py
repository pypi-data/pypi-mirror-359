"""ParentIssueRemovedEvent model class."""
...
@dataclass
class ParentIssueRemovedEvent(Event):
    """Event representing a parent issue being removed from an issue."""
    ...
    @classmethod
    def from_response(cls, data: Dict[str, Any]) -> "ParentIssueRemovedEvent":
        """Create a ParentIssueRemovedEvent instance from API response data."""
