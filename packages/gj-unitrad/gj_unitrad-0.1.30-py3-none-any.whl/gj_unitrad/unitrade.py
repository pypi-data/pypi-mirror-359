...
class WebSocketClient:
    def __init__(self, uri, user, passwd, strategy_name, strategy_param, upload_strategy, info : BackInfo ):
        ...
        self.analyzer = FutureMethod(self.path + 'rq_trades.csv'
                                              , self.path + 'rq_daily_positions.csv', self.info.init_cash
                                              , self.info.start, self.info.end, self.info.dol_ip
                                              , self.info.dol_port, self.info.dol_user, self.info.dol_passwd)
    ...
    async def handle_rtn_back_results(self, data):
        ...
        self.analyzer = FutureMethod(self.path + 'rq_trades.csv'
                                              , self.path + 'rq_daily_positions.csv', self.info.init_cash
                                              , self.info.start, self.info.end, self.info.dol_ip
                                              , self.info.dol_port, self.info.dol_user, self.info.dol_passwd, self.path + file_name_before + "_", self.info.risk_free_rate)
...
async def run_func(config_data):
    ...
    dol_config = config_data.get("dolphin", {})
    info.dol_ip = dol_config.get("ip")
    info.dol_port = dol_config.get("port")
    info.dol_user = dol_config.get("user")
    info.dol_passwd = dol_config.get("passwd")
    global gclient
