...
set_target_properties(gmsh::shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libgmsh.so.4.14.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libgmsh.so.4.14"
  )

list(APPEND _IMPORT_CHECK_TARGETS gmsh::shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gmsh::shared "${_IMPORT_PREFIX}/lib/libgmsh.so.4.14.0" )
