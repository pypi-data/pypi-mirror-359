...
def check_video_status(bearer_token, x_client_data, operation_name, scene_id, max_retries, check_interval):
        ...
        headers = {
            "Host": "aisandbox-pa.googleapis.com", "Connection": "keep-alive",
            "sec-ch-ua-platform": '"Windows"', "Authorization": f"Bearer {bearer_token}",
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36",
            "sec-ch-ua": '"Google Chrome";v="137", "Chromium";v="137", "Not/A)Brand";v="24"', "sec-ch-ua-mobile": "?0",
            "Accept": "*/*", "Origin": "https://labs.google", "X-Client-Data": x_client_data, "Sec-Fetch-Site": "cross-site",
            "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://labs.google/",
            "Accept-Language": "es-ES,es;q=0.9,en;q=0.8", "Accept-Encoding": "gzip, deflate",
...
def fetch_video_base64(authorization_token, x_client_data, media_name):
        ...
        headers = {
            "Host": "aisandbox-pa.googleapis.com", "Connection": "keep-alive",
            "sec-ch-ua-platform": '"Windows"', "Authorization": f"Bearer {authorization_token}",
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36",
            "sec-ch-ua": '"Google Chrome";v="137", "Chromium";v="137", "Not/A)Brand";v="24"',
            "Content-Type": "text/plain;charset=UTF-8", "sec-ch-ua-mobile": "?0", "Accept": "*/*",
            "Origin": "https://labs.google", "X-Client-Data": x_client_data, "Sec-Fetch-Site": "cross-site",
            "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://labs.google/",
            "Accept-Language": "es-ES,es;q=0.9,en;q=0.8", "Accept-Encoding": "gzip, deflate"
        }
        try:
