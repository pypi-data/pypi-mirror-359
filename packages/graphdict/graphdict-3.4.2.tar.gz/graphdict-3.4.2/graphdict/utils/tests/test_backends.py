...
def test_graph_converter_needs_backend():
    ...
    from graphdict.classes.tests.dispatch_interface import (
...
def test_mixing_backend_graphs():
    from graphdict.classes.tests import dispatch_interface
...
def test_not_implemented_by_nx():
    ...
    if "nx_loopback" in nx.config.backends:
        from graphdict.classes.tests.dispatch_interface import LoopbackBackendInterface
