...
from graphdict.algorithms.tree.mst import random_spanning_tree
from graphdict.utils import not_implemented_for, pairwise, py_random_state
...
def asadpour_atsp(G, weight="weight", seed=None, source=None):
    ...
    --------
    >>> import graphdict as nx
    >>> import graphdict.algorithms.approximation as approx
