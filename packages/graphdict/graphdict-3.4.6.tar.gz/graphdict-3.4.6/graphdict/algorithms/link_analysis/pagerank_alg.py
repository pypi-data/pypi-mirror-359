...
def _pagerank_numpy(
    ...
    Examples
    --------
    >>> from graphdict.algorithms.link_analysis.pagerank_alg import _pagerank_numpy
    >>> G = nx.DiGraph(nx.path_graph(4))
...
def _pagerank_scipy(
    ...
    Examples
    --------
    >>> from graphdict.algorithms.link_analysis.pagerank_alg import _pagerank_scipy
    >>> G = nx.DiGraph(nx.path_graph(4))
