...
class Comparer:
    ...
    @overload
    def compare(self, document : io._IOBase) -> groupdocs.comparison.Document:
    ...
    @overload
    def apply_changes(self, document : io._IOBase, apply_change_options : groupdocs.comparison.options.ApplyChangeOptions) -> None:
        '''Accepts or rejects changes and applies them to resultant document.
    ...
    @overload
    def apply_changes(self, document : io._IOBase, save_options : groupdocs.comparison.options.SaveOptions, apply_change_options : groupdocs.comparison.options.ApplyChangeOptions) -> None:
        '''Accepts or rejects changes and applies them to resultant document.
    ...
    @property
    def targets(self) -> List[groupdocs.comparison.Document]:
