...
class CompareOptions:
    ...
    @property
    def sensitivity_of_comparison_for_tables(self) -> Optional[int]:
        '''Gets a sensitivity of comparison for tables.'''
        raise NotImplementedError()
    
    @sensitivity_of_comparison_for_tables.setter
    def sensitivity_of_comparison_for_tables(self, value : Optional[int]) -> None:
...
class LoadOptions:
    ...
    def font_directories(self, value : List[str]) -> None:
        '''List of font directories to load.'''
        raise NotImplementedError()
...
class StyleSettings:
    ...
    @property
    def words_separators(self) -> List[str]:
        '''Gets the words separator chars.'''
        raise NotImplementedError()
    
    @words_separators.setter
    def words_separators(self, value : List[str]) -> None:
