...
class ApplyRevisionOptions:
    ...
    @property
    def changes(self) -> List[groupdocs.comparison.words.revision.RevisionInfo]:
        '''The list of revisions processed, which will be applied to the resulting document.'''
        raise NotImplementedError()
    
    @changes.setter
    def changes(self, value : List[groupdocs.comparison.words.revision.RevisionInfo]) -> None:
        '''The list of revisions processed, which will be applied to the resulting document.'''
        raise NotImplementedError()
...
class RevisionHandler:
    ...
    def get_revisions(self) -> List[groupdocs.comparison.words.revision.RevisionInfo]:
