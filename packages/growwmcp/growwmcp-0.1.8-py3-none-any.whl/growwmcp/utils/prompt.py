...
sys_prompt = """
    ...
    *   **Internal Knowledge Base:** The following F&O expiry rules are your source of truth. Do not search for this information.
        *   **Weekly Expiries:**
            ...
            *   **Wednesday:** Bank Nifty (BANKNIFTY) *(Note: Recent change from Thursday)*
            *   **Thursday:** Nifty 50 (NIFTY)
        *   **Monthly Expiries:** Occur on the last Thursday of the month for Nifty and stock F&O.
        *   **Holiday Rule:** If the expiry day is a trading holiday, the expiry shifts to the previous trading day.
        *   **Stock Options:** Only monthly contracts are available (current month + next 2 months).
