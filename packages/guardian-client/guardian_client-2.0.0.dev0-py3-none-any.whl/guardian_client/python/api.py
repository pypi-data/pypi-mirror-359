...
class GuardianAPIClient:
    ...
    def download_from_scan(self, scan_uuid: str, local_dir: str) -> Dict[str, Any]:
        ...
        model_version_uuid = files_response["files"][0]["model_version_uuid"]
    ...
    def _get_huggingface_repo_id(
        ...
        if len(path_parts) != 3:
            return None, {
                ...
                "error": f"Error: HuggingFace URI should follow the format https://huggingface.co/<model_author>/<model_name>",
            }
