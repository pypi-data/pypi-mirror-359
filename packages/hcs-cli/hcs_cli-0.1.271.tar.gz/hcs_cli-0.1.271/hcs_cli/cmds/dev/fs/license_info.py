...
from hcs_cli.cmds.dev.fs.common import log, required_fields

env_vars = ["CSP_LICENSE_SVC_CLIENT_ID", "CSP_LICENSE_SVC_CLIENT_SECRET"]
...
def createLicenseFeatures():
    env = required_fields.validate(env_vars)
    ...
    client = hcs_client(
        current_profile.hcs.url,
        {
            ...
            "client_id": env["CSP_LICENSE_SVC_CLIENT_ID"],
            "client_secret": env["CSP_LICENSE_SVC_CLIENT_SECRET"],
        },
    )
