...
def stats(
    org: str, edge_ids: str, run_id: str, ca_label: str, force: bool, verbose: bool, provider: list, exclude_orgs: str
):
    """edge rotate certs"""
    target_org_id = org
    ...
    try:
        ...
        for edge in edges:
            ...
            if edge["providerLabel"].lower() not in allowed_providers:
                ...
                continue
            if not (edge["providerLabel"].lower() in desiredProviderTypes):
                logger.warn(
