...
from hcs_cli.cmds.dev.fs.k8s_util import _fs_kubeconfig
...
def download_kubeconfig(service_name):
    ...
    if jobs is None:
        ...
        fail(
            f"No jobs found for service {service_name}. Check if the service name is correct or if the Jenkins job exists."
        )
