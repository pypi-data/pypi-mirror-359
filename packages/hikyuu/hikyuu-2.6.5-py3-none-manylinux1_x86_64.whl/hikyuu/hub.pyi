...
class ConfigModel(sqlalchemy.orm.decl_api.Base):
    __mapper__: typing.ClassVar[sqlalchemy.orm.mapper.Mapper]  # value = <Mapper at 0x700def2d0880; ConfigModel>
    ...
    _sa_class_manager: typing.ClassVar[sqlalchemy.orm.instrumentation.ClassManager]  # value = <ClassManager of <class 'hikyuu.hub.ConfigModel'> at 700def2d7d60>
...
class HubModel(sqlalchemy.orm.decl_api.Base):
    __mapper__: typing.ClassVar[sqlalchemy.orm.mapper.Mapper]  # value = <Mapper at 0x700def2d0f10; HubModel>
    ...
    _sa_class_manager: typing.ClassVar[sqlalchemy.orm.instrumentation.ClassManager]  # value = <ClassManager of <class 'hikyuu.hub.HubModel'> at 700e299cc7c0>
    def __init__(self, **kwargs):
        """
        A simple constructor that allows initialization from kwargs.
...
class PartModel(sqlalchemy.orm.decl_api.Base):
    __mapper__: typing.ClassVar[sqlalchemy.orm.mapper.Mapper]  # value = <Mapper at 0x700e299d48e0; PartModel>
    ...
    _sa_class_manager: typing.ClassVar[sqlalchemy.orm.instrumentation.ClassManager]  # value = <ClassManager of <class 'hikyuu.hub.PartModel'> at 700e299d9270>
    def __init__(self, **kwargs):
        """
        A simple constructor that allows initialization from kwargs.
