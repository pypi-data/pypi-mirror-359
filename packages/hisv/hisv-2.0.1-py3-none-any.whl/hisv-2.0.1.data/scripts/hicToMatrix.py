...
hicfile = " /mnt/d/HiSV_data/T47D/ENCFF832RTC.hic"
binSize = 100000
ref_file = "/mnt/d/HiSV_data/hg38.len"
outdir = "/mnt/d/HiSV_data/T47D/hg38"
name = "T47D"
n_cores = 1
hicToMatrix(hicfile, binSize, ref_file, outdir, name, n_cores)
print("tttttttt")