...
class BatchInputTag(object):
    ...
    @property
    def inputs(self):
        """Gets the inputs of this BatchInputTag.  # noqa: E501

        Blog tags to input.  # noqa: E501

        :return: The inputs of this BatchInputTag.  # noqa: E501
        :rtype: list[Tag]
        """
        return self._inputs
    ...
    def inputs(self, inputs):
        """Sets the inputs of this BatchInputTag.

        Blog tags to input.  # noqa: E501

        :param inputs: The inputs of this BatchInputTag.  # noqa: E501
        :type inputs: list[Tag]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInputTag):
            return False
