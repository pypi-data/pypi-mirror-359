...
class BatchInputPage(object):
    ...
    @property
    def inputs(self):
        """Gets the inputs of this BatchInputPage.  # noqa: E501

        Pages to input.  # noqa: E501

        :return: The inputs of this BatchInputPage.  # noqa: E501
        :rtype: list[Page]
        """
        return self._inputs
    ...
    def inputs(self, inputs):
        """Sets the inputs of this BatchInputPage.

        Pages to input.  # noqa: E501

        :param inputs: The inputs of this BatchInputPage.  # noqa: E501
        :type inputs: list[Page]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInputPage):
            return False
