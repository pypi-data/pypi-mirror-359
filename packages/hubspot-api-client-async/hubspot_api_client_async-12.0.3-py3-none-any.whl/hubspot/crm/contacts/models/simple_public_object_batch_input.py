...
class SimplePublicObjectBatchInput(object):
    ...
    def id_property(self):
        ...
        The name of a unique property, when identifying records by property.   # noqa: E501
    ...
    def id(self):
        ...
        The ID of the contact to update. This can be the object ID, or the unique property value of the `idProperty` property.  # noqa: E501
