...
class PublicImportMetadata(object):
    ...
    """
    openapi_types = {"counters": "dict[str, int]", "file_ids": "list[str]", "object_lists": "list[PublicObjectListRecord]"}

    attribute_map = {"counters": "counters", "file_ids": "fileIds", "object_lists": "objectLists"}

    def __init__(self, counters=None, file_ids=None, object_lists=None, local_vars_configuration=None):  # noqa: E501
