...
class PublicCtaAnalyticsFilter(object):
    ...
    attribute_map = {"coalescing_refine_by": "coalescingRefineBy", "pruning_refine_by": "pruningRefineBy", "filter_type": "filterType", "cta_name": "ctaName", "operator": "operator"}

    def __init__(self, coalescing_refine_by=None, pruning_refine_by=None, filter_type="CTA", cta_name=None, operator=None, local_vars_configuration=None):  # noqa: E501
