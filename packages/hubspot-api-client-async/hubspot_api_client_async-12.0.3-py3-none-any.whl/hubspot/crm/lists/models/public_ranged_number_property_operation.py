...
class PublicRangedNumberPropertyOperation(object):
    ...
    """
    openapi_types = {"include_objects_with_no_value_set": "bool", "upper_bound": "int", "operation_type": "str", "lower_bound": "int", "operator": "str"}
    ...
    def __init__(self, include_objects_with_no_value_set=None, upper_bound=None, operation_type="NUMBER_RANGED", lower_bound=None, operator=None, local_vars_configuration=None):  # noqa: E501
