...
class PublicTimeOffset(object):
    ...
    """
    openapi_types = {"amount": "int", "offset_direction": "str", "time_unit": "str"}

    attribute_map = {"amount": "amount", "offset_direction": "offsetDirection", "time_unit": "timeUnit"}

    def __init__(self, amount=None, offset_direction=None, time_unit=None, local_vars_configuration=None):  # noqa: E501
