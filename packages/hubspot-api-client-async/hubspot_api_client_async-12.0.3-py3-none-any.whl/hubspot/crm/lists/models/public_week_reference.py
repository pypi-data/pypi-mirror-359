...
class PublicWeekReference(object):
    ...
    """
    openapi_types = {"day_of_week": "str", "hour": "int", "millisecond": "int", "reference_type": "str", "minute": "int", "second": "int"}

    attribute_map = {"day_of_week": "dayOfWeek", "hour": "hour", "millisecond": "millisecond", "reference_type": "referenceType", "minute": "minute", "second": "second"}

    def __init__(self, day_of_week=None, hour=None, millisecond=None, reference_type="WEEK", minute=None, second=None, local_vars_configuration=None):  # noqa: E501
