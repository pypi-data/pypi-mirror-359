...
class PublicDealSplitsBatchCreateRequest(object):
    ...
    """
    openapi_types = {"inputs": "list[PublicDealSplitsCreateRequest]"}

    attribute_map = {"inputs": "inputs"}

    def __init__(self, inputs=None, local_vars_configuration=None):  # noqa: E501
        """PublicDealSplitsBatchCreateRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublicDealSplitsBatchCreateRequest):
            return False
