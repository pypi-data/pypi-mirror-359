...
class DependentField(object):
    ...
    def dependent_condition(self, dependent_condition):
        ...
        """
        if self.local_vars_configuration.client_side_validation and dependent_condition is None:  # noqa: E501
            raise ValueError("Invalid value for `dependent_condition`, must not be `None`")  # noqa: E501
