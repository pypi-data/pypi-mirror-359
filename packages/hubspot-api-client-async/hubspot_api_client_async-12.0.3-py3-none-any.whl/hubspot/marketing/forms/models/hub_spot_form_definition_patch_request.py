...
class HubSpotFormDefinitionPatchRequest(object):
    ...
    def __init__(self, field_groups=None, archived=None, configuration=None, name=None, legal_consent_options=None, display_options=None, local_vars_configuration=None):  # noqa: E501
