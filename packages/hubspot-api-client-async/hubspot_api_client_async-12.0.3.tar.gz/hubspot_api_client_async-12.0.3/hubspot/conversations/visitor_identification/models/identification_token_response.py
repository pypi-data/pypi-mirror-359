...
class IdentificationTokenResponse(object):
    ...
    def __init__(self, token=None, local_vars_configuration=None):  # noqa: E501
        """IdentificationTokenResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdentificationTokenResponse):
            return False
