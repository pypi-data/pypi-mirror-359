...
class IntegratorObjectResultActionsInner(object):
    ...
    def __init__(self, property_names_included=None, confirmation=None, label=None, type="IFRAME", http_method=None, url=None, width=None, height=None, local_vars_configuration=None):  # noqa: E501
