...
class PublicCommunicationSubscriptionFilter(object):
    ...
    """
    openapi_types = {"subscription_type": "str", "subscription_ids": "list[str]", "channel": "str", "accepted_opt_states": "list[str]", "filter_type": "str", "business_unit_id": "str"}
    ...
    def __init__(
        self, subscription_type=None, subscription_ids=None, channel=None, accepted_opt_states=None, filter_type="COMMUNICATION_SUBSCRIPTION", business_unit_id=None, local_vars_configuration=None
    ):  # noqa: E501
