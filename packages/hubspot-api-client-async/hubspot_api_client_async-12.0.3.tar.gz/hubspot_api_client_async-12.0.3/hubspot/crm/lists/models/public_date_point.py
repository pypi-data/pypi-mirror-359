...
class PublicDatePoint(object):
    ...
    """
    openapi_types = {"month": "int", "hour": "int", "year": "int", "timezone_source": "str", "millisecond": "int", "time_type": "str", "zone_id": "str", "day": "int", "minute": "int", "second": "int"}
    ...
    def __init__(
        self, month=None, hour=None, year=None, timezone_source=None, millisecond=None, time_type="DATE", zone_id=None, day=None, minute=None, second=None, local_vars_configuration=None
    ):  # noqa: E501
