...
class PublicPageViewAnalyticsFilter(object):
    ...
    def __init__(self, coalescing_refine_by=None, enable_tracking=None, pruning_refine_by=None, page_url=None, filter_type="PAGE_VIEW", operator=None, local_vars_configuration=None):  # noqa: E501
