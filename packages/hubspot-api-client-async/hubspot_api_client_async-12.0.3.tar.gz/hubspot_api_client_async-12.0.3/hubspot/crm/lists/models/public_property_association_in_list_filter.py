...
class PublicPropertyAssociationInListFilter(object):
    ...
    def __init__(
        self, list_id=None, coalescing_refine_by=None, property_with_object_id=None, filter_type="PROPERTY_ASSOCIATION", to_object_type_id=None, operator=None, local_vars_configuration=None
    ):  # noqa: E501
