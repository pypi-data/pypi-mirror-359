...
class BatchInputPropertyName(object):
    ...
    """
    openapi_types = {"inputs": "list[PropertyName]"}

    attribute_map = {"inputs": "inputs"}

    def __init__(self, inputs=None, local_vars_configuration=None):  # noqa: E501
        """BatchInputPropertyName - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def inputs(self):
        """Gets the inputs of this BatchInputPropertyName.  # noqa: E501


        :return: The inputs of this BatchInputPropertyName.  # noqa: E501
        :rtype: list[PropertyName]
        """
        return self._inputs

    @inputs.setter
    def inputs(self, inputs):
        """Sets the inputs of this BatchInputPropertyName.


        :param inputs: The inputs of this BatchInputPropertyName.  # noqa: E501
        :type inputs: list[PropertyName]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInputPropertyName):
            return False
