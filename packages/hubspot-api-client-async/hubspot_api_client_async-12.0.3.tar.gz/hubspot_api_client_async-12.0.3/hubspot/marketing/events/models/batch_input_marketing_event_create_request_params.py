...
class BatchInputMarketingEventCreateRequestParams(object):
    ...
    """
    openapi_types = {"inputs": "list[MarketingEventCreateRequestParams]"}

    attribute_map = {"inputs": "inputs"}

    def __init__(self, inputs=None, local_vars_configuration=None):  # noqa: E501
        """BatchInputMarketingEventCreateRequestParams - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInputMarketingEventCreateRequestParams):
            return False
