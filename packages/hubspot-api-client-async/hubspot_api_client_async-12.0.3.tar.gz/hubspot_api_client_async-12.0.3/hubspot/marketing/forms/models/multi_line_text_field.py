...
class MultiLineTextField(object):
    ...
    def object_type_id(self):
        """Gets the object_type_id of this MultiLineTextField.  # noqa: E501

        A unique ID for this field's CRM object type. For example a CONTACT field will have the object type ID 0-1.  # noqa: E501

        :return: The object_type_id of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
    ...
    def object_type_id(self, object_type_id):
        """Sets the object_type_id of this MultiLineTextField.

        A unique ID for this field's CRM object type. For example a CONTACT field will have the object type ID 0-1.  # noqa: E501

        :param object_type_id: The object_type_id of this MultiLineTextField.  # noqa: E501
    ...
    @property
    def hidden(self):
        """Gets the hidden of this MultiLineTextField.  # noqa: E501
        ...
        :return: The hidden of this MultiLineTextField.  # noqa: E501
        :rtype: bool
        """
        return self._hidden
    ...
    def hidden(self, hidden):
        """Sets the hidden of this MultiLineTextField.

        Whether a field should be hidden or not. Hidden fields won't appear on the form, but can be used to pass a value to a property without requiring the customer to fill it in.  # noqa: E501

        :param hidden: The hidden of this MultiLineTextField.  # noqa: E501
        :type hidden: bool
        """
    ...
    def default_value(self):
        """Gets the default_value of this MultiLineTextField.  # noqa: E501

        The value filled in by default. This value will be submitted unless the customer modifies it.  # noqa: E501

        :return: The default_value of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """Sets the default_value of this MultiLineTextField.

        The value filled in by default. This value will be submitted unless the customer modifies it.  # noqa: E501

        :param default_value: The default_value of this MultiLineTextField.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this MultiLineTextField.  # noqa: E501

        The identifier of the field. In combination with the object type ID, it must be unique.  # noqa: E501

        :return: The name of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MultiLineTextField.

        The identifier of the field. In combination with the object type ID, it must be unique.  # noqa: E501

        :param name: The name of this MultiLineTextField.  # noqa: E501
        :type name: str
        """
    ...
    def description(self):
        """Gets the description of this MultiLineTextField.  # noqa: E501

        Additional text helping the customer to complete the field.  # noqa: E501

        :return: The description of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this MultiLineTextField.

        Additional text helping the customer to complete the field.  # noqa: E501

        :param description: The description of this MultiLineTextField.  # noqa: E501
    ...
    def dependent_fields(self):
        """Gets the dependent_fields of this MultiLineTextField.  # noqa: E501

        A list of other fields to make visible based on the value filled in for this field.  # noqa: E501

        :return: The dependent_fields of this MultiLineTextField.  # noqa: E501
    ...
    def dependent_fields(self, dependent_fields):
        """Sets the dependent_fields of this MultiLineTextField.

        A list of other fields to make visible based on the value filled in for this field.  # noqa: E501

        :param dependent_fields: The dependent_fields of this MultiLineTextField.  # noqa: E501
    ...
    @property
    def label(self):
        """Gets the label of this MultiLineTextField.  # noqa: E501

        The main label for the form field.  # noqa: E501

        :return: The label of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this MultiLineTextField.

        The main label for the form field.  # noqa: E501

        :param label: The label of this MultiLineTextField.  # noqa: E501
        :type label: str
        """
    ...
    def placeholder(self):
        """Gets the placeholder of this MultiLineTextField.  # noqa: E501

        The prompt text showing when the field isn't filled in.  # noqa: E501

        :return: The placeholder of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
    ...
    def placeholder(self, placeholder):
        """Sets the placeholder of this MultiLineTextField.

        The prompt text showing when the field isn't filled in.  # noqa: E501

        :param placeholder: The placeholder of this MultiLineTextField.  # noqa: E501
    ...
    @property
    def field_type(self):
        """Gets the field_type of this MultiLineTextField.  # noqa: E501

        Determines how the field will be displayed and validated.  # noqa: E501

        :return: The field_type of this MultiLineTextField.  # noqa: E501
        :rtype: str
        """
    ...
    def field_type(self, field_type):
        """Sets the field_type of this MultiLineTextField.

        Determines how the field will be displayed and validated.  # noqa: E501

        :param field_type: The field_type of this MultiLineTextField.  # noqa: E501
        :type field_type: str
        """
    ...
    @property
    def required(self):
        """Gets the required of this MultiLineTextField.  # noqa: E501

        Whether a value for this field is required when submitting the form.  # noqa: E501

        :return: The required of this MultiLineTextField.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this MultiLineTextField.

        Whether a value for this field is required when submitting the form.  # noqa: E501

        :param required: The required of this MultiLineTextField.  # noqa: E501
        :type required: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MultiLineTextField):
            return False
