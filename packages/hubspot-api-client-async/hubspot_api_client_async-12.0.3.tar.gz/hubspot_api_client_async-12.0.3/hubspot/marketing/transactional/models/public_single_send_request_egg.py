...
class PublicSingleSendRequestEgg(object):
    ...
    """
    openapi_types = {"custom_properties": "dict[str, object]", "email_id": "int", "message": "PublicSingleSendEmail", "contact_properties": "dict[str, str]"}

    attribute_map = {"custom_properties": "customProperties", "email_id": "emailId", "message": "message", "contact_properties": "contactProperties"}

    def __init__(self, custom_properties=None, email_id=None, message=None, contact_properties=None, local_vars_configuration=None):  # noqa: E501
