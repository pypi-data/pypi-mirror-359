...
class BatchInputSubscriptionBatchUpdateRequest(object):
    ...
    """
    openapi_types = {"inputs": "list[SubscriptionBatchUpdateRequest]"}
    ...
    @property
    def inputs(self):
        """Gets the inputs of this BatchInputSubscriptionBatchUpdateRequest.  # noqa: E501


        :return: The inputs of this BatchInputSubscriptionBatchUpdateRequest.  # noqa: E501
    ...
    def inputs(self, inputs):
        ...
        :param inputs: The inputs of this BatchInputSubscriptionBatchUpdateRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInputSubscriptionBatchUpdateRequest):
            return False
