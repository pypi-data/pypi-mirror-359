...
class PublicQuickReplies(BaseModel):
    ...
    allow_multi_select: StrictBool = Field(alias="allowMultiSelect")
    allow_user_input: StrictBool = Field(alias="allowUserInput")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["quickReplies", "allowMultiSelect", "allowUserInput", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicQuickReplies from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicQuickReplies from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "allowMultiSelect": obj.get("allowMultiSelect"),
            "allowUserInput": obj.get("allowUserInput"),
