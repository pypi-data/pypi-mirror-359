...
class FileAttachment(BaseModel):
    ...
    FileAttachment
    """ # noqa: E501
    file_usage_type: Optional[StrictStr] = Field(default=None, alias="fileUsageType")
    type: StrictStr
    file_id: StrictStr = Field(alias="fileId")
    __properties: ClassVar[List[str]] = ["fileUsageType", "type", "fileId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fileUsageType": obj.get("fileUsageType"),
