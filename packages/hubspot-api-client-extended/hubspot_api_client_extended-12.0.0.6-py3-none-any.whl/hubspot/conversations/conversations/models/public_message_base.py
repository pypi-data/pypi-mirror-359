...
class PublicMessageBase(BaseModel):
    """
    PublicMessageBase
    """ # noqa: E501
    id: StrictStr
    ...
    archived: StrictBool
    type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "conversationsThreadId", "createdAt", "updatedAt", "createdBy", "client", "senders", "recipients", "archived", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicMessageBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicMessageBase from a dict"""
        if obj is None:
            return None
