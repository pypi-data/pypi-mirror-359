...
class PublicThreadInboxChange(BaseModel):
    ...
    archived: StrictBool
    type: StrictStr
    from_inbox_id: StrictStr = Field(alias="fromInboxId")
    to_inbox_id: StrictStr = Field(alias="toInboxId")
    __properties: ClassVar[List[str]] = ["id", "conversationsThreadId", "createdAt", "updatedAt", "createdBy", "client", "senders", "recipients", "archived", "type", "fromInboxId", "toInboxId"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['THREAD_INBOX_CHANGE']):
            raise ValueError("must be one of enum values ('THREAD_INBOX_CHANGE')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicThreadInboxChange from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicThreadInboxChange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'THREAD_INBOX_CHANGE',
            "fromInboxId": obj.get("fromInboxId"),
            "toInboxId": obj.get("toInboxId")
        })
        return _obj
