...
- API Render : [https://data-movie-app-back.onrender.com](https://movie-backend-xelv.onrender.com)
- PyPI : [https://pypi.org/project/ibmoviesdk](https://pypi.org/project/ibmoviesdk)