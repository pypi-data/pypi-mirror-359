...
def get_settings(use_prod: bool = False, use_staging: bool = False) -> Settings:
    if is_editable_install() and not (use_prod or use_staging):
        ...
        base_url = "https://staging.indent.ai"
        base_api_url = "https://staging-api.indent.ai"
        base_ws_url = "wss://ws-staging-api.indent.ai"
        environment = Environment.staging
    else:
        base_url = "https://indent.ai"
        base_api_url = "https://api.indent.ai"
        base_ws_url = "wss://ws-api.indent.ai"
