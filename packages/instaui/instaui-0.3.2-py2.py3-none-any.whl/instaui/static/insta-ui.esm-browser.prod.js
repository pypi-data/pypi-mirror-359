...
var Un = (e, t, n) => t in e ? Fn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var $ = (e, t, n) => Un(e, typeof t != "symbol" ? t + "" : t, n);
import * as Hn from "vue";
import { unref as M, watch as G, nextTick as ke, isRef as Gt, ref as Q, shallowRef as H, watchEffect as zt, computed as W, toRaw as qt, customRef as ie, toValue as Je, readonly as Kn, provide as ve, inject as J, shallowReactive as Gn, defineComponent as D, reactive as zn, h as x, getCurrentInstance as Qt, renderList as qn, TransitionGroup as Jt, cloneVNode as Ne, withDirectives as Yt, normalizeStyle as Qn, normalizeClass as Ve, toDisplayString as $e, vModelDynamic as Jn, vShow as Yn, resolveDynamicComponent as Xn, normalizeProps as Zn, onErrorCaptured as er, openBlock as se, createElementBlock as me, createElementVNode as tr, createVNode as nr, createCommentVNode as rr, createBlock as or, Teleport as sr, renderSlot as ir, Fragment as ar, KeepAlive as cr } from "vue";
let Xt;
function ur(e) {
  Xt = e;
}
...
function et(e, t = !1) {
  ...
  function r(c, f) {
    ...
    return m != null && R.push(
      Ze(m, v).then(() => he(e)).finally(() => (_ == null || _(), he(e)))
    ), Promise.race(R);
  }
  function o(c) {
    return n((f) => !!f, c);
  ...
  function l(c, f) {
    return n((h) => {
      ...
      return g.includes(c) || g.includes(he(c));
    }, f);
  }
  function d(c) {
    return a(1, c);
...
function hr(e, t, n) {
  const {
    ...
    shallow: l = !0,
    throwError: d
  } = {}, a = l ? H(t) : Q(t), c = Q(!1), f = Q(!1), h = H(void 0);
...
function wr(e) {
  ...
  return n === void 0 ? H(t ?? we) : ht(t ?? we);
}
function br(e, t, n) {
  const {
    inputs: r = [],
  ...
  const h = B(o), g = l === 0 ? H(we) : ht(we), m = { immediate: !0, deep: !0 };
  return Zt(h) ? (g.value = u, G(
    c,
    async () => {
  ...
  constructor(t, n, r, o) {
    ...
    t == null || t.forEach((u) => {
      ...
      G(
        h,
        (g) => {
          g.some(be) || (u.modify = !0, this.taskQueue.push(new Dr(u)), this._scheduleNextTick());
        },
        f
      );
    });
...
function ln(e) {
  return typeof e == "function" ? e : Fr(qt(e));
}
function Ur(e, t) {
  const {
    on: n,
  ...
  return G(m, g, { immediate: o, deep: s, once: i, flush: u });
}
function St(e, t, n) {
...
const qr = typeof Proxy == "function", Qr = "devtools-plugin:setup", Jr = "plugin:settings:set";
let oe, ot;
function Yr() {
  var e;
...
function eo(e, t) {
  const n = e, r = fn(), o = zr(), s = qr && n.enableEarlyProxy;
  if (o && (r.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !s))
    o.emit(Qr, e, t);
  else {
    const i = s ? new Zr(n, o) : null;
...
const hn = /#/g, no = /&/g, ro = /\//g, oo = /=/g, so = /\?/g, pn = /\+/g, io = /%5B/g, ao = /%5D/g, gn = /%5E/g, co = /%60/g, mn = /%7B/g, uo = /%7C/g, vn = /%7D/g, lo = /%20/g;
function gt(e) {
  return encodeURI("" + e).replace(uo, "|").replace(io, "[").replace(ao, "]");
}
function fo(e) {
  return gt(e).replace(mn, "{").replace(vn, "}").replace(gn, "^");
}
function st(e) {
  return gt(e).replace(pn, "%2B").replace(lo, "+").replace(hn, "%23").replace(no, "%26").replace(co, "`").replace(mn, "{").replace(vn, "}").replace(gn, "^");
}
function ho(e) {
  return st(e).replace(oo, "%3D");
}
function po(e) {
  return gt(e).replace(hn, "%23").replace(so, "%3F");
}
function go(e) {
  return e == null ? "" : po(e).replace(ro, "%2F");
}
function ae(e) {
  try {
...
const mo = /\/$/, vo = (e) => e.replace(mo, "");
function Ge(e, t, n = "/") {
  let r, o = {}, s = "", i = "";
  const u = t.indexOf("#");
  let l = t.indexOf("?");
  return u < l && u >= 0 && (l = -1), l > -1 && (r = t.slice(0, l), s = t.slice(l + 1, u > -1 ? u : t.length), o = e(s)), u > -1 && (r = r || t.slice(0, u), i = t.slice(u, t.length)), r = _o(r ?? t, n), {
    fullPath: r + (s && "?") + s + i,
    path: r,
    query: o,
    hash: ae(i)
...
function No(e) {
  ...
  function s(l, d, a) {
    const c = e.indexOf("#"), f = c > -1 ? (n.host && document.querySelector("base") ? e : e.slice(c)) + l : Oo() + e + l;
    try {
...
function bn(e) {
  e = En(e);
  const t = No(e), n = ko(e, t.state, t.location, t.replace);
  function r(s, i = !0) {
...
` + JSON.stringify(t) : ""}`;
  ...
  2({ from: e, to: t }) {
    return `Redirected from "${e.fullPath}" to "${$o(t)}" via a navigation guard.`;
  },
  4({ from: e, to: t }) {
...
function ue(e, t) {
  return P.NODE_ENV !== "production" ? V(new Error(Io[e](t)), {
    type: e,
    [at]: !0
  }, t) : V(new Error(), {
    type: e,
  ...
  for (; u < e.length; ) {
    ...
    switch (n) {
      ...
      case 4:
        ...
        break;
      case 1:
        l === "(" ? n = 2 : Wo.test(l) ? f() : (c(), n = 0, l !== "*" && l !== "?" && l !== "+" && u--);
        break;
      case 2:
...
function Fo(e, t) {
  ...
  function s(c, f, h) {
    const g = !h, m = Tt(c);
    P.NODE_ENV !== "production" && Go(m, f), m.aliasOf = h && h.record;
    const v = jt(t, c), _ = [m];
    if ("alias" in c) {
...
See more at https://router.vuejs.org/guide/migration/#Removed-star-or-catch-all-routes.`);
      if (b = Lo(N, f, v), P.NODE_ENV !== "production" && f && j[0] === "/" && qo(b, f), h ? (h.alias.push(b), P.NODE_ENV !== "production" && Ko(h, b)) : (R = R || b, R !== b && R.alias.push(b), g && c.name && !Dt(b) && (P.NODE_ENV !== "production" && zo(c, f), i(c.name))), Sn(b) && l(b), m.children) {
        const U = m.children;
...
function Yo(e) {
  ...
  for (let o = 0; o < r.length; ++o) {
    const s = r[o].replace(pn, " "), i = s.indexOf("="), u = ae(i < 0 ? s : s.slice(0, i)), l = i < 0 ? null : ae(s.slice(i + 1));
    if (u in t) {
      let d = t[u];
...
const Zo = Symbol(P.NODE_ENV !== "production" ? "router view location matched" : ""), Wt = Symbol(P.NODE_ENV !== "production" ? "router view depth" : ""), je = Symbol(P.NODE_ENV !== "production" ? "router" : ""), mt = Symbol(P.NODE_ENV !== "production" ? "route location" : ""), ut = Symbol(P.NODE_ENV !== "production" ? "router view location" : "");
function pe() {
  let e = [];
  function t(r) {
    return e.push(r), () => {
...
function X(e, t, n, r, o, s = (i) => i()) {
  ...
  return () => new Promise((u, l) => {
    ...
    }, a = s(() => e.call(r && r.instances[o], t, n, P.NODE_ENV !== "production" ? es(d, t, n) : d));
...
- props:`, e)), o = a, r = !0), t.resolve(a);
  ...
  }), u = W(() => i.value > -1 && ss(n.params, s.value.params)), l = W(() => i.value > -1 && i.value === n.matched.length - 1 && yn(n.params, s.value.params));
  function d(a = {}) {
    if (os(a)) {
...
const ns = /* @__PURE__ */ D({
  ...
  useLink: Bt,
  setup(e, { slots: t }) {
    const n = zn(Bt(e)), { options: r } = J(je), o = W(() => ({
    ...
    return () => {
      const s = t.default && ts(t.default(n));
...
const Ft = (e, t, n) => e ?? t ?? n, is = /* @__PURE__ */ D({
  name: "RouterView",
  ...
  setup(e, { attrs: t, slots: n }) {
    P.NODE_ENV !== "production" && cs();
    const r = J(ut), o = W(() => e.route || r.value), s = J(Wt, 0), i = W(() => {
      let d = M(s);
    ...
    ve(Wt, W(() => i.value + 1)), ve(Zo, u), ve(ut, o);
    const l = Q();
    return G(() => [l.value, u.value, e.name], ([d, a, c], [f, h, g]) => {
...
function ge(e, t) {
  const n = V({}, e, {
    ...
    matched: e.matched.map((r) => Es(r, ["instances", "children", "aliasOf"]))
  });
  return {
    _custom: {
      type: null,
  ...
  eo({
    ...
    typeof o.now != "function" && console.warn("[Vue Router]: You seem to be using an outdated version of Vue Devtools. Are you still using the Beta release instead of the stable one? You can find the links at https://devtools.vuejs.org/guide/installation.html."), o.on.inspectComponent((a, c) => {
      ...
      L(c.__vrl_devtools) && (c.__devtoolsApi = o, c.__vrl_devtools.forEach((f) => {
        ...
        f.error ? (h = f.error, g = gs, v = ms) : f.isExactActive ? (g = Nn, m = "This is exactly active") : f.isActive && (g = kn, m = "This link is active"), a.tags.push({
          label: h,
          textColor: v,
          tooltip: m,
          backgroundColor: g
    ...
    t.beforeEach((a, c) => {
      const f = {
        guard: Oe("beforeEach"),
        from: ge(c, "Current Location during this navigation"),
        to: ge(a, "Target location")
      };
      ...
      }, h.status = Oe("❌")) : h.status = Oe("✅"), h.from = ge(c, "Current Location during this navigation"), h.to = ge(a, "Target location"), o.addTimelineEvent({
        layerId: s,
        event: {
...
const On = 15485081, kn = 2450411, Nn = 8702998, hs = 2282478, Vn = 16486972, ps = 6710886, gs = 16704226, ms = 12131356;
function Cn(e) {
  const t = [], { record: n } = e;
  n.name != null && t.push({
    label: String(n.name),
...
function _s(e) {
  const t = Fo(e.routes, e), n = e.parseQuery || Yo, r = e.stringifyQuery || Mt, o = e.history;
  if (P.NODE_ENV !== "production" && !o)
    throw new Error('Provide the "history" option when calling "createRouter()": https://router.vuejs.org/api/interfaces/RouterOptions.html#history');
  const s = pe(), i = pe(), u = pe(), l = H(Y);
  let d = Y;
  q && e.scrollBehavior && "scrollRestoration" in history && (history.scrollRestoration = "manual");
  const a = Ke.bind(null, (p) => "" + p), c = Ke.bind(null, go), f = (
  ...
  function _(p, E) {
    if (E = V({}, E || l.value), typeof p == "string") {
      const O = Ge(n, p, E.path), I = t.resolve({ path: O.path }, E), ee = o.createHref(O.fullPath);
...
- Location:`, p), _({});
  ...
  function b(p) {
    return typeof p == "string" ? Ge(n, p, l.value.path) : V({}, p);
  }
  function R(p, E) {
    if (d !== p)
      return ue(8, {
...
${JSON.stringify(w, null, 2)}
 when navigating to "${p.fullPath}". A redirect must contain a name or path. This will break in production.`), new Error("Invalid redirect");
  ...
  function F(p, E) {
    ...
    I.redirectedFrom = E;
    let ee;
    return !A && kt(r, w, y) && (ee = ue(16, { to: I, from: w }), wt(
      w,
      w,
      ...
      !1
    )), (ee ? Promise.resolve(ee) : vt(I, w)).catch((T) => z(T) ? (
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`), Promise.reject(new Error("Infinite redirect in navigation guard"))) : F(
  ...
  function Bn() {
    de || (de = o.listen((p, E, y) => {
      ...
      d = w;
      const A = l.value;
      q && Po(Vt(A.fullPath, y.delta), De()), vt(w, A).catch((k) => z(
        k,
        12
        /* ErrorTypes.NAVIGATION_CANCELLED */
      ) ? k : z(
        ...
        !z(
          ...
          8
          /* ErrorTypes.NAVIGATION_CANCELLED */
        ) ? o.go(-y.delta, !1) : y.type === ce.pop && z(
          k,
          20
          /* ErrorTypes.NAVIGATION_DUPLICATED */
        ) && o.go(-1, !1)), yt(w, A, k);
  ...
  function Le(p) {
    return Pe || (Pe = !p, Bn(), We.list().forEach(([E, y]) => p ? y(p) : E()), We.reset()), p;
  }
  function wt(p, E, y, w) {
    const { scrollBehavior: C } = e;
    if (!q || !C)
      return Promise.resolve();
    const A = !y && So(Vt(p.fullPath, 0)) || (w || !y) && history.state && history.state.scroll || null;
    return ke().then(() => C(p, E, A)).then((k) => k && Ro(k)).catch((k) => Be(k, p, E));
  }
  const Fe = (p) => o.go(p);
  let Ue;
  const Se = /* @__PURE__ */ new Set(), bt = {
    ...
    install(p) {
      const E = this;
      p.component("RouterLink", rs), p.component("RouterView", as), p.config.globalProperties.$router = E, Object.defineProperty(p.config.globalProperties, "$route", {
        enumerable: !0,
        get: () => M(l)
      ...
      p.provide(je, E), p.provide(mt, Gn(y)), p.provide(ut, l);
      const w = p.unmount;
      Se.add(p), p.unmount = function() {
        Se.delete(p), Se.size < 1 && (d = Y, de && de(), de = null, l.value = Y, Ue = !1, Pe = !1), w();
      }, P.NODE_ENV !== "production" && q && ls(p, E, t);
    }
  };
  function re(p) {
...
function fe(e, t) {
  ...
  function i(d) {
    ...
    if (!a)
      return;
    const f = He(a), { id: h } = f.sp, g = r.get(h);
    g.value = c;
  }
  return {
    updateVforInfo: s,
...
function ne(e) {
  const { attached: t, sidCollector: n } = e || {}, [r, o, s] = Ns(n);
  t && r.set(t.sid, t.varMap);
  const i = o ? Rs() : null, u = s ? bs() : null, l = o ? () => i : () => {
  ...
  function f(m) {
    return Or(m) ? () => l()[m.prop] : r.get(m.sid).get(m.id);
  }
  function h(m, v) {
    if (pt(m)) {
      const _ = f(m);
...
function ks(e, t) {
  ...
  if (e.data && e.data.forEach((a) => {
    ...
    const { fv: a, fi: c, fk: f } = e.vfor, { index: h = 0, keyValue: g = null, config: m } = t.initVforInfo, { sid: v } = m, _ = Gr(v);
    if (a) {
      const b = ie(() => ({
        get() {
          const R = _.value;
...
function Cs(e) {
  const { sid: t, items: n = [] } = e.vforConfig, { updateVforInfo: r } = fe(t, {
    initVforInfo: {
      config: e.vforConfig,
      index: e.vforIndex,
  ...
  return () => (r(t, {
    index: e.vforIndex,
    keyValue: e.vforKeyValue
  }), n.length === 1 ? le(n[0]) : n.map((o) => le(o)));
}
function Ht(e) {
...
function Is(e) {
  const { fkey: t, tsGroup: n = {} } = e.config, r = ne(), s = xs(t ?? "index"), i = Ts(e.config, r);
...
const As = (e) => e, $s = (e, t) => t;
function xs(e) {
  const t = pr(e);
  return typeof t == "function" ? t : e === "item" ? As : $s;
}
function Ts(e, t) {
...
function Ds(e) {
  ...
  Re(t) && fe(t);
  const o = ne();
  return () => (typeof r == "boolean" ? r : o.getValue(r)) ? n.map((i) => le(i)) : void 0;
}
const Kt = D(js, {
  props: ["slotConfig"]
});
function js(e) {
  ...
  return Re(t) && fe(t), () => n.map((r) => le(r));
}
const Qe = ":default", Dn = D(Ms, {
  props: ["config"]
});
function Ms(e) {
  ...
  return () => {
    const i = s.getValue(t), u = n.map((l, d) => {
      ...
      return l === i ? x(Kt, { slotConfig: c, key: a }) : null;
    }).filter(Boolean);
    return u.length === 0 && Qe in r ? x(Kt, {
      slotConfig: r[Qe],
      key: Qe
    }) : u;
  };
...
function Hs(e, t) {
  const { code: n, inputs: r = {} } = e, o = Te(
    r,
    (u) => u.type !== K.Data ? t.getVueRefObject(u.value) : u.value
  ), s = B(n, o);
  function i(...u) {
    s(...u);
  }
...
function Ys(e) {
  const { sid: t, items: n } = e.config, r = Re(t) ? fe(t, {
    initSlotPropInfo: {
      value: e.slotPropValue
    }
  }).updateSlotPropValue : Xs;
  return () => (r({ sid: t, value: e.slotPropValue }), n.map((o) => le(o)));
}
function Xs() {
}
function Zs(e, t) {
  if (!e.slots)
    return null;
  const n = e.slots ?? {};
  return t ? ft(n[":"]) : un(n, { keyFn: (i) => i === ":" ? "default" : i, valueFn: (i) => (u) => i.use_prop ? ei(u, i) : ft(i) });
}
function ei(e, t) {
  return x(Js, { config: t, slotPropValue: e });
}
function ti(e, t, n) {
  const r = [], { dir: o = [] } = t;
  return o.forEach((s) => {
...
function oi(e) {
  const { config: t } = e, n = ne({
    sidCollector: new si(t).getCollectInfo()
  }), r = t.props ?? {};
  return Ae(r, !0), () => {
    const { tag: o } = t, s = typeof o == "string" ? o : n.getValue(o), i = Xn(s), u = typeof i == "string", l = Gs(t, n), { styles: d, hasStyle: a } = Ks(t, n), c = Zs(t, u), f = qs(t, r, n), h = Zn(f) || {};
    a && (h.style = d), l && (h.class = l);
    let g = x(i, { ...h }, c);
    return g = Bs(g, t.events ?? {}, n), g = ni(g, t, n), ti(g, t, n);
  };
}
class si {
  constructor(t) {
   ...
   */
  getCollectInfo() {
    const { eRef: t, dir: n, classes: r, bProps: o, proxyProps: s, bStyle: i, events: u } = this.config;
...
function le(e, t) {
  return Rr(e) ? x(xn, { config: e, key: t }) : Pr(e) ? x(Tn, { config: e, key: t }) : Sr(e) ? x(Dn, { config: e, key: t }) : x(ri, { config: e, key: t });
}
function ft(e, t) {
  return x(jn, { slotConfig: e, key: t });
}
const jn = D(ii, {
  props: ["slotConfig"]
});
...
const ui = {
  ...
  setup(e) {
    const t = e, { debug: n = !1 } = t.meta, { config: r, isLoading: o } = ai(
      t.config,
      t.configUrl
    );
    G(r, (u) => {
    ...
    const { hasError: s, errorMessage: i } = ci(n);
    return (u, l) => (se(), me("div", ui, [
      M(o) ? (se(), me("div", li, l[0] || (l[0] = [
        tr("p", { style: { margin: "auto" } }, "Loading ...", -1)
      ]))) : (se(), me("div", {
        key: 1,
        class: Ve(["insta-main", M(r).class])
      }, [
        nr(M(jn), { "slot-config": M(r) }, null, 8, ["slot-config"]),
        M(s) ? (se(), me("div", fi, $e(M(i)), 1)) : rr("", !0)
      ], 2))
    ]));
  }
});
...
function Ri(e, t) {
  ...
  return t ? x(cr, null, () => i) : u;
}
function Pi(e, t) {
  const { mode: n = "hash" } = t.router, r = n === "hash" ? Co() : n === "memory" ? Vo() : bn();
  e.use(
    _s({
      history: r,
      routes: bi(t)
...
function ki(e, t) {
  e.component("insta-ui", di), e.component("vif", Tn), e.component("vfor", xn), e.component("match", Dn), e.component("teleport", wi), e.component("ts-group", pi), e.component("content", mi), e.component("heading", _i), t.router && Pi(e, t);
}
export {
