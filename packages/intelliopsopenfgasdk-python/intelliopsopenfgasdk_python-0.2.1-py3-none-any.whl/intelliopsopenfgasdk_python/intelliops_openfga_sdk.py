    ...
    def __init_datasource(self, create_datasource_model: CreateDataSourceModel) -> None:
        ...
        try:
            response = self.http_client.post(
                init_datasource_endpoint, json=create_datasource_model.model_dump_json()
            )
    ...
    def __init_fga(self, create_fga_model: CreateFgaModel) -> None:
        ...
        try:
            ...
            create_groups_model_response = self.http_client.post(
                create_groups_endpoint, json=create_groups_model.model_dump_json()
            )
            ...
            create_l1_l2_objects_model_response = self.http_client.post(
                create_l1_l2_objects_endpoint, json=create_l1_l2_objects_model.model_dump_json()
            )
    ...
    def check_access(self, check_access_model: CheckAccessModel) -> bool:
        ...
        try:
            response = self.http_client.post(
                ...
                json={
                    "user_id": check_access_model.intelliopsUserUId,
                    "l2_object_id": check_access_model.fgaObjectId,
                },
            )
            response.raise_for_status()
    ...
    def check_multi_access(
        ...
        try:
            response = self.http_client.post(
                ...
                json={
                    "user_id": check_access_model.intelliopsUserUId,
                    "l2_object_id": check_access_model.fgaObjectIds,
                },
            )
            response.raise_for_status()
            res = response.json()
            ...
            }  # Output: {'550568177': True, '669876453': False, '190480451': True}
        except httpx.HTTPStatusError as exc:
            self._handle_http_error(exc)
        except httpx.RequestError as exc:
            self._handle_request_error(exc)
