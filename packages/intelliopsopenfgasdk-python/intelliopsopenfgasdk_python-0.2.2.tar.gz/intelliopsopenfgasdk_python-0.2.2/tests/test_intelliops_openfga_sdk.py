...
class DummyHttpClient:
    ...
    def post(self, url, json=None):
        ...
        if url in ("confluence/create-groups", "/confluence/create-groups"):
            ...
            # Return False for a specific fgaObjectId to test negative case
            if json and json.get("objectId") == "t417ce8a_Confluence_e4448be1-8022-43a2-b234-e467842aac60_19048045":
