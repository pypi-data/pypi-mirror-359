...
CCD_URL = "https://huggingface.co/intelligenAI/CNN/resolve/main/ccd.pkl"
MODEL_URL = (
    "https://huggingface.co/intelligenAI/CNN/resolve/main/intfold_v0.1.0.pt"
)
...
def download(cache: Path) -> None:
    ...
    if not model.exists():
        ...
        try:
            ...
            urllib.request.urlretrieve(MODEL_MIRROR__URL, str(model))  
