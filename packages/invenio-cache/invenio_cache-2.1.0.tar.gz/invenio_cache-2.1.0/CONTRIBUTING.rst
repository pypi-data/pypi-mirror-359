...
Invenio-Cache could always use more documentation, whether as part of the
official Invenio-Cache docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
https://github.com/inveniosoftware/invenio-cache/issues.
...
3. The pull request should work for Python 3.6, 3.7, 3.8 and 3.9. Check
   https://github.com/inveniosoftware/invenio-cache/actions?query=event%3Apull_request
