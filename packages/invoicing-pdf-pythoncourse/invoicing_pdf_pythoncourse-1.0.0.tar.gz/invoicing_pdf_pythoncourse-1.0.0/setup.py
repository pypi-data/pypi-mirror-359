...
setup(
  name = 'invoicing-pdf-pythoncourse',         #* Your package will have this name
  packages = ['invoicing'],   #* Name the package again
  version = '1.0.0',         #* To be increased every time your change your library
  license='MIT',             # Type of license. More here: https://help.github.com/articles/licensing-a-repository. MIT license everyone can use this license
  ...
  keywords = ['invoice', 'excel', 'pdf', 'pythoncourse'],   # Keywords users can search on pypi.org
