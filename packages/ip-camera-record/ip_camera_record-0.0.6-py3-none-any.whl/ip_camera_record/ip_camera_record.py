...
def main(ip_first_segment, ip_second_segment, ip_third_segment, ip_fourth_segment, output_dir, url_template, record_num, record_interval, time_period, ip_update_interval):
    last_check_time = 0
    valid_ip_addrs = []
    while True:
...
def record():
    ...
    main(args.ip_first_segment, args.ip_second_segment, args.ip_third_segment, args.ip_fourth_segment, args.output_dir, args.url_template,
         args.record_num, args.record_interval, args.time_period, args.ip_update_interval)
