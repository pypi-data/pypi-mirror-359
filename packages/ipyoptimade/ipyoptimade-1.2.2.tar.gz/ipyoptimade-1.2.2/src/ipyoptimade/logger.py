...
LOG_FILE = LOG_DIR / "ipyoptimade.log"
...
class ReportLogger(ipw.HTML):
    ...
    def logs(self, _):  # pylint: disable=no-self-use
        ...
        msg = (
            "Will not change 'logs'. Logs should be added through the 'ipyoptimade' logger, "
...
# Instantiate LOGGER
LOGGER = logging.getLogger("ipyoptimade")
...
if os.environ.get("ipyoptimade_DEBUG", None) is None:
    # Default - INFO
    WIDGET_HANDLER.setLevel(logging.INFO)
else:
    # ipyoptimade_DEBUG set - DEBUG
