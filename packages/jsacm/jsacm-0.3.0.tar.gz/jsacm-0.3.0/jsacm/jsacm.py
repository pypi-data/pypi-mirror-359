...
sortedfeatures = [
    ...
    [["Calculators"],[
        ...
        'agecalc = age calculator {YYYY-MM-DD}',
    ...
    [["Encryption"],[
        "ceasar_encryption = ceasar cypher {phrase, 'random' or 'custom', cusotm key}",
        'asymetrical_encryption = binary two step assymetrical encryption {binary}',
        'atbash_encryption = simple abtash encryption {phrase}',
        'keyboard_encryption = simple keyboard code encryption {phrase}'
            ]],
    [["Decryption"],[
        "ceasar_decryption = ceasar cypher {encrypted msg, 'all' or 'custom', custom key}",
        'asymetrical_decryption = binary two step assymetical decryption {encrypted binary, public key, private key}',
        'abtash_decryption = simple abtash decryption {phrase}',
        'keyboard_decryption = simple keyboard code decryption {phrase}'
        ]],
    [["Converstion"],[
    ...
    [["Sorts"],[
        'bubblesort = bubble sort {list}',
        'bogosort = bogo sort {list}',
        'stalinsort = stalin sort {list}'
        ]],
    [["Searches"],[
        'linearsearch = linear search {list, number}'
        ]]
    ]
...
def dbedit(*argv):
    ...
    conn.commit()
############################################################Rockpaperscissors### CHECKED TRUE
...
############################################################checkofftodolist### CHECKED FALSE
...
############################################################file type converter### CHECKED TRUE
...
############################################################password generator### CHECKED TRUE
def passgen(*argv):
    loop = 0
    check = False
    for arg in argv:
    ...
    if check == True:
        ...
        print(f"Generated password: {passwrd}")

############################################################ewans module### CHECKED TRUE
def ewans(*argv):
    print("Spam,Eggs and Ham")
    
    
############################################################profit calculator### CHECKED TRUE
def profitcalc(*argv):
    loop = 0
    check = False
    for arg in argv:
...
############################################################rickroll### CHECKED TRUE :: ONLY WINDOWS
def rickroll(*argv):
...
def binary2denary(*argv): # can take: binary
    ...
    if check == True:
        ...
        print(answer)
############################################################denary to hexadecimal### CHECKED TRUE
def denary2hexadecimal(*argv): # can take: number
    ...
    if check == True:
        ...
        print(answer)
############################################################denary to roman numerals### CHECKED TRUE
def denary2numeral(*argv): # can take: number
    ...
    if check == True:
        ...
        print(answer)
############################################################roman numeral to denary### CHECKED TRUE
...
############################################################asymetrical encryption### CHECKED TRUE
...
############################################################asymetrical decryption### CHECKED TRUE
def asymetrical_decryption(*argv): # can take input of: encrypted binary, public key, private key
    loop = 0
    check = False
    for arg in argv:
        check = True
...
############################################################ceasar encryption### CHECK TRUE
def ceasar_encryption(*argv): # can take input of: phrase, "random" or "custom" shift, if custom also custom number
    ans = []
    import string
    import random
    loop = 0
...
############################################################ceasar decryption### CHECKED TRUE
def ceasar_decryption(*argv): # can take input of: encrypted message, "all" or "custom" cypher key, if custom then also custom key
    import string
...
############################################################atbash encryption### CHECKED TRUE
def atbash_encryption(*argv): # can take: phrase
    usrinp = []
    backwards = []
    ans = ""
    for i in alphabet:
...
############################################################atbash decryption### CHECKED TRUE
def atbash_decryption(*argv): # can take: phrase
    usrinp = []
    backwards = []
    ans = ""
    for i in alphabet:
...
############################################################keyboard code encryption### CHECKED TRUE
def keyboard_encryption(*argv):
    usrinp = []
    ans = ""
    loop = 0
    check = False
...
############################################################keyboard code decryption### CHECKED TRUE
def keyboard_decryption(*argv): # can take: phrase
    usrinp = []
    ans = ""
    loop = 0
    check = False
    ...
    if check == True:
        ...
        print(ans)
############################################################bogo sort### CHECKED TRUE
def bogosort(*argv): # can take: 
    import random
    data = []
    sorteddata = []
    loop = 0
    ...
    if check == True:
        ...
        print(data)
############################################################bubbble sort### CHEKCED TRUE 
def bubblesort(*argv): # can take: list
    loop = 0
    lyst = []
    check = False
    for arg in argv:
    ...
    if check == True:
        ...
        print(lyst)
############################################################stalin sort### CHECKED TRUE
def stalinsort(*argv): # can take: list
    not_sorted = []
    result = []
    import random
    loop = 0
    ...
    for i in not_sorted:
        if i > prev:
            ...
            print(i,"<",prev)
    print(result)
############################################################linear search### CHECKED TRUE
def linearsearch(*argv): # can take: list, number
    loop = 0
    lyst = []
    check = False
    for arg in argv:
