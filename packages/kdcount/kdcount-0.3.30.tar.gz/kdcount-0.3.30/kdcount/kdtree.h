...
int
kd_fof_prefernodes(KDNode * tree, double linklength, ptrdiff_t * head);
int
kd_fof_buggy(KDNode * tree, double linklength, ptrdiff_t * head);
void
...
void
kd_forcea(double * pos, size_t n,
        KDNode * node, KDAttr * mass, KDAttr * xmass,
        double r_cut, double eta, double * force,
        kd_force_func func, void * userdata);

void
kd_force2(KDNode * target, KDNode * node,
        KDAttr * mass, KDAttr * xmass,
        double r_cut, double eta, double * force,
        kd_force_func func, void * userdata);
