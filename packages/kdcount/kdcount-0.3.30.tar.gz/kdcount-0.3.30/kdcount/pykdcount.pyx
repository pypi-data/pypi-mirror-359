...
cdef void kd_force_func_count(double r, double * dx, double * f, int ndims, void * userdata) noexcept:
...
cdef void kd_force_func_plummer(double r, double * dx, double * f, int ndims, void * userdata) noexcept:
    cdef double ir3
