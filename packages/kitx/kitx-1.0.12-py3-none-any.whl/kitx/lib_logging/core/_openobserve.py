...
class ObserveConfig(BaseSettings):
    ...
    Observe配置
    """
    observe_host: str = '172.20.0.2'
    observe_port: int = 40000
    observe_base_dir: str = "/logs"
    observe_username: str = 'root@qq.com'
    observe_password: str = 'admin'
    observe_organization: str = ""  # 项目名
    observe_stream: str = ""  # 环境+版本等
...
class ObServe:
    ...
    def __init__(self, conf: Optional[ObserveConfig] = None):
        ...
        # 初始化连接池
        self.httpx_client = httpx.AsyncClient(timeout=2,
