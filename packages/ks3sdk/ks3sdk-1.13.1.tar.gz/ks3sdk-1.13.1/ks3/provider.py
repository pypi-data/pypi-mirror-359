...
MIGRATION_SOURCE_HEADER_KEY = 'migration-source'
...
class Provider(object):
    ...
    HeaderInfoMap = {
        'kss': {
            ...
            MIGRATION_SOURCE_HEADER_KEY: KSS_HEADER_PREFIX + 'migration-source'
        },
        'aws': {
...
#        self._secret_key = self._convert_key_to_str(self._secret_key)
    ...
    def configure_headers(self):
        ...
        self.migration_source_header = header_info_map[MIGRATION_SOURCE_HEADER_KEY]
