"""Wrapper around GreenNode Serverless AI's Embeddings API."""
...
class GreenNodeEmbeddings(BaseModel, Embeddings):
    """GreenNode embedding model integration.

    Setup:
        Install ``langchain_greennode`` and set environment variable
        ``GREENNODE_API_KEY``.

        .. code-block:: bash

            pip install -U langchain_greennode
            export GREENNODE_API_KEY="your-api-key"

    Key init args — completion params:
        model: str
            Name of GreenNode Serverless AI model to use.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from __module_name__ import GreenNodeEmbeddings

            embed = GreenNodeEmbeddings(
                model="BAAI/bge-m3",
                # api_key="...",
                # other params...
            )
    ...
    Instead, use 'BAAI/bge-m3' for example.
    """
