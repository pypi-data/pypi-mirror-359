...
class TestFactoryFunctions:
    ...
    def test_create_assistant_openai_provider(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_openai_provider_defaults(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_gemini_provider(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_vllm_provider(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_default_provider(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_with_custom_config_path(self, mock_load_config):
        ...
        result = create_assistant(
            response_model=MockResponse,
            config_path="/custom/path/api.yaml"
        )
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_with_additional_kwargs(self, mock_load_config):
    ...
    def test_create_chat_streaming(self, mock_chat_streaming_class, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    @patch("langchain_llm_config.factory.ChatStreaming")
    def test_create_chat_streaming_default_provider(self, mock_chat_streaming_class, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    @patch("langchain_llm_config.factory.ChatStreaming")
    def test_create_chat_streaming_with_custom_config_path(self, mock_chat_streaming_class, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_openai(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_vllm(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_infinity(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_default(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_with_custom_config_path(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_with_additional_kwargs(self, mock_load_config):
        ...
        result = create_embedding_provider(
            provider="openai",
            timeout=60  # Valid parameter for embedding providers
        )
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_embedding_provider_unsupported_provider(self, mock_load_config):
    ...
    @patch("langchain_llm_config.factory.load_config")
    def test_create_assistant_unsupported_provider(self, mock_load_config):
