...
if __name__ == "__main__":
    ...
    # site_name='Science-NCERT' 
    
    # # file_name = "Class 8/C8S05 - Coal and Petroleum/Questions/C8S05 - Q -Coal and Petroleum #.pptx"
    
    # large_file_path = "test_folder/vlc-3.0.21-win64.exe"
    
    # client.upload_file_by_site_name_drive_name_and_file_path(
    #     site_name=site_name,
    #     local_file_path="vlc-3.0.21-win64.exe",
    #     sharepoint_file_path="test/vlc-3.0.21-win64.exe",
    #     is_print_progress=True
    # )
    
    SITE_NAME = "Content"
    
    drive_name = "Academic Year Details"
    
    files = client.get_folder_content_by_site_name_drive_name_and_folder_path(site_name=SITE_NAME, folder_path="AY 2025 - 2026/Math team data/LWS/Class 6/NCERT 2024/4 - LWS - Data Handling and Presentation  - NCERT 2024 (CBSE) [866]", drive_name=drive_name)
