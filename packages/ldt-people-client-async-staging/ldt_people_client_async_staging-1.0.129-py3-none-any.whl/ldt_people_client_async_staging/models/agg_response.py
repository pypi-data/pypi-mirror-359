...
class AggResponse(BaseModel):
    ...
    buckets: List[AggResponseBucketsInner]
    other: Optional[Union[StrictFloat, StrictInt]]
    __properties: ClassVar[List[str]] = ["id", "field", "buckets", "other"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AggResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AggResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "field": obj.get("field"),
            "buckets": [AggResponseBucketsInner.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None,
            "other": obj.get("other")
        })
        return _obj
