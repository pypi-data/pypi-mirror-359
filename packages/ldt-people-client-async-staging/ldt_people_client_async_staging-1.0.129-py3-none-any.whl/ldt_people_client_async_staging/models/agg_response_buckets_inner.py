...
class AggResponseBucketsInner(BaseModel):
    """
    AggResponseBucketsInner
    """ # noqa: E501
    value: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AggResponseBucketsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AggResponseBucketsInner from a dict"""
        if obj is None:
            return None
