...
class Find200ResponseMatchesInnerPeopleInner(BaseModel):
    """
    Find200ResponseMatchesInnerPeopleInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "info_change_detected_at", "title_change_detected_at", "company_change_detected_at", "position", "jobs", "education", "first_name", "last_name", "name", "linkedin", "country", "connections", "location", "cell_phone_number", "location_details", "employment_status", "score"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Find200ResponseMatchesInnerPeopleInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Find200ResponseMatchesInnerPeopleInner from a dict"""
        if obj is None:
            return None
