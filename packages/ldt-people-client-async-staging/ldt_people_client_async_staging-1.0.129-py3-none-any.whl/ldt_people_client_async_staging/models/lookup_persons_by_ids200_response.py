...
class LookupPersonsByIds200Response(BaseModel):
    """
    LookupPersonsByIds200Response
    """ # noqa: E501
    people: Optional[List[Person]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["people", "count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LookupPersonsByIds200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LookupPersonsByIds200Response from a dict"""
        if obj is None:
            return None
