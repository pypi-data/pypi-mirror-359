...
class SampleCompany(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "linkedin", "domain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleCompany from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleCompany from a dict"""
        if obj is None:
            return None
