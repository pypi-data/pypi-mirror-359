...
class SearchPersonsDataPreviewRequest(BaseModel):
    """
    SearchPersonsDataPreviewRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort_by", "aggs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchPersonsDataPreviewRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchPersonsDataPreviewRequest from a dict"""
        if obj is None:
            return None
