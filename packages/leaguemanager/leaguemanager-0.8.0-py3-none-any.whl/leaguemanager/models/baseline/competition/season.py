...
from leaguemanager.models.base import CompetitionBase, mapper, metadata
...
class Season(CompetitionBase):
    ...
    projected_start_date: datetime | None = field(default=None)
    projected_end_date: datetime | None = field(default=None)
...
mapper.map_imperatively(
    ...
    properties={
        ...
        "ruleset": relationship("Ruleset", back_populates="season"),
    },
)
