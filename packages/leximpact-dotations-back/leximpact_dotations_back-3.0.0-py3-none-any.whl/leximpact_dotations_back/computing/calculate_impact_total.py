...
def format_total_impact_base(
    ...
    for dotation in DotationOpenFisca:
        ...
        filtre_dotation_positive = dotations_simulation.criteres[dotation_colonne_dgcl].astype(float) > 1e-10  # epsilon de marge d'erreur au lieu de la comparaison exacte
...
def format_total_impact_reform(
    ...
    for dotation in DotationOpenFisca:
        ...
        dotation_colonne_dgcl = mapping_montants_dotations_openfisca_to_dgcl[dotation.value]
        base_dgcl_filtre_dotation_positive = dotations_simulation.criteres[dotation_colonne_dgcl] != "0.0"
