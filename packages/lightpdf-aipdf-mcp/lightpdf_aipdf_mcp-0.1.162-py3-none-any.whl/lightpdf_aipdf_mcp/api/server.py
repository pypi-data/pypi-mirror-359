...
async def extract_pdf_tables(
    ...
    Features:
    - Automatically detects and extracts table structures from all PDF pages
    - Converts tables to Excel (.xlsx) format with proper formatting
    - Supports multi-page PDFs with multiple tables
    - Preserves table headers, data types, and basic formatting
    
    Use cases:
    - Extract financial data from PDF reports
    - Convert tabular data from research papers
    - Process invoice or receipt tables
    - Extract data from forms and surveys
