...
if __name__ == '__main__':
    host = 'r-bp16vbem7ydwhzkw0hpd.redis.rds.aliyuncs.com'
    link_filter_udf = LinkFilter(rds_host=host, rds_port=6379, rds_password='Spider666Linux')
    r = link_filter_udf.manual_evaluate("https://m.jd.com/wiki/disease/xxx", rules={
        "jd.com": [
            {
                "rule": {"host": [["equal", "m.jd.com"]], "path": [["startswith", "wiki/disease/"]]}
            }
        ]
    })
    print(r)
    print(link_filter_udf.evaluate("https://ewing-gallery.utk.edu/past-exhibitions/?album_gallery_id_0=209&album_gallery_id_1=203&album_gallery_id_2=191&album_gallery_id_3=181&album_gallery_id_4=156&album_gallery_id_5=142&album_gallery_id_6=107&page_number_4=1&type_0=gallery&type_1=gallery&type_2=gallery&type_3=gallery&type_4=gallery&type_5=gallery&type_6=gallery"))
