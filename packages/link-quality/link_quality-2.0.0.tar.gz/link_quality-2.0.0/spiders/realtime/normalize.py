...
if __name__ == '__main__':
    ...
    link_filter_udf = Normalizer(rds_host=host, rds_port=6379, rds_password='Spider666Linux')
    print(link_filter_udf.evaluate("https://passport.baidu.com/static/phoenix/scripts/jssdk/all.js?v=1751367739443"))
