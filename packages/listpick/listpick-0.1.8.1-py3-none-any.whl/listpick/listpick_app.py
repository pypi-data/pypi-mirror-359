                ...
                for highlight in self.highlights:
                    ...
                    try:
                        if highlight["field"] == "all":
                            ...
                            highlight_start = match.start() - self.leftmost_char
                            highlight_end = match.end() - self.leftmost_char
                            ...
                            highlight_start = field_start + match.start() - self.leftmost_char
                            highlight_end = match.end() + field_start - self.leftmost_char
                            if match.end()+field_start - self.leftmost_char < 0:
                                continue
                        else:
                            continue
                        ...
                        self.stdscr.addstr(y, max(startx, startx+highlight_start), row_str[highlight_start:min(w-startx, highlight_end)], curses.color_pair(self.colours_start+highlight["color"]) | curses.A_BOLD)
