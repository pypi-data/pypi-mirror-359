...
@pro_aws_provider(api='batch',name='v2')
def batch_v2():from localstack.pro.core.services.batch.v2.provider import BatchProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
