...
from src.example.exam_const import CHAT_ID_SINGLE, PORT
from src.lotuschat_sdk.control import ChatBot
from src.lotuschat_sdk.control.bot import Argument
from src.lotuschat_sdk.model.data import Message
...
class Test:
    ...
    async def on_temp_command(self, args: list[Argument], chat_id: int, message: Message):
        ...
        await self.bot.send_message(
            ...
            text="python bot receive temp command"
        )
...
async def lc_webhook():
    return await control.bot.web_hook_quart()
