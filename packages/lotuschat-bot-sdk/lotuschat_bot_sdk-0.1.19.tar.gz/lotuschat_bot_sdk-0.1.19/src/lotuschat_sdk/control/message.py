...
def message_action(cls):
    ...
    async def send_document(self, chat_id: int, file_path: str, caption: str = None, reply_id: int = None):
        return await self._send_media("sendDocument", chat_id, file_path, caption, reply_id)

    async def send_photo(self, chat_id: int, file_path: str, caption: str = None, reply_id: int = None):
        return await self._send_media("sendPhoto", chat_id, file_path, caption, reply_id)

    async def send_audio(self, chat_id: int, file_path: str, caption: str = None, reply_id: int = None):
        return await self._send_media("sendAudio", chat_id, file_path, caption, reply_id)

    async def send_voice(self, chat_id: int, file_path: str, caption: str = None, reply_id: int = None):
        return await self._send_media("sendVoice", chat_id, file_path, caption, reply_id)

    async def send_animation(self, chat_id: int, file_path: str, caption: str = None, reply_id: int = None):
        return await self._send_media("sendAnimation", chat_id, file_path, caption, reply_id)

    async def _send_media(self, path_name: str, chat_id: int, file_path: str, caption: str = None, reply_id: int = None):
