...
class InferenceInterface:
    ...
    async def inference(
        ...
        return await self._apply_post_processing(
            raw_results, input1, post_processing_config, stream_key
        )
    ...
    async def _apply_post_processing(
        ...
        try:
            ...
            result = self.post_processor.process(raw_results, config_to_use, input1, stream_key=stream_key)
        ...
        try:
            ...
            for i, result in enumerate(batch_results):
                ...
                if apply_post_processing:
                    ...
                    processed_result, post_processing_result = (
                        await self._apply_post_processing(result, input1, config, stream_key)
                    )
