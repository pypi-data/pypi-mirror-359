...
class PostProcessor:
    ...
    def process(self, data: Any, config: Union[BaseConfig, Dict[str, Any], str, Path], input_bytes: Optional[bytes] = None,
                context: Optional[ProcessingContext] = None, stream_key: Optional[str] = None) -> ProcessingResult:
        """
    ...
    def process_simple(self, data: Any, usecase: str, 
        ...
        try:
            ...
            return self.process(data, config, context=context, stream_key=stream_key)
    ...
    def process_from_file(self, data: Any, config_file: Union[str, Path],
                         context: Optional[ProcessingContext] = None,
                         stream_key: Optional[str] = None) -> ProcessingResult:
        """
