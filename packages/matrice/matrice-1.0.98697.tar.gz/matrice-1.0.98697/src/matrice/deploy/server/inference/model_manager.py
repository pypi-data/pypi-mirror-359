...
class ModelManager:
    ...
    def _create_prediction_wrapper(self, predict_func):
        ...
        def wrapper(model, input1, input2=None, extra_params=None, stream_key=None) -> dict:
    ...
    def inference(self, input1, input2=None, extra_params=None, stream_key=None) -> tuple[dict, bool]:
        ...
        try:
            ...
            # Run prediction
            results = self.predict(model, input1, input2, extra_params, stream_key)
    ...
    def batch_inference(
        self, input1, input2=None, extra_params=None, stream_key=None
    ) -> tuple[dict, bool]:
        ...
        try:
            ...
            results = self.batch_predict(model, input1, input2, extra_params, stream_key)
