TOOL_PARAM_MAP = {
    ...
    "mcp_cldkctl_cldkctl_org_member_add": {
        ...
        "method": "POST",
        "required_params": [
            {"name": "fullname", "type": "string", "desc": "Full name of the user"},
            {"name": "email", "type": "string", "desc": "Email address of the user"},
            {"name": "organization_role_id", "type": "integer", "desc": "Organization role ID"},
            {"name": "role_id", "type": "integer", "desc": "Role ID (1=Owner, 2=Member)"},
            {"name": "phone_number", "type": "string", "desc": "Phone number"},
            {"name": "projects", "type": "list", "desc": "List of project dicts (e.g. [{project_id, status, openstack_project_id}])"},
            {"name": "type", "type": "string", "desc": "Type (usually 'member')"},
            {"name": "external_subdomain", "type": "string", "desc": "Organization subdomain"},
            {"name": "host", "type": "string", "desc": "Organization host"}
        ],
        "optional_params": [],
    },
