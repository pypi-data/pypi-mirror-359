TOOL_PARAM_MAP = {
    ...
    "mcp_cldkctl_cldkctl_org_member_add": {
        ...
        "method": "POST",
        "required_params": [
            {"name": "fullname", "type": "string", "desc": "Full name of the new member"},
            {"name": "email", "type": "string", "desc": "Email address of the new member"},
            {"name": "role_id", "type": "integer", "desc": "Role ID to assign"},
            {"name": "project_ids", "type": "list", "desc": "List of project IDs"}
        ],
        "optional_params": [
            {"name": "organization_role_id", "type": "integer", "desc": "Organization Role ID (optional)"},
            {"name": "phone_number", "type": "string", "desc": "Phone number (optional)"},
            {"name": "type", "type": "string", "desc": "Type (optional)"},
            {"name": "external_subdomain", "type": "string", "desc": "External subdomain (optional)"},
            {"name": "host", "type": "string", "desc": "Host (optional)"}
        ],
    },
    ...
    "mcp_cldkctl_cldkctl_org_role_add": {
        ...
        "required_params": [
            ...
            {"name": "privilege_names", "type": "list", "desc": "List of privilege names (strings)"},
        ],
        "optional_params": [],
    },
    # --- Kubernetes ---
    ...
    "mcp_cldkctl_cldkctl_org_edit": {
        ...
        "required_params": [
            ...
            {"name": "org_data_json", "type": "string", "desc": "Organization data as JSON string (will be parsed in server.py)"},
        ],
        "optional_params": [],
    },
