...
agent_apis = [
    {
        ...
        "description": "一位专业影院导览员，具备丰富的电影知识，能用清晰、生动且易懂的语言，为用户提供全方位的电影观赏引导与服务，让大家尽情沉浸于电影的精彩世界。"
    },
    {
        "parameters": {
            "type": "object", 
    ...
    },
    {
        ...
        "description": "提供新闻资讯的内容播报服务，包括新闻事件、社会动态、财经动态、文化活动、体育新闻、科技新闻等各类资讯的详细内容、背景信息、相关解读等。适用于需要了解当前各类新闻资讯内容的查询。仅限新闻播报，不提供搜索服务。"
    },
    {
        "parameters": {
            "type": "object", 
        ...
        "description": "查找需要实时获取或搜索的具体信息，包括但不限于：实时数据查询（天气、交通等）、操作方法指导、需要外部搜索的知识点解答、网站信息等。适用于无法直接回答，需要最新、准确、具体答案的查询需求。"
    }
]
...
async def test_agent_prompt_comprehensive():
    ...
    markdown_content.append(f"**测试模型**: deepseek-chat")
    markdown_content.append("")
