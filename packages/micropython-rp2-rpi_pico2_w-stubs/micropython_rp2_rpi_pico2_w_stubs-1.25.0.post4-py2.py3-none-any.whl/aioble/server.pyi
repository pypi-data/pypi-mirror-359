...
class BaseCharacteristic:
    ...
    async def written(self, timeout_ms: Incomplete | None = None): ...
...
class Characteristic(BaseCharacteristic):
    ...
    def _tuple(self): ...
    def notify(self, connection, data: Incomplete | None = None) -> None: ...
    async def indicate(self, connection, data: Incomplete | None = None, timeout_ms: int = 1000) -> None: ...
...
class Descriptor(BaseCharacteristic):
    ...
    _value_handle: Incomplete
    _initial: Incomplete
    def __init__(self, characteristic, uuid, read: bool = False, write: bool = False, initial: Incomplete | None = None) -> None: ...
    def _tuple(self): ...
