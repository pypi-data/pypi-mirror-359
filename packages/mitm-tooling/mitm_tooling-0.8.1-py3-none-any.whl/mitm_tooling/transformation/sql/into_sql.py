...
from mitm_tooling.representation.sql import SQLRepresentationSchema, SQLRepInsertionResult
from mitm_tooling.representation.sql import mk_sql_rep_schema, insert_data
...
from mitm_tooling.utilities.sql_utils import EngineOrConnection, create_sa_engine


def insert_mitm_data(bind: EngineOrConnection, sql_rep_schema: SQLRepresentationSchema, mitm_data: MITMData) -> SQLRepInsertionResult:
...
def insert_exportable(target: AnyDBBind,
                      sql_rep_schema: SQLRepresentationSchema,
                      source: AnyDBBind,
                      exportable: Exportable,
                      stream_data: bool = False) -> SQLRepInsertionResult:
    def instances() -> TypedMitMDataFrameStream:
...
def append_exportable(target: AnyDBBind,
                      sql_rep_schema: SQLRepresentationSchema,
                      source: AnyDBBind,
                      exportable: Exportable,
                      stream_data: bool = False) -> SQLRepInsertionResult:
