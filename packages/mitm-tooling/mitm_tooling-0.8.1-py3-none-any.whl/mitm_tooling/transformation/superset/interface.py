...
from .asset_bundles import DatasourceIdentifierBundle, SupersetDatasourceBundle, \
    SupersetVisualizationBundle, SupersetMitMDatasetBundle, MitMDatasetIdentifierBundle
...
def mk_superset_mitm_dataset_bundle(header: Header,
                                    ...
                                    just_placeholders: bool = False) -> SupersetMitMDatasetBundle:
    ...
    if visualization_types is not None:
        mitm_dataset_bundle = mitm_dataset_bundle.replace_visualization_bundle(
            mk_superset_visualization_bundle(header,
                                             mitm_dataset_bundle.identifiers,
                                             visualization_types,
                                             just_placeholders=just_placeholders))
