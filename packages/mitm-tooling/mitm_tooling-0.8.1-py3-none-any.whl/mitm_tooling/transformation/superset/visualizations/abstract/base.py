...
from ...asset_bundles import SupersetVisualizationBundle, NamedChartIdentifierMap
from ...definitions import DatasetIdentifier, SupersetChartDef, \
    SupersetDashboardDef, DatasetIdentifierMap, DashboardIdentifier, ChartIdentifier
...
class ChartCreator(ABC):
    ...
    def build_chart(self,
                    ...
                    chart_identifier: ChartIdentifier) -> SupersetChartDef:
        ...

    def mk_chart(self,
                 dataset_identifier: DatasetIdentifier,
                 chart_identifier: ChartIdentifier | None = None) -> SupersetChartDef:
...
class DashboardCreator(ABC):
    ...
    def mk_dashboard(self,
        ...
        return self.build_dashboard(ds_id_map,
                                    chart_collection,
    ...
    def mk_bundle(self,
                  ...
                  viz_collection: str = 'default') -> SupersetVisualizationBundle:
        ...
        return SupersetVisualizationBundle(charts=list(selected_charts.values()),
                                           dashboards=[dashboard],
                                           named_charts={name: ch.identifier for name, ch in selected_charts.items()},
                                           viz_collections={
                                               viz_collection: {self.viz_name: dashboard.identifier}})
