...
from mitm_tooling.representation.sql import mk_sql_rep_schema, SQLRepresentationSchema
from .base import DashboardCreator
from ...asset_bundles import SupersetVisualizationBundle, MitMDatasetIdentifierBundle
from ...definitions import MitMDatasetIdentifier, DashboardIdentifier
...
def find_dash_id(mitm_dataset_identifiers: MitMDatasetIdentifierBundle,
                 viz_collection: str,
                 dash_name: str) -> DashboardIdentifier | None:
...
class MitMVisualizationsCreator(ABC):
    ...
    def mk_dashboard_bundles(self, mitm_dataset_identifiers: MitMDatasetIdentifierBundle) -> dict[
        ...
        return {name: creator.mk_bundle(mitm_dataset_identifiers.ds_id_map,
    ...
    @classmethod
    def wrap_dashboard_creator(cls,
                               viz_name: str,
                               dashboard_creator_cls: Type[MitMDashboardCreator], dashboard_name: str | None = None) -> \
            Type[Self]:
