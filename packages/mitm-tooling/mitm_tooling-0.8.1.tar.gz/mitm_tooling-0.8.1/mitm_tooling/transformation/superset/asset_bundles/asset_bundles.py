...
from .identifier import VizCollectionIdentifierMap, DatasourceIdentifierBundle, \
    MitMDatasetIdentifierBundle, VisualizationsIdentifierBundle, NamedChartIdentifierMap
...
class SupersetVisualizationBundle(SupersetAssetBundle):
    ...
    def take_viz(self, viz_name: str) -> Self | None:
        ...
        if coll := self.viz_identifier_map.get(viz_name):
            ...
            return self.__class__(charts=list(self.charts),
                                  dashboards=dashes,
...
class SupersetMitMDatasetBundle(SupersetAssetBundle):
    ...
    def replace_visualization_bundle(self, visualization_bundle: SupersetVisualizationBundle) -> Self:
        ...
        return self.__class__(
            mitm_dataset=mk_mitm_dataset(name=mitm_ds.dataset_name,
                                         mitm=mitm_ds.mitm,
                                         uuid=mitm_ds.uuid,
