...
@overload
def pick_from_mapping(d: Mapping[K, T], keys: Sequence[K]) ->  list[T]: ...


@overload
def pick_from_mapping(d: Mapping[K, T], keys: Sequence[K], *, with_key: Literal[True]) ->list[tuple[K, T]]: ...


@overload
def pick_from_mapping(d: Mapping[K, T], keys: Sequence[K], *, with_key: Literal[False]) ->  list[T]: ...


def pick_from_mapping(d: Mapping[K, T], keys: Sequence[K], *, with_key: bool = False) -> list[T] | list[tuple[K, T]]:
    if with_key:
