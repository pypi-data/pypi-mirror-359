...
from ml_golem.grid_search.grid_search_builder import GridJobBuilder, GridJobViewer
...
def get_args_and_actions(app_title,system_config_path,_add_additional_args):
    ...
    parser.add_argument(f'-{ReservedArgKeywords.INFERENCE_SHORT.value}', f'--{ReservedArgKeywords.INFERENCE.value}', action= 'store_true', help='Have the model make inferences')
