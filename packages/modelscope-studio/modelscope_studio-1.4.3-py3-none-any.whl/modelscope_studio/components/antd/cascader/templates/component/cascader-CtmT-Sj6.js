import { i as be, a as B, r as Ie, b as ve, w as F, g as Ee, c as Re } from "./Index-BDm2Y59C.js";
  ...
  return {
    ...
    l(l) {
      n = ue(l, "REACT-PORTAL-TARGET", {
        class: !0
      }), ie(n).forEach(j), r = Qe(l), t && t.l(l), c = $(), this.h();
    },
    h() {
      fe(n, "class", "svelte-1rt0kpf");
    },
...
function mn(e, n, r) {
  ...
  return e.$$set = (f) => {
    r(17, n = K(K({}, n), ee(f))), "svelteInit" in f && r(5, u = f.svelteInit), "$$scope" in f && r(6, l = f.$$scope);
