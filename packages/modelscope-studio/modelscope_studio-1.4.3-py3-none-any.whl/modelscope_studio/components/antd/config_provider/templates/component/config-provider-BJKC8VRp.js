import { i as vt, a as de, r as xt, w as L, g as St, b as jt, c as Be, d as Ct } from "./Index-bPAJxBb0.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-CAd2BPdg.js").then((e) => e.a), import("./ar-40rgWLqi.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-CGmVHOCa.js").then((e) => e.a), import("./az-4wjmTLcq.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-BQ8r6wIw.js").then((e) => e.b), import("./bg-BOt1-YkH.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-csKHi5ee.js").then((e) => e.b), import("./bn-CuhaD86V.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-G-fi1474.js").then((e) => e.b),
      import("./be-CBABZev2.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-8gKGEQyP.js").then((e) => e.c), import("./ca-KIh6rFqi.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-CfassY1j.js").then((e) => e.c), import("./cs-C9FJ1izk.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-CiyKuuMD.js").then((e) => e.d), import("./da-2GfFEL2y.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-BlbscAEo.js").then((e) => e.d), import("./de-Dyy70gNe.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-CvfQKeDy.js").then((e) => e.e), import("./el-BSCnsGbK.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-VQhHOiIZ.js").then((e) => e.e), import("./en-gb-CO7SIYQN.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-WE7Hm-rM.js").then((e) => e.e), import("./es-DXidI3pk.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-DK0NsRoJ.js").then((e) => e.e), import("./et-DCaT8HX_.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-BPKzoFva.js").then((e) => e.e),
      import("./eu-4vkp924K.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-DgY59f1T.js").then((e) => e.f), import("./fa-BgO3XtZ0.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-DKJ_ailN.js").then((e) => e.f), import("./fi-BiDvB9A6.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-DufKALcD.js").then((e) => e.f), import("./fr-gZVwD6s4.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-D0VtpzCr.js").then((e) => e.f), import("./fr-ca-DBvmUkRe.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-CKPAQNla.js").then((e) => e.f), import("./fr-gZVwD6s4.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-CP0y_hQ2.js").then((e) => e.g),
      import("./ga-BCScJK2u.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-CT4cUNWD.js").then((e) => e.g),
      import("./gl-CmCwD_Lx.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-D7cICCx5.js").then((e) => e.h), import("./he-D0Y_ewiw.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-Bh7Idzbt.js").then((e) => e.h), import("./hi-CLC_Bk0L.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-CkqdWQNr.js").then((e) => e.h), import("./hr-CloYxNVc.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-b_4SrO7X.js").then((e) => e.h), import("./hu-CQSl3lyG.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-CS_GWjtp.js").then((e) => e.h),
      import("./am-B3je_IfI.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-C0V_Be1n.js").then((e) => e.i), import("./id-DZrnl8eH.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-B-HFxekl.js").then((e) => e.i), import("./is-BN0gEcbv.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-CV8Cc5FO.js").then((e) => e.i), import("./it-Hxkxykg3.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-DMAhzzmL.js").then((e) => e.j), import("./ja-sBVTWeEN.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-PeC7l2mL.js").then((e) => e.k),
      import("./ka-BCdPa59t.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-kqo8R9Wc.js").then((e) => e.k),
      import("./kk-C_su3dSM.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-CtHDZbUz.js").then((e) => e.k),
      import("./km-Dpq2HPWY.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-DOR-eHny.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-NVRAEMVj.js").then((e) => e.k),
      import("./kn-Btw_iJws.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-CXUjKev7.js").then((e) => e.k), import("./ko-Cg5qQicY.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-C5GGMvvy.js").then((e) => e.k),
      import("./ku-BG4vJsUg.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-AzjqidHp.js").then((e) => e.l), import("./lt-BIUapnbk.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-DlbBnLTo.js").then((e) => e.l), import("./lv-BYBaL6s-.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-BEsN9wq-.js").then((e) => e.m),
      import("./mk-hL5RMBwm.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-iFcuCFhZ.js").then((e) => e.m),
      import("./ml-C50-63st.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-iLQ5OKKd.js").then((e) => e.m),
      import("./mn-B2Z5kY4_.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-kd-8xxQz.js").then((e) => e.m), import("./ms-C8S6V2SX.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-DQVN88Yh.js").then((e) => e.m),
      import("./my-B0Nyepeq.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-2rxTbLoH.js").then((e) => e.n),
      import("./nb-CIws9j_v.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-BxwU_4Ae.js").then((e) => e.n),
      import("./ne-D_f2Ias8.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-D_e1ChfS.js").then((e) => e.n),
      import("./nl-be-BXLJa3aS.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-BnYq4EWS.js").then((e) => e.n),
      import("./nl-BBkh2sbq.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-B7MqznMj.js").then((e) => e.p), import("./pl-CTjmT17t.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-B2j1kJTx.js").then((e) => e.p),
      import("./pt-br-BHyIZWUk.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-abcp5Sjz.js").then((e) => e.p),
      import("./pt-CzeZjLFT.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-tllpuv2I.js").then((e) => e.r), import("./ro-BCbYh_j3.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-k1jKW-Zc.js").then((e) => e.r), import("./ru-GoBiv-ze.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-C3aX-7jQ.js").then((e) => e.s),
      import("./si-CGBfh62-.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-BqVDxXJh.js").then((e) => e.s), import("./sk-D067J95r.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-DLTVtCTG.js").then((e) => e.s), import("./sl-U13vBVEQ.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-C3aTa8xF.js").then((e) => e.s),
      import("./sr-OsI6-eMP.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-CWnp0urV.js").then((e) => e.s), import("./sv-N1YdN7hr.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-f56VUP5F.js").then((e) => e.t),
      import("./ta-DL6ZYd_n.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-ohGsGKQk.js").then((e) => e.t), import("./th-GLBR-35-.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-DrdfWjzD.js").then((e) => e.t),
      import("./tk-DFmVLFp5.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-ChtsqRVy.js").then((e) => e.t), import("./tr-BY-Y9eU9.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-Bab8UbQH.js").then((e) => e.u),
      import("./uk-DEe3ODnH.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-BlMGMbUe.js").then((e) => e.u),
      import("./ur-DvqyRC09.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-B4hP_5SE.js").then((e) => e.u),
      import("./uz-SGNJpT4X.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-K9WGTWW-.js").then((e) => e.v), import("./vi-zm21btC3.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-Tx5wnP-5.js").then((e) => e.z),
      import("./zh-cn-DCGsDSng.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-CQ2544-G.js").then((e) => e.z),
      import("./zh-hk-MoWwMNi4.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-DpeV1_rt.js").then((e) => e.z),
      import("./zh-tw-CKGBaYvR.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
