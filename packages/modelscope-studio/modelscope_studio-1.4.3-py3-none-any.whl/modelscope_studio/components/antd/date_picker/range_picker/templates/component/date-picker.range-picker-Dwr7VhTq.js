import { i as Re, a as q, r as Se, w as A, g as je, b as Pe } from "./Index-CI95WNzS.js";
...
const Pt = ht(Et(["presets"], ({
  ...
  }, [i]), he = S(() => s == null ? void 0 : s.map((g) => R(g)), [s]), xe = S(() => l == null ? void 0 : l.map((g) => R(g)), [l]), ge = S(() => Array.isArray(r) ? r.map((g) => R(g)) : r ? R(r) : void 0, [r]), ve = S(() => Array.isArray(n) ? n.map((g) => R(g)) : n ? R(n) : void 0, [n]), we = S(() => h ? R(h) : void 0, [h]), Ie = S(() => x ? R(x) : void 0, [x]), {
    items: {
      presets: K
    }
  } = Ct();
