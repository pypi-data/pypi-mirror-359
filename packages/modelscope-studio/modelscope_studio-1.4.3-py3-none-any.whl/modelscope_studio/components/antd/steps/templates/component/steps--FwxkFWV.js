import { i as fe, a as W, r as de, w as O, g as me, b as _e } from "./Index-DJej9QS9.js";
  ...
  if (o.length !== 0)
    return o.map((s, n) => {
      ...
      Object.keys(s.slots).forEach((p) => {
        ...
        g instanceof Element ? d = g : (d = g.el, x = g.callback, b = g.clone ?? b, u = g.forceClone ?? u), u = u ?? !!x, i[c[c.length - 1]] = d ? x ? (...m) => (x(c[c.length - 1], m), /* @__PURE__ */ w.jsx(A, {
          ...s.ctx,
          params: m,
          forceClone: u,
