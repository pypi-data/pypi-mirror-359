import { i as ke, a as Q, r as Te, w as D, g as Oe, b as je } from "./Index-DkgtkDEQ.js";
...
var K = function() {
  return Te.Date.now();
}, Xe = "Expected a function", Ye = Math.max, Qe = Math.min;
function Ze(e, t, r) {
  var s, i, n, o, l, u, g = 0, b = !1, c = !1, _ = !0;
  if (typeof e != "function")
    throw new TypeError(Xe);
  t = oe(t) || 0, Q(r) && (b = !!r.leading, c = "maxWait" in r, n = c ? Ye(oe(r.maxWait) || 0, t) : n, _ = "trailing" in r ? !!r.trailing : _);
  function f(d) {
    var E = s, U = i;
    return s = i = void 0, g = d, o = e.apply(U, E), o;
  }
  function I(d) {
    return g = d, l = setTimeout(p, t), b ? f(d) : o;
  }
  function S(d) {
...
function It(e) {
  ...
  return {
    c() {
      t = be("react-portal-target"), r = pt(), n && n.c(), s = ce(), this.h();
    },
    l(o) {
    ...
    p(o, [l]) {
      ...
      16 && M(n, 1)) : (n = de(o), n.c(), M(n, 1), n.m(s.parentNode, s)) : n && (ut(), Z(n, 1, 1, () => {
        n = null;
      }), it());
    },
    i(o) {
...
function bt(e, t, r) {
  ...
  }, t = ae(t), [s, i, b, c, l, u, o, n, x, w];
}
class yt extends ot {
  constructor(t) {
    super(), ft(this, t, bt, It, mt, {
      svelteInit: 5
    });
  }
}
...
const me = Pe(({
  ...
  }, [e, b, r, s, n, i, g]), R.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }
...
const Nt = xt(({
  ...
  const x = e["showUploadList.downloadIcon"] || e["showUploadList.removeIcon"] || e["showUploadList.previewIcon"] || e["showUploadList.extra"] || typeof r == "object", w = Tt(r), a = L(w.showPreviewIcon), C = L(w.showRemoveIcon), d = L(w.showDownloadIcon), E = L(i), U = L(n), N = L(s == null ? void 0 : s.format), xe = L(o), Ee = L(l), Le = L(u), Se = L(g), Re = L(b), [Fe, W] = X(!1), [j, B] = X(S);
  he(() => {
    B(S);
  }, [S]);
  const $ = we(() => {
  ...
  return /* @__PURE__ */ F.jsx(De, {
    ...
    onChange: async (k) => {
      try {
        const v = k.file, P = k.fileList, ee = $.findIndex((y) => y.uid === v.uid);
        if (ee !== -1) {
          if (q)
            return;
          f == null || f(v);
          ...
          if (E && !await E(v, P) || q)
            return;
          W(!0);
          let y = P.filter((h) => h.status !== "done");
          if (I === 1)
            y = y.slice(0, 1);
          else if (y.length === 0) {
            W(!1);
