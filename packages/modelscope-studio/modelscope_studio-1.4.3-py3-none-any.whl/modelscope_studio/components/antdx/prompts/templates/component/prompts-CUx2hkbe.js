import { i as zt, a as _e, r as At, w as Q, g as Bt, c as V } from "./Index-DESd5yq7.js";
...
const Hr = /* @__PURE__ */ _.createContext({}), zr = {
  classNames: {},
  styles: {},
  className: "",
  style: {}
...
S.isValidElementType = function(t) {
  return typeof t == "string" || typeof t == "function" || t === oe || t === ie || t === se || t === ue || t === fe || t === Jr || typeof t == "object" && t !== null && (t.$$typeof === he || t.$$typeof === de || t.$$typeof === ae || t.$$typeof === le || t.$$typeof === ce || t.$$typeof === yt || t.getModuleId !== void 0);
};
S.typeOf = R;
Number(Lt.split(".")[0]);
function tt(t, e, n, o) {
...
function sn(t) {
  ...
  function l(d, b, x, g) {
    ...
    return function(C) {
      var I = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : C, $ = p(C, I), B = Y($, 2), E = B[1], D = T(I), k = Y(D, 2), z = k[0], U = k[1];
      return [z, E, U];
    };
  }
  function c(d, b, x) {
    var g = x.unitless, h = x.injectStyle, y = h === void 0 ? !0 : h, v = x.prefixToken, P = x.ignore, m = function(T) {
      var C = T.rootCls, I = T.cssVar, $ = I === void 0 ? {} : I, B = o(), E = B.realToken;
      return Vt({
        path: [d],
        prefix: $.prefix,
        key: $.key,
  ...
  function f(d, b, x) {
    ...
    return function(w) {
      var p = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : w, T = o(), C = T.theme, I = T.realToken, $ = T.hashId, B = T.token, E = T.cssVar, D = r(), k = D.rootPrefixCls, z = D.iconPrefixCls, U = n(), ge = E ? "css" : "js", Ct = nn(function() {
      ...
      var Ot = Xe(j(j({}, He), {}, {
        ...
        if (g.injectStyle === !1)
          return [];
        var X = Yr(B), q = X.token, Pt = X.flush, F = nt(v, I, x), Mt = ".".concat(w), ze = tt(v, I, F, {
          deprecatedTokens: g.deprecatedTokens
        });
        E && F && H(F) === "object" && Object.keys(F).forEach(function(Be) {
          F[Be] = "var(".concat(pe(Be, et(v, E.prefix)), ")");
        });
        var Ae = $e(q, {
          componentCls: Mt,
          prefixCls: w,
...
const {
  ...
  const {
    ...
    getPrefixCls: b,
    direction: x
  } = Ie(), g = b("prompts", e), h = Ar("prompts"), [y, v, P] = xn(g), m = V(g, h.className, o, l, v, P, {
    [`${g}-rtl`]: x === "rtl"
