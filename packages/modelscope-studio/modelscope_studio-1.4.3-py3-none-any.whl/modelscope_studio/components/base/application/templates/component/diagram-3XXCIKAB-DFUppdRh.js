import { p as y } from "./chunk-44GW5IO5-DBYu2rfi.js";
import { _ as i, s as B, g as S, q as F, p as z, a as E, b as P, D as w, H as W, e as D, y as T, E as _, F as A, l as x } from "./mermaid.core-CMvzQQ24.js";
import { p as N } from "./radar-VG2SY3DT-CjQdO54y.js";
var m = {
  packet: []
  ...
  const n = s.db, a = n.getConfig(), {
    rowHeight: r,
    paddingY: c,
    bitWidth: f,
    bitsPerRow: d
  } = a, p = n.getPacket(), l = n.getDiagramTitle(), k = r + c, g = k * (p.length + 1) - (l ? 0 : r), b = f * d + 2, h = W(e);
