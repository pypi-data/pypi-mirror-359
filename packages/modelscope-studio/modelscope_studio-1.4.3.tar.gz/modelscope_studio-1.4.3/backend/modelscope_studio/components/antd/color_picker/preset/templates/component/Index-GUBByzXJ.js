...
var Tt = Object.prototype, Hn = Tt.hasOwnProperty, qn = Tt.propertyIsEnumerable, Pe = Ue(/* @__PURE__ */ function() {
  return arguments;
}()) ? Ue : function(e) {
...
var Pt = typeof exports == "object" && exports && !exports.nodeType && exports, H = Pt && typeof module == "object" && module && !module.nodeType && module, vr = H && H.exports === Pt, fe = vr && ft.process, B = function() {
  try {
    var e = H && H.require && H.require("util").types;
    return e || fe && fe.binding && fe.binding("util");
  } catch {
  }
}(), ze = B && B.isTypedArray, Ot = ze ? Oe(ze) : mr, Tr = Object.prototype, wr = Tr.hasOwnProperty;
function At(e, t) {
  var n = S(e), r = !n && Pe(e), i = !n && !r && ne(e), o = !n && !r && !i && Ot(e), a = n || r || i || o, s = a ? Bn(e.length, String) : [], u = s.length;
  for (var l in e)
...
var _e = K(j, "DataView"), be = K(j, "Promise"), he = K(j, "Set"), Ze = "[object Map]", Ri = "[object Object]", We = "[object Promise]", Qe = "[object Set]", Ve = "[object WeakMap]", ke = "[object DataView]", Li = N(_e), Di = N(J), Ni = N(be), Ki = N(he), Ui = N(ge), $ = D;
...
function Pa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var g = new C(), b;
      if (!(b === void 0 ? Ee(l, u, Ta | wa, r, g) : b))
        return !1;
    }
  }
  return !0;
...
function Ns(e, t, n) {
  ...
  const c = Za(() => import("./color-picker.preset-CE8sZ6Pm.js"));
  let {
    gradio: f
  } = t, {
    props: d = {}
