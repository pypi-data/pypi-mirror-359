import { i as le, a as A, r as ce, w as T, g as ae } from "./Index-DpUcNBCC.js";
...
function z(e) {
  ...
  e = _e(e);
  var s = ge.test(e);
  return s || we.test(e) ? be(e.slice(2), s ? 2 : 8) : he.test(e) ? U : +e;
}
var L = function() {
  return ce.Date.now();
  ...
  return {
    ...
    l(r) {
      t = $(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Z(t).forEach(I), s = Le(r), n && n.l(r), i = K(), this.h();
    },
    h() {
      te(t, "class", "svelte-1rt0kpf");
    },
