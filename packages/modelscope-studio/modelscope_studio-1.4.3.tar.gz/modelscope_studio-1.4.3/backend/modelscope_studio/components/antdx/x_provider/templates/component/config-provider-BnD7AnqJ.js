import { w as L, g as vt, a as Be, c as xt } from "./XProvider-BESPPrlZ.js";
import { a as Ct, b as de, r as kt, c as Et } from "./Index-CoFMpqj4.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-CWF-y1sU.js").then((e) => e.a), import("./ar-BnS-htTV.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-D7gzpMOY.js").then((e) => e.a), import("./az-CC6YoJuV.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-Ce0d0phH.js").then((e) => e.b), import("./bg-CMe1Za2p.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-CzEwxLr9.js").then((e) => e.b), import("./bn-CZPCsjDo.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-7W36JOzR.js").then((e) => e.b),
      import("./be-CQ5hjFjL.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-Di2g0s3o.js").then((e) => e.c), import("./ca-BvhGhnbb.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-CKOZ242w.js").then((e) => e.c), import("./cs-B8AfWtwy.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-CuJWbQy9.js").then((e) => e.d), import("./da-DD8Kz2B8.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-C0hdYaiE.js").then((e) => e.d), import("./de-BtNd9Ivz.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-CyI6o-gk.js").then((e) => e.e), import("./el-CKv504ZX.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-DWqqWBoB.js").then((e) => e.e), import("./en-gb-K36q86qx.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-CiQ9968z.js").then((e) => e.e), import("./es-CAWPdDhy.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-C6hLPMI_.js").then((e) => e.e), import("./et-euM0Z63R.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-apFaXqgc.js").then((e) => e.e),
      import("./eu-C85lwYos.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-DtvxC5Pb.js").then((e) => e.f), import("./fa-Brzhdz8U.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-CHUJKT6u.js").then((e) => e.f), import("./fi-P4OhSecG.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-BXE3ReyH.js").then((e) => e.f), import("./fr-DGOioP5w.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-FEvmf0nc.js").then((e) => e.f), import("./fr-ca-Dq4HFTYZ.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-YYFdQWBm.js").then((e) => e.f), import("./fr-DGOioP5w.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-Gj_0VL4h.js").then((e) => e.g),
      import("./ga-USvwssxr.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-CF8jAn9i.js").then((e) => e.g),
      import("./gl-DtfKRKeW.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-BN60dyek.js").then((e) => e.h), import("./he-E8FlC2_W.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-jSO9ns75.js").then((e) => e.h), import("./hi-C5SBw7A2.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-CeSfAtxO.js").then((e) => e.h), import("./hr-id04Q1dY.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-DRze_JyW.js").then((e) => e.h), import("./hu-pxjsa34_.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-BztPu7as.js").then((e) => e.h),
      import("./am-jQxSKMsz.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-bWhbZTc3.js").then((e) => e.i), import("./id-D-58ojr5.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-BQ9lywNC.js").then((e) => e.i), import("./is-7dNElUD3.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-DIXXDnbZ.js").then((e) => e.i), import("./it-DoRMa32q.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-Bvb7VT7Z.js").then((e) => e.j), import("./ja-jvOSt2fb.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-DNS5Yocz.js").then((e) => e.k),
      import("./ka-DwjWJrlF.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-CmwbkXhI.js").then((e) => e.k),
      import("./kk-CQMOuYgv.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-v2ypjc02.js").then((e) => e.k),
      import("./km-CZZ5FQ8r.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-B7Lu4iK5.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-Doh0En_4.js").then((e) => e.k),
      import("./kn-CMhSnzHo.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-DUxHS9CA.js").then((e) => e.k), import("./ko-B1OWlqOZ.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-Bu68fGCn.js").then((e) => e.k),
      import("./ku-B8tU1Qdm.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-uzaKgI2u.js").then((e) => e.l), import("./lt-CZbZ5ysy.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-0xQ8u_jv.js").then((e) => e.l), import("./lv-BbY8HA2X.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-p6Xkkjo7.js").then((e) => e.m),
      import("./mk-BUw26ABp.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-aEqWxC4Y.js").then((e) => e.m),
      import("./ml-sbaU3_bp.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-9UDDWivd.js").then((e) => e.m),
      import("./mn-U1ao2ZTI.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-BNDA1oCh.js").then((e) => e.m), import("./ms-CRRWZYQz.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-BAmpvk8r.js").then((e) => e.m),
      import("./my-BECJFG-Q.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-Cf3oH_7V.js").then((e) => e.n),
      import("./nb-DGBxU3GA.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-BEJ13Mt4.js").then((e) => e.n),
      import("./ne-D4dEk2XB.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-Dcuv82oR.js").then((e) => e.n),
      import("./nl-be-BD9yNLOD.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-uvCXgGL7.js").then((e) => e.n),
      import("./nl-D0fAcQda.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-B1ztYJfb.js").then((e) => e.p), import("./pl-CFvmWD_p.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-C-U1YkC-.js").then((e) => e.p),
      import("./pt-br-uFRdMBFG.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-DqC4bzVo.js").then((e) => e.p),
      import("./pt-5EmvWddU.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-DF5-xiDj.js").then((e) => e.r), import("./ro-Cr4XubI1.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-DkDOAEQ-.js").then((e) => e.r), import("./ru-B-d_2zF0.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-DCXitCJL.js").then((e) => e.s),
      import("./si-BiWXlKOL.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-e8nw8sAj.js").then((e) => e.s), import("./sk-DVhMSEhE.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-DzDapUJ8.js").then((e) => e.s), import("./sl-2WalWHZ7.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-Bz5o-gcq.js").then((e) => e.s),
      import("./sr-Yr6cmZ93.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-D3IXamqL.js").then((e) => e.s), import("./sv-BXKyxqav.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-Bn_ptmS0.js").then((e) => e.t),
      import("./ta-CVC9TEBF.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-Cz3z1ij7.js").then((e) => e.t), import("./th-C4Np_qIh.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-D3HYpYSn.js").then((e) => e.t),
      import("./tk-TjsMCuBK.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-Bh5k0r4A.js").then((e) => e.t), import("./tr-BoM-Rga-.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-COdFgTws.js").then((e) => e.u),
      import("./uk-B-oTOH1K.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-pF3qrgKZ.js").then((e) => e.u),
      import("./ur-CXogPfsN.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-xZEfscEg.js").then((e) => e.u),
      import("./uz-Jz3dMWKZ.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-C8e9MBrV.js").then((e) => e.v), import("./vi-B4Su5H1q.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-CSYmF7fC.js").then((e) => e.z),
      import("./zh-cn-DBcnvyM2.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-u5wIveTs.js").then((e) => e.z),
      import("./zh-hk-Drfjmv_J.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-DEtkvvvB.js").then((e) => e.z),
      import("./zh-tw-eaeRVntC.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
