import { g as de } from "./chunk-UIWBPB2F-DNVX2Nh5.js";
import { _ as d, E as at, d as R, e as ge, l as L, y as ue, A as pe, c as z, ai as fe, R as xe, S as ye, O as be, aj as Z, ak as Yt, al as we, u as tt, k as me, am as Le, an as xt, ao as Se, i as Tt } from "./mermaid.core-CMvzQQ24.js";
import { c as ve } from "./clone-BwN-DId1.js";
import { G as Ee } from "./graph-DaZI6LXa.js";
import { c as _e } from "./channel-CqmaPQqi.js";
var yt = function() {
...
function ot(e, t, r = 0, n = 0) {
  ...
  L.debug("setBlockSizes abc95 (start)", e.id, (s = e == null ? void 0 : e.size) == null ? void 0 : s.x, "block width =", e == null ? void 0 : e.size, "siblingWidth", r), (l = e == null ? void 0 : e.size) != null && l.width || (e.size = {
    width: r,
    height: n,
    x: 0,
    y: 0
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    if (u < r) {
      L.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${r} siblingHeight ${n} width ${u}`), u = r, w = n;
...
var lr = /* @__PURE__ */ d(async (e, t, r, n) => {
  ...
  const r = z(), n = Z(r.flowchart.htmlLabels), i = t.labelType === "markdown" ? Yt(e, t.label, {
    ...
    useHtmlLabels: n,
    addSvgBackground: !0
  }, r) : await j(t.label, t.labelStyle), a = e.insert("g").attr("class", "edgeLabel"), s = a.insert("g").attr("class", "label");
...
function ee(e, t, r) {
  ...
  for (var o = n - e.width / 2 - s, f = i - e.height / 2 - l, h = 0; h < t.length; h++) {
    var y = t[h], b = t[h < t.length - 1 ? h + 1 : 0], m = wr(e, r, {
      x: o + y.x,
      y: f + y.y
    }, {
      x: o + b.x,
...
var Lr = /* @__PURE__ */ d((e, t) => {
  ...
  }, i) : y = h.appendChild(await j(Tt(xt(f), i), t.labelStyle, !1, n));
  let b = y.getBBox();
  const m = t.padding / 2;
...
var vr = /* @__PURE__ */ d(async (e, t) => {
...
}, "note"), Er = vr, zt = /* @__PURE__ */ d((e) => e ? " " + e : "", "formatClass"), K = /* @__PURE__ */ d((e, t) => `${t || "node default"}${zt(e.classes)} ${zt(e.class)}`, "getClassesFromNode"), At = /* @__PURE__ */ d(async (e, t) => {
  const {
    shapeSvg: r,
    bbox: n
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, void 0, !0), i = 2, a = n.height + 2 * t.padding, s = a / i, l = n.width + 2 * s + t.padding, o = xr(t.directions, n, t), f = G(r, l, a, o);
  return f.attr("style", t.style), B(t, f), t.intersect = function(h) {
    return C.polygon(t, o, h);
  }, r;
...
var Fr = /* @__PURE__ */ d(async (e, t) => {
  ...
  let b = f.getBBox();
  const m = s.node().appendChild(await j(y.join ? y.join("<br/>") : y, t.labelStyle, !0, !0));
  if (Z(z().flowchart.htmlLabels)) {
  ...
  t.classData.members.forEach(async (c) => {
    ...
    const A = b.node().appendChild(await j(p, _.cssStyle ? _.cssStyle : t.labelStyle, !0, !0));
    let O = A.getBBox();
    if (Z(z().flowchart.htmlLabels)) {
...
function kt(e, t, r = !1) {
  ...
  const o = Se((n == null ? void 0 : n.styles) ?? []), f = n.label, h = n.size ?? {
    width: 0,
    height: 0,
    x: 0,
    y: 0
...
async function se(e, t, r) {
  ...
  if (r.getBlock(n.id).type !== "space") {
    ...
    await re(e, n, {
      config: a
    }), t.intersect = n == null ? void 0 : n.intersect, jr(n);
  }
}
  ...
  for (const s of t)
    if (s.start && s.end) {
      ...
      if (l != null && l.size && (o != null && o.size)) {
        ...
        }, void 0, "block", a, i), s.label && (await hr(e, {
          ...s,
          label: s.label,
...
var Vr = /* @__PURE__ */ d(function(e, t) {
  ...
  if (await ne(E, y, s), await le(E, m, b, s, t), D) {
    ...
    ge(f, k, N, !!x), L.debug("Here Bounds", D, v), f.attr("viewBox", `${v.x - 5} ${v.y - 5} ${v.width + 10} ${v.height + 10}`);
  }
}, "draw"), Zr = {
  draw: Gr,
  getClasses: Vr
