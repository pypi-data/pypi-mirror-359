import { G as g } from "./graph-DaZI6LXa.js";
import { e as ce, a as f, f as C, v as x, r as M } from "./_baseUniq-Cwma4_PQ.js";
import { b as le, a as Te, c as Ie, d as Me, t as j, m as w, e as N, h as he, f as z, g as Se } from "./_basePickBy-DSxXHBME.js";
import { aI as $, aA as Fe, aV as q } from "./mermaid.core-CMvzQQ24.js";
import { b as je, L as Ve, j as Ae, x as ve, n as X, M as Be, r as pe, f as ee, o as V, p as we, w as Ge, N as Ye, O as De, P as $e, a as qe, Q as We, v as ze, R as _, c as Xe, i as m, T } from "./Index-CfN6vI6e.js";
var Ue = 1, He = 4;
function Je(e) {
  return je(e, Ue | He);
}
...
function U(e, n) {
  return e && e.length ? le(e, X(n), Te) : void 0;
}
function en(e, n) {
  var r = e.length;
  for (e.sort(n); r--; )
...
function it(e, n) {
  ...
  r("layout", () => {
    ...
    r("  runLayout", () => Tr(t, r)), r("  updateInputGraph", () => Ir(e, t));
  });
}
function Tr(e, n) {
  n("    makeSpaceForEdgeLabels", () => Dr(e)), n("    removeSelfEdges", () => Qr(e)), n("    acyclic", () => gn(e)), n("    nestingGraph.run", () => Xn(e)), n("    rank", () => qn(be(e))), n("    injectEdgeLabelProxies", () => $r(e)), n("    removeEmptyRanks", () => On(e)), n("    nestingGraph.cleanup", () => Jn(e)), n("    normalizeRanks", () => En(e)), n("    assignRankMinMax", () => qr(e)), n("    removeEdgeLabelProxies", () => Wr(e)), n("    normalize.run", () => In(e)), n("    parentDummyChains", () => hr(e)), n("    addBorderSegments", () => Pn(e)), n("    order", () => cr(e)), n("    insertSelfEdges", () => Zr(e)), n("    adjustCoordinateSystem", () => Cn(e)), n("    position", () => _r(e)), n("    positionSelfEdges", () => Kr(e)), n("    removeBorderNodes", () => Jr(e)), n("    normalize.undo", () => Sn(e)), n("    fixupEdgeLabelCoords", () => Ur(e)), n("    undoCoordinateSystem", () => _n(e)), n("    translateGraph", () => zr(e)), n("    assignNodeIntersects", () => Xr(e)), n("    reversePoints", () => Hr(e)), n("    acyclic.undo", () => kn(e));
}
function Ir(e, n) {
  f(e.nodes(), function(r) {
...
var Mr = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], Sr = {
  ranksep: 50,
  edgesep: 20,
  nodesep: 50,
  rankdir: "tb"
...
function Yr(e) {
  ...
  return n.setGraph(q({}, Sr, Y(r, Mr), I(r, Fr))), f(e.nodes(), function(t) {
    var a = D(e.node(t));
    n.setNode(t, Se(Y(a, jr), Vr)), n.setParent(t, e.parent(t));
  }), f(e.edges(), function(t) {
    var a = D(e.edge(t));
    n.setEdge(t, q({}, Br, Y(a, Ar), I(a, Gr)));
  }), n;
}
function Dr(e) {
  var n = e.graph();
