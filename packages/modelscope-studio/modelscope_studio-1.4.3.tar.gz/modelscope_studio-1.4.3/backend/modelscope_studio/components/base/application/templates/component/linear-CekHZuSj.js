import { aQ as un, aR as I, aS as X, aT as fn, aU as Q } from "./mermaid.core-CMvzQQ24.js";
...
function C(n, t) {
  var e = typeof t, r;
  return t == null || e === "boolean" ? un(t) : (e === "number" ? I : e === "string" ? (r = Q(t)) ? (t = r, X) : fn : t instanceof Q ? X : t instanceof Date ? An : kn(t) ? Nn : Array.isArray(t) ? xn : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? vn : I)(n, t);
}
function Sn(n, t) {
  ...
  function o(h) {
    ...
    function U(m) {
      ...
      if (d === "c")
        ...
        m = +m;
        var P = m < 0 || 1 / m < 0;
        if (m = isNaN(m) ? c : O(Math.abs(m), w), G && (m = Rn(m)), P && +m == 0 && y !== "+" && (P = !1), N = (P ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + N, g = (d === "s" ? K[8 + nn / 3] : "") + g + (P && y === "(" ? ")" : ""), an) {
          for (x = -1, V = m.length; ++x < V; )
...
function Qn(n) {
  ...
  return n.ticks = function(e) {
    ...
    var i = t();
    return Xn(i[0], i[i.length - 1], e ?? 10, r);
  }, n.nice = function(e) {
    e == null && (e = 10);
