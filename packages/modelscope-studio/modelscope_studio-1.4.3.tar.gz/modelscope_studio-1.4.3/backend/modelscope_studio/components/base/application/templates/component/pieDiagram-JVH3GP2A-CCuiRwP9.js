import { p as V } from "./chunk-44GW5IO5-DBYu2rfi.js";
import { a4 as S, a7 as z, aE as U, _ as u, g as j, s as q, a as H, b as Z, q as J, p as K, l as F, c as Q, D as X, H as Y, N as tt, e as et, y as at, F as rt } from "./mermaid.core-CMvzQQ24.js";
import { p as nt } from "./radar-VG2SY3DT-CjQdO54y.js";
import { d as P } from "./arc-CVzzqNRk.js";
...
` + t);
  ...
  const d = p.getSections(), y = At(d), D = [n.pie1, n.pie2, n.pie3, n.pie4, n.pie5, n.pie6, n.pie7, n.pie8, n.pie9, n.pie10, n.pie11, n.pie12], C = it(D);
  ...
  const M = c.selectAll(".legend").data(C.domain()).enter().append("g").attr("class", "legend").attr("transform", (s, E) => {
    const k = r + l, L = k * C.domain().length / 2, _ = 12 * r, B = E * k - L;
