import { _ as s, c as xt, l as T, d as q, V as kt, W as vt, X as _t, Y as bt, B as wt, $ as St, y as Et } from "./mermaid.core-CMvzQQ24.js";
import { d as nt } from "./arc-CVzzqNRk.js";
var X = function() {
  var n = /* @__PURE__ */ s(function(f, i, a, h) {
    ...
    parse: /* @__PURE__ */ s(function(i) {
      var a = this, h = [0], u = [], y = [null], o = [], S = this.table, k = "", $ = 0, H = 0, B = 2, J = 1, O = o.slice.call(arguments, 1), v = Object.create(this.lexer), E = {
        yy: {}
      };
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Q = "Parse error on line " + ($ + 1) + ": Unexpected " + (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Q, {
        ...
        switch (N[0]) {
          ...
          case 2:
            ...
            }, P && (V._$.range = [o[o.length - (M || 1)].range[0], o[o.length - 1].range[1]]), K = this.performAction.apply(V, [k, H, $, E.yy, N[1], y, o].concat(O)), typeof K < "u")
              return K;
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  t.section = r, d.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + r));
  ...
  T.debug("maxSectionHeight before draw", i), T.debug("maxTaskHeight before draw", a), f && f.length > 0 ? f.forEach((E) => {
    ...
    T.debug("sectionNode output", A), P.attr("transform", `translate(${y}, ${u})`), o += i + 50, b.length > 0 && st(p, b, S, y, o, a, r, $, H, i, !1), y += 200 * Math.max(b.length, 1), o = u, S++;
  }) : (k = !1, st(p, x, S, y, o, a, r, $, H, i, !0));
  const B = p.node().getBBox();
  T.debug("bounds", B), _ && p.append("text").text(_).attr("x", B.width / 2 - d).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), h = k ? i + a + 150 : a + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", d).attr("y1", h).attr("x2", B.width + 3 * d).attr("y2", h).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), kt(void 0, p, ((O = r.timeline) == null ? void 0 : O.padding) ?? 50, ((v = r.timeline) == null ? void 0 : v.useMaxWidth) ?? !1);
