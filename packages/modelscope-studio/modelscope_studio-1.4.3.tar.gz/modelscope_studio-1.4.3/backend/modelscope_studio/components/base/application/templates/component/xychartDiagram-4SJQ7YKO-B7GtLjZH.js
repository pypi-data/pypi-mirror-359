import { _ as a, s as gi, g as xi, q as Xt, p as di, a as fi, b as pi, l as Nt, H as mi, e as yi, y as bi, E as St, D as Yt, F as Ai, K as wi, i as Ci, aD as Si, R as Wt } from "./mermaid.core-CMvzQQ24.js";
import { i as _i } from "./init-DjUOC4st.js";
import { o as ki } from "./ordinal-CDDIbzuo.js";
import { l as zt } from "./linear-CekHZuSj.js";
function Ri(e, t, i) {
...
var bt = function() {
  var e = /* @__PURE__ */ a(function(F, h, u, x) {
    ...
    parse: /* @__PURE__ */ a(function(h) {
      var u = this, x = [0], d = [], w = [null], o = [], at = this.table, f = "", lt = 0, It = 0, hi = 2, Mt = 1, li = o.slice.call(arguments, 1), T = Object.create(this.lexer), Y = {
        yy: {}
      };
...
Expecting ` + ut.join(", ") + ", got '" + (this.terminals_[M] || M) + "'" : mt = "Parse error on line " + (lt + 1) + ": Unexpected " + (M == Mt ? "end of input" : "'" + (this.terminals_[M] || M) + "'"), this.parseError(mt, {
        ...
        switch (B[0]) {
          ...
          case 2:
            ...
            }, ci && (q._$.range = [o[o.length - (O || 1)].range[0], o[o.length - 1].range[1]]), pt = this.performAction.apply(q, [f, It, lt, Y.yy, B[1], w, o].concat(li)), typeof pt < "u")
              return pt;
...
var tt, Li = (tt = class {
  ...
  getDrawableElement() {
    const t = this.barData.data.map((r) => [this.xAxis.getScaleValue(r[0]), this.yAxis.getScaleValue(r[1])]), s = Math.min(this.xAxis.getAxisOuterPadding() * 2, this.xAxis.getTickDistance()) * (1 - 0.05), n = s / 2;
...
var st, Mi = (st = class {
  ...
  calculateVerticalSpace() {
    let t = this.chartConfig.width, i = this.chartConfig.height, s = 0, n = 0, r = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), g = Math.floor(i * this.chartConfig.plotReservedSpacePercent / 100), m = this.componentStore.plot.calculateSpace({
      width: r,
      height: g
    });
  ...
  calculateHorizontalSpace() {
    let t = this.chartConfig.width, i = this.chartConfig.height, s = 0, n = 0, r = 0, g = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), m = Math.floor(i * this.chartConfig.plotReservedSpacePercent / 100), p = this.componentStore.plot.calculateSpace({
      width: g,
      height: m
    });
    t -= p.width, i -= p.height, p = this.componentStore.title.calculateSpace({
      ...
      x: n,
      y: s
    }), this.componentStore.xAxis.setRange([r, r + m]), this.componentStore.xAxis.setBoundingBoxXY({
      x: 0,
      y: r
