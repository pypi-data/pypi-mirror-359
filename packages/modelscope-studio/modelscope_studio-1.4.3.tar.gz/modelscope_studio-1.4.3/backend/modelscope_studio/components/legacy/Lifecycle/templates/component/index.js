...
function D(e, t) {
  return t.clone !== !1 && t.isMergeableObject(e) ? I(bt(e), e, t) : e;
}
function gt(e, t, r) {
...
function vt(e, t, r) {
  var n = {};
  return r.isMergeableObject(e) && Ee(e).forEach(function(i) {
    n[i] = D(e[i], r);
  }), Ee(t).forEach(function(i) {
    xt(e, i) || (Le(e, i) && r.isMergeableObject(t[i]) ? n[i] = dt(i, r)(e[i], t[i], r) : n[i] = D(t[i], r));
  }), n;
}
function I(e, t, r) {
  r = r || {}, r.arrayMerge = r.arrayMerge || gt, r.isMergeableObject = r.isMergeableObject || ut, r.cloneUnlessOtherwiseSpecified = D;
...
var Xe = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, Mt = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Ct(e) {
  var t = {};
...
var ve = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, ke = /^(@+)?(\+|#+)?[rs]?$/g, Gt = /(\*)(0+)|(#+)(0+)|(0+)/g, ze = /^(0+)$/;
function _e(e) {
  var t = {};
...
function jt(e) {
  for (var t = {}, r = 0, n = e; r < n.length; r++) {
    ...
    if (ve.test(i.stem)) {
      ...
      i.stem.replace(ve, function(f, u, s, c, l, d) {
...
var re, kt = new RegExp("^".concat(Xe.source, "*")), zt = new RegExp("".concat(Xe.source, "*$"));
function p(e, t) {
  return {
    start: e,
    end: t
    ...
    return e.prototype.parse = function() {
      ...
      switch (h) {
        ...
        case "time": {
          ...
          if (u && He(u == null ? void 0 : u.style, "::", 0)) {
...
function k(e, t, r, n, i, o, a) {
  ...
  for (var h = [], f = 0, u = e; f < u.length; f++) {
    ...
    if (Re(s)) {
      var d = typeof s.style == "string" ? n.number[s.style] : Ve(s.style) ? s.style.parsedOptions : void 0;
    ...
    if (Ge(s)) {
      ...
      if (!_)
        throw new Se(s.value, l, Object.keys(s.options), a);
...
const H = {}, dr = (e, t, r) => r && (t in H || (H[t] = {}), e in H[t] || (H[t][e] = r), r), Je = (e, t) => {
  if (t == null) return;
  if (t in H && e in H[t])
    return H[t][e];
  const r = Y(t);
...
function _r(e, ...t) {
  delete H[e], F.update((r) => (r[e] = Ht.all([r[e] || {}, ...t]), r));
}
L([F], ([e]) => Object.keys(e));
F.subscribe((e) => be = e);
const z = {};
...
const ie = Q(!1);
var Pr = Object.defineProperty, Ir = Object.defineProperties, Nr = Object.getOwnPropertyDescriptors, Ae = Object.getOwnPropertySymbols, Or = Object.prototype.hasOwnProperty, wr = Object.prototype.propertyIsEnumerable, Pe = (e, t, r) => t in e ? Pr(e, t, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: r
}) : e[t] = r, Lr = (e, t) => {
  for (var r in t || (t = {})) Or.call(t, r) && Pe(e, r, t[r]);
...
var Ur = Object.defineProperty, Z = Object.getOwnPropertySymbols, et = Object.prototype.hasOwnProperty, tt = Object.prototype.propertyIsEnumerable, Ne = (e, t, r) => t in e ? Ur(e, t, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: r
...
const G = (e, t) => {
  ...
  return c;
}, Wr = (e, t) => Xr(t).format(e), Zr = (e, t) => Vr(t).format(e), Qr = (e, t) => jr(t).format(e), qr = (e, t = B()) => Je(e, t);
L([j, F], () => zr);
L([j], () => Wr);
L([j], () => Zr);
L([j], () => Qr);
