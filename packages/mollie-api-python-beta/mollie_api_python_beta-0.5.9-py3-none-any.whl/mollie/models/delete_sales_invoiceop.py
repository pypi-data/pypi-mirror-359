...
class DeleteSalesInvoiceSalesInvoicesResponseBody(Exception):
    r"""An error response object."""

    data: DeleteSalesInvoiceSalesInvoicesResponseBodyData

    def __init__(self, data: DeleteSalesInvoiceSalesInvoicesResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, DeleteSalesInvoiceSalesInvoicesResponseBodyData
        )
...
class DeleteSalesInvoiceResponseBody(Exception):
    r"""An error response object."""

    data: DeleteSalesInvoiceResponseBodyData

    def __init__(self, data: DeleteSalesInvoiceResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, DeleteSalesInvoiceResponseBodyData)
