...
class ListWebhooksWebhooksDocumentationTypedDict(TypedDict):
...
class ListWebhooksWebhooksDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListWebhooksWebhooksLinksTypedDict(TypedDict):
    documentation: ListWebhooksWebhooksDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class ListWebhooksWebhooksLinks(BaseModel):
    documentation: ListWebhooksWebhooksDocumentation
    r"""The URL to the generic Mollie API error handling guide."""


class ListWebhooksWebhooksResponseBodyData(BaseModel):
    status: int
    ...
    links: Annotated[ListWebhooksWebhooksLinks, pydantic.Field(alias="_links")]

    field: Optional[str] = None
    r"""If the error was caused by a value provided by you in a specific field, the `field` property will contain the name of the field that caused the issue."""


class ListWebhooksWebhooksResponseBody(Exception):
    r"""An error response object."""

    data: ListWebhooksWebhooksResponseBodyData

    def __init__(self, data: ListWebhooksWebhooksResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ListWebhooksWebhooksResponseBodyData)


class ListWebhooksWebhooksTypedDict(TypedDict):
...
class ListWebhooksWebhooks(BaseModel):
...
class ListWebhooksEmbeddedTypedDict(TypedDict):
    webhooks: NotRequired[List[ListWebhooksWebhooksTypedDict]]
    r"""A list of webhooks."""


class ListWebhooksEmbedded(BaseModel):
    webhooks: Optional[List[ListWebhooksWebhooks]] = None
    r"""A list of webhooks."""
...
class ListWebhooksResponseBodyTypedDict(TypedDict):
    r"""A list of webhooks. For a complete reference of the webhook object, refer to the [Get hook endpoint](get-webhook) documentation."""
