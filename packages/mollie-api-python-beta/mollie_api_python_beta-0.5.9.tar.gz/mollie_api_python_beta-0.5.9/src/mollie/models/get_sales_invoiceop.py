...
class GetSalesInvoiceSalesInvoicesResponseBody(Exception):
    r"""An error response object."""

    data: GetSalesInvoiceSalesInvoicesResponseBodyData

    def __init__(self, data: GetSalesInvoiceSalesInvoicesResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, GetSalesInvoiceSalesInvoicesResponseBodyData
        )
