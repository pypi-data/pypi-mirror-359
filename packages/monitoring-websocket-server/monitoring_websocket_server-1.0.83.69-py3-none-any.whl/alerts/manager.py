...
class AlertManager:
    ...
    def __init__(self, max_history: int = 100, cooldown_seconds: float = 300.0) -> None:
        ...
        self._cleanup_interval: float = 3600.0  # Nettoyer toutes les heures
    ...
    def _check_component_thresholds(self, component: str, value: float,
        ...
        elif value > self._thresholds.get(f"{component}_warning", 80.0):
            warning_key = f"{component}_warning"
    ...
    def _cleanup_old_alert_times(self, current_time: float) -> None:
        ...
        Args:
            current_time: Timestamp actuel en secondes.
        """
        old_time = current_time - 86400  # 24 heures
