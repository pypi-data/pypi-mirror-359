...
class DiskMonitor(BaseMonitor):
    ...
    def is_disk_critical(self, threshold: float = 95.0) -> bool:
    ...
    def is_disk_warning(self, threshold: float = 85.0) -> bool:
    ...
    def is_disk_nearly_full(self, min_free_gb: float = 1.0) -> bool:
    ...
    def get_disk_health_status(self) -> Dict[str, Any]:
        ...
        if usage_percent > 95 or free_gb < 0.5:
            status = "critical"
            message = "Espace disque critique"
        elif usage_percent > 85 or free_gb < 2.0:
            status = "warning"
