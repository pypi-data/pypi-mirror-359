...
class ThreadSafeMonitoringService:
    ...
    def __init__(self,
        ...
        self._command_queue: queue.Queue = queue.Queue(maxsize=100)  # Limite à 100 commandes
        self._response_queue: queue.Queue = queue.Queue(maxsize=100)  # Limite à 100 réponses
        ...
        self._last_alerts: Deque[Alert] = deque(maxlen=100)  # Limite à 100 dernières alertes
    ...
    def _has_significant_change(old_data: Dict[str, Any], new_data: Dict[str, Any]) -> bool:
        ...
        thresholds = {
            'cpu_usage': 5.0,    # 5% de différence
            'memory_usage': 2.0, # 2% de différence
            'disk_usage': 1.0    # 1% de différence
        }
