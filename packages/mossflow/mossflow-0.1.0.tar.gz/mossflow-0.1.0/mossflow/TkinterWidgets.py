...
from numpyutils import Generate_heatmap
import numpy as np
...
class NumericInputPad:
    def __init__(self, root, message=None):
        ...
        rootx = root.winfo_x()
        rooty = root.winfo_y()
        self.root.geometry(f"360x480+{rootx}+{rooty}")
...
class FlowPlane(OpenGLFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.tool_menu.add_cascade(label=self.texts[self.language]['numberkeyboard'], command=lambda : NumericInputPad(tk.Toplevel(self)))  # 添加计算器工具
    ...
    def on_message(self,module,operationcode:int,**kwargs):
        ...
        window.iconbitmap("main.ico")  # 设置窗口图标
            ...
            'zh': 
                ...
                ">
                    ...
                    ">
                        ...
                        <img src="main.ico" alt="Title Icon" style="width: 100%; height: auto; margin-top: 5px;">
