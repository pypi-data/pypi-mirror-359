...
from .result_types import (
    ...
    validation_error, data_not_found_error
)
...
from .connection_services import EnhancedConnectionManager
...
class CLICommands:
    ...
    def __init__(self):
        ...
        self.connection_manager = EnhancedConnectionManager(self.data_manager)
