# PDF Analysis Report - J9lKd7Y

## Submission Details

**PDF File:** J9lKd7Y.pdf  
**Language:** Slovenia  
**Contains Handwriting:** No  
**Requires OCR:** No

### User's Goal
Table in Slovenian (e.g. on page 80).

### PDF Description  
This is about the PISA (a student assessment from OECD) downloaded from the Slovenian education agency.

### Reported Issues
The table is in Slovenia and it has some radio buttons in the table which may message up the natural-pdf?
...
**Analysis Generated:** 2025-06-22 14:34:06
