...
def get_ctx_id(tx):
    return _blsct.get_ctx_id(tx)

def ser_ctx_to_CMutableTransaction(ser_ctx, ser_ctx_size):
    return _blsct.ser_ctx_to_CMutableTransaction(ser_ctx, ser_ctx_size)

def get_ctx_ins(ctx):
    return _blsct.get_ctx_ins(ctx)
...
def get_ctx_outs(ctx):
    return _blsct.get_ctx_outs(ctx)
