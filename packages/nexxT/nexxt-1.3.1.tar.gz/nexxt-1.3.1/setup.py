...
for variant in ["nonopt", "release"]:
    build_files.append('nexxT/binary/' + cplatform + '/' + variant + "/" + cnexT)
    for prefix,suffix in presuf:
        build_files.append('nexxT/binary/' + cplatform + '/' + variant + "/" + prefix + "nexxT" + suffix)
        build_files.append('nexxT/tests/binary/' + cplatform + '/' + variant + "/" + prefix + "test_plugins" + suffix)
...
setup(name='nexxT',
      ...
      packages=['nexxT', 'nexxT.interface', 'nexxT.tests', 'nexxT.services', 'nexxT.services.gui', 'nexxT.filters',
                ...
                'nexxT.examples.framework', 'nexxT.include.nexxT'] + ([] if not build_required else [
                'nexxT.binary.' + cplatform + '.nonopt', 'nexxT.binary.' + cplatform + '.release',
                'nexxT.tests.binary.' + cplatform + '.nonopt', 'nexxT.tests.binary.' + cplatform + '.release']),
      cmdclass={
