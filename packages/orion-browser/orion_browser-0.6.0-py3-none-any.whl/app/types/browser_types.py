...
from browser_use.controller.views import ClickElementAction, DoDatePickerAction, GoToUrlAction, InputTextAction, OpenTabAction, GetAllTabsAction, ScrollAction, SearchBaiduAction, SendKeysAction, SwitchTabAction, ClickByPositionAction, GetElementsAction
...
class BrowserAction(ActionModel):
    ...
    get_elements: GetElementsAction | None = None
    ...
    scroll_to_bottom: NoParamAction | None = None
    ...
    do_date_picker: DoDatePickerAction | None = None
