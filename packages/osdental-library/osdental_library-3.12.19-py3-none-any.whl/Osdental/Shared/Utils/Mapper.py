...
class Mapper:
    ...
    def map_data(data: Dict[str, any], model: Type[T]) -> T:
        ...
        for field in fields(model):
            ...
            if value is None:
                continue  # omitir si no viene en el dict
    ...
    def _map_value(value: any, field_type: any):
        ...
        if origin is list:
            ...
            return value  # en caso de que no sea lista, retornamos como está
        ...
        # En cualquier otro caso, devolvemos el valor directamente
        return value
