...
def test_case1():
    ...
    assert p.basis == pytest.approx(82012.2, abs=0.5)
...
def test_case2():
    ...
    assert p.bequest == pytest.approx(597419.7, abs=0.5)
...
def test_config1():
    ...
    assert p2.bequest == pytest.approx(597419.7, abs=0.5)
    ...
    assert p3.bequest == pytest.approx(597419.7, abs=0.5)
