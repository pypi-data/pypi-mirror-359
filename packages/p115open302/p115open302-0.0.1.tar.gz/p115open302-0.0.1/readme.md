...
```console
$ p115open302 -h
usage: __main__.py [-h] [-c COOKIES] [-cp COOKIES_PATH] [-a APP_ID] [-rt REFRESH_TOKEN] [-t TOKEN] [-H HOST] [-P PORT] [-cu] [-d]
...
> 用 sha1 或 name 查询时，可指定 size，要求文件大小等于此值
...
options:
  ...
  -v, --version         输出版本号
  -l, --license         输出授权信息
(py312) ➜  ~ python /Users/gcy/project_github/p115client/modules/p115open302/p115open302/__main__.py (py312) ➜  ~ python /Users/gcy/project_github/p115client/modules/p115op(py312) ➜  ~ python /Users/gcy/project_github/p115client/modules/p115open302/p115open302/__main__.py -h
usage: __main__.py [-h] [-c COOKIES] [-cp COOKIES_PATH] [-a APP_ID]
