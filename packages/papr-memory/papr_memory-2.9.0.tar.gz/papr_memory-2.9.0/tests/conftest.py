...
from papr_memory import Papr, AsyncPapr, DefaultAioHttpClient
from papr_memory._utils import is_dict
...
def client(request: FixtureRequest) -> Iterator[Papr]:
    ...
    with Papr(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
