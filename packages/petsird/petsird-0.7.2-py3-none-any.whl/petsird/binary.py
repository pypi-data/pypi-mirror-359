...
class DetectionEfficienciesSerializer(_binary.RecordSerializer[DetectionEfficiencies]):
    ...
    def read(self, stream: _binary.CodedInputStream) -> DetectionEfficiencies:
        field_values = self._read(stream)
        return DetectionEfficiencies(detection_bin_efficiencies=field_values[0], module_pair_sgidlut=field_values[1], module_pair_efficiencies_vectors=field_values[2])


class AliveTimeFractionsSerializer(_binary.RecordSerializer[AliveTimeFractions]):
    def __init__(self) -> None:
        super().__init__([("singles_alive_time_fractions", _binary.VectorSerializer(_binary.NDArraySerializer(_binary.float32_serializer, 1))), ("module_coincidence_alive_time_fractions", _binary.VectorSerializer(_binary.VectorSerializer(_binary.NDArraySerializer(_binary.float32_serializer, 2))))])
