...
class AliveTimeFractionsConverter(_ndjson.JsonConverter[AliveTimeFractions, np.void]):
    def __init__(self) -> None:
        ...
        self._module_coincidence_alive_time_fractions_converter = _ndjson.VectorConverter(_ndjson.VectorConverter(_ndjson.NDArrayConverter(_ndjson.float32_converter, 2)))
        super().__init__(np.dtype([
    ...
    def numpy_to_json(self, value: np.void) -> object:
        ...
        json_object["moduleCoincidenceAliveTimeFractions"] = self._module_coincidence_alive_time_fractions_converter.numpy_to_json(value["module_coincidence_alive_time_fractions"])
        return json_object
    ...
    def from_json(self, json_object: object) -> AliveTimeFractions:
        ...
        return AliveTimeFractions(
            ...
            module_coincidence_alive_time_fractions=self._module_coincidence_alive_time_fractions_converter.from_json(json_object["moduleCoincidenceAliveTimeFractions"],),
        )
    ...
    def from_json_to_numpy(self, json_object: object) -> np.void:
        ...
        return (
            ...
            self._module_coincidence_alive_time_fractions_converter.from_json_to_numpy(json_object["moduleCoincidenceAliveTimeFractions"]),
        ) # type:ignore 
...
class EventTimeBlockConverter(_ndjson.JsonConverter[EventTimeBlock, np.void]):
    def __init__(self) -> None:
        ...
        self._delayed_events_converter = _ndjson.OptionalConverter(_ndjson.VectorConverter(_ndjson.VectorConverter(_ndjson.VectorConverter(CoincidenceEventConverter()))))
        self._triple_events_converter = _ndjson.OptionalConverter(_ndjson.VectorConverter(_ndjson.VectorConverter(_ndjson.VectorConverter(_ndjson.VectorConverter(TripleEventConverter())))))
        super().__init__(np.dtype([
