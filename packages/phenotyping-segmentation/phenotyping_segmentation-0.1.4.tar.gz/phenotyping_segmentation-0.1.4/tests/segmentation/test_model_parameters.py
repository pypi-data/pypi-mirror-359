...
from tests.fixtures.data import crop_image_1, input_dir, params_json, model_name, DEVICE
...
def test_setup_model_parameters(input_dir, model_name, DEVICE, crop_image_1):
    best_model, select_classes, select_class_rgb_values, preprocessing_fn = (
