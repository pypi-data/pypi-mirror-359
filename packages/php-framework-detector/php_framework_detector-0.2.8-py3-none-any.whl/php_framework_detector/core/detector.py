    ...
    async def _load_composer_json_async(self) -> Dict[str, Any]:
        ...
        if composer_path.exists():
            try:
                ...
                logger.warning("Failed to parse composer.json", error=str(e))
            except Exception as e:
                logger.warning("Failed to read composer.json", error=str(e))
        ...
        if lock_path.exists():
            try:
                ...
                logger.warning("Failed to parse composer.lock", error=str(e))
            except Exception as e:
                logger.warning("Failed to read composer.lock", error=str(e))
