...
STOCK_PRICE_TYPE_LIMITPRICE = "LMT" # 限價 0
STOCK_PRICE_TYPE_FLT = "FLT" # 平盤 1
STOCK_PRICE_TYPE_LIMITUP = "LMU" # 漲停 2
STOCK_PRICE_TYPE_LIMITDOWN = "LMD" # 跌停 3
STOCK_PRICE_TYPE_MKT = "MKT" # 市價 4
...
class StockPriceType(str, Enum):
    LMT = STOCK_PRICE_TYPE_LIMITPRICE # 限價 0
    FLT = STOCK_PRICE_TYPE_FLT # 平盤
    LMU = STOCK_PRICE_TYPE_LIMITUP # 漲停
    LMD = STOCK_PRICE_TYPE_LIMITDOWN # 跌停
    MKT = STOCK_PRICE_TYPE_MKT # 市價 4
