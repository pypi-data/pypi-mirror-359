...
class BinanceMCPServer:
    ...
    def __init__(self, api_key: str = "", secret_key: str = "", member_key: str = ""):
        ...
        # Validate premium member key
        self._member_key = None
        if member_key:
            self._validate_member_key(member_key)
    ...
    def _setup_tools(self):
        ...
        async def handle_call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
            ...
            premium_tools = [
                "place_order", "place_bracket_order", "place_multiple_orders", "cancel_order",
                "cancel_multiple_orders", "cancel_all_orders", "auto_cancel_all_orders",
                "close_position", "modify_order", "add_tp_sl_to_position"
            ]
    ...
    def _validate_member_key(self, member_key: str):
        ...
        try:
            ...
            if key_info:
                print(f"[OK] Premium member key validated for {key_info.member_id}")
