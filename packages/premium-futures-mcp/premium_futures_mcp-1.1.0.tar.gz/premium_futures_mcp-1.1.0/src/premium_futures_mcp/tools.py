...
def get_account_tools():
    ...
    return [
        ...
        Tool(
            ...
            description="Get current position information V2. If symbol specified, returns position for that symbol. If no symbol provided, returns only OPEN positions (non-zero size) to avoid token bloat.",
            inputSchema={
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "Trading pair symbol (optional - if not provided, returns only open positions)"}
                },
                "required": []
            }
        ),
        ...
        Tool(
            name="get_balance_debug",
            description="Get raw futures account balance data for debugging purposes (shows unfiltered response from Binance API)",
            inputSchema={
                "type": "object",
                "properties": {},
                "required": []
        ...
        Tool(
            name="get_account_info_debug",
            description="Get raw futures account information for debugging purposes (shows unfiltered response from Binance API)",
            inputSchema={
                "type": "object",
                "properties": {},
                "required": []
        ...
        Tool(
            ...
            description="Test API connection and authentication by checking server time and account access",
            inputSchema={
                "type": "object",
                "properties": {},
                "required": []
