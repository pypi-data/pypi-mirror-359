...
class ToolHandler:
    ...
    async def handle_tool_call(self, name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async with BinanceClient(self.config) as client:
            ...
            # Market Data Tools
                ...
                return await self._handle_top_gainers_losers(arguments)
            elif name == "get_market_overview":
                return await self._handle_market_overview(arguments)
    ...
    async def _handle_top_gainers_losers(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_market_overview(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Check if cache has data after refresh attempt
