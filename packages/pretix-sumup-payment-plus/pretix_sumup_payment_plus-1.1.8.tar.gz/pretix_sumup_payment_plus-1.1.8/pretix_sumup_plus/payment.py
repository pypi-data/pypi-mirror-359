...
from pretix_sumup_plus import sumup_client
...
class SumUp(BasePaymentProvider):
        ...
        try:
            checkout_params = {
                ...
                "return_url": build_absolute_uri(
                    event,
                    "plugins:pretix_sumup_plus:checkout_event",
            ...
            if self.settings.get("enable_apms", as_type=bool, default=False):
                checkout_params["redirect_url"] = build_absolute_uri(
                    event,
                    "plugins:pretix_sumup_plus:return",
                    kwargs={
                        "order": order.code,
                        "payment": payment.pk,
                        "hash": order.tagged_secret("plugins:pretix_sumup_plus"),
                    },
                )
    ...
    def payment_pending_render(self, request: HttpRequest, payment: OrderPayment):
        ...
        return get_template("pretix_sumup_plus/payment_widget.html").render(context)
    ...
    def payment_presale_render(self, payment: OrderPayment):
        ...
        return get_template("pretix_sumup_plus/control.html").render(
            {
