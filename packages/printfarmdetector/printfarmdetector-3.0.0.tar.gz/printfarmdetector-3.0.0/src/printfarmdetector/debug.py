...
client = OpenAI(api_key="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")  # Usa variable de entorno
        ...
        input=[
            {
                ...
                "content": [
                    {
                        "type": "input_file",
                        "filename": "granadilla.jpg",
                        "file_data": f"data:image/jpeg;base64,{imagen_base64}",
                    },
                    {
                        "type": "input_text",
                        "text": prompt,
