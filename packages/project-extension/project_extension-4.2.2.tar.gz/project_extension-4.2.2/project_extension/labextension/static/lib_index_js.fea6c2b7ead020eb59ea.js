...
class ProjectSidebarWidget extends _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    constructor(app, documentManager) {
        ...
        this.app = app;
        this.documentManager = documentManager;
        this.projectId = JSON.parse(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.PageConfig.getOption('project_id') || '{}');
...
//# sourceMappingURL=lib_index_js.fea6c2b7ead020eb59ea.js.map