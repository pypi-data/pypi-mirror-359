...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, prn=None, content_guard=None, no_content_change_since=None, name=None, pulp_created=None, base_url=None, base_path=None, pulp_labels=None, hidden=False, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
