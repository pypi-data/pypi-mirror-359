...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_href=None, content_guard=None, base_url=None, base_path=None, pulp_labels=None, name=None, hidden=False, pulp_created=None, local_vars_configuration=None):  # noqa: E501
