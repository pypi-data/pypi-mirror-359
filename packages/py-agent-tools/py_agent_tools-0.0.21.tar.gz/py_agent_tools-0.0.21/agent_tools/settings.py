...
class NewAPISettings(BaseSettings):
    """New API configuration settings."""

    model_config = SettingsConfigDict(env_prefix="NEW_API_")
    base_url: str = Field(default="https://hgj.buzzcloud.ai")
...
class AgentSettings(BaseSettings):
    ...
    new_api: NewAPISettings = Field(default_factory=NewAPISettings)
