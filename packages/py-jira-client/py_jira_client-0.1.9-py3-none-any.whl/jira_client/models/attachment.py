...
class Attachment(BaseModel):
    ...
    """ # noqa: E501
    author: Optional[UserDetails] = Field(default=None, description="Details of the user who added the attachment.")
    content: Optional[StrictStr] = Field(default=None, description="The content of the attachment.")
    created: Optional[datetime] = Field(default=None, description="The datetime the attachment was created.")
    filename: Optional[StrictStr] = Field(default=None, description="The file name of the attachment.")
    ...
    var_self: Optional[StrictStr] = Field(default=None, description="The URL of the attachment details response.", alias="self")
    ...
    __properties: ClassVar[List[str]] = ["author", "content", "created", "filename", "id", "mimeType", "self", "size", "thumbnail"]
