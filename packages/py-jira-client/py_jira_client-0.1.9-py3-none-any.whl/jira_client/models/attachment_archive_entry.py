...
class AttachmentArchiveEntry(BaseModel):
    ...
    """ # noqa: E501
    abbreviated_name: Optional[StrictStr] = Field(default=None, alias="abbreviatedName")
    entry_index: Optional[StrictInt] = Field(default=None, alias="entryIndex")
    media_type: Optional[StrictStr] = Field(default=None, alias="mediaType")
    name: Optional[StrictStr] = None
    size: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["abbreviatedName", "entryIndex", "mediaType", "name", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "abbreviatedName": obj.get("abbreviatedName"),
            "entryIndex": obj.get("entryIndex"),
