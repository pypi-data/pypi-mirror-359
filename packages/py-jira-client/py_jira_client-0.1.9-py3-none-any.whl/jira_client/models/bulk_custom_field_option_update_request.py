...
class BulkCustomFieldOptionUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    options: Optional[List[CustomFieldOptionUpdate]] = Field(default=None, description="Details of the options to update.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [CustomFieldOptionUpdate.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
