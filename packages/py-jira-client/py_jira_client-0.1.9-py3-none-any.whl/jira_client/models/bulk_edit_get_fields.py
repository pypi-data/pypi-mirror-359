...
class BulkEditGetFields(BaseModel):
    ...
    fields: Optional[List[IssueBulkEditField]] = Field(default=None, description="List of all the fields")
    ...
    __properties: ClassVar[List[str]] = ["endingBefore", "fields", "startingAfter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkEditGetFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkEditGetFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fields": [IssueBulkEditField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
