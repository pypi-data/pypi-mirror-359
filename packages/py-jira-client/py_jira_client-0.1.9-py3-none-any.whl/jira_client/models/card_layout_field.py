...
class CardLayoutField(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fieldId", "id", "mode", "position"]
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['PLAN', 'WORK']):
            raise ValueError("must be one of enum values ('PLAN', 'WORK')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CardLayoutField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CardLayoutField from a dict"""
        if obj is None:
            return None
