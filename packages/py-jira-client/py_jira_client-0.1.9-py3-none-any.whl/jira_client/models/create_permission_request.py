...
class CreatePermissionRequest(BaseModel):
    ...
    type: StrictStr = Field(description="The permission type. This must be \"View\" or \"Edit\".")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "holder": CreatePermissionHolderRequest.from_dict(obj["holder"]) if obj.get("holder") is not None else None,
            "type": obj.get("type")
        })
        return _obj
