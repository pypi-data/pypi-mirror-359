...
class CustomFieldConfigurations(BaseModel):
    ...
    """ # noqa: E501
    configurations: Annotated[List[ContextualConfiguration], Field(min_length=1, max_length=1000)] = Field(description="The list of custom field configuration details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configurations": [ContextualConfiguration.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None
        })
        return _obj
