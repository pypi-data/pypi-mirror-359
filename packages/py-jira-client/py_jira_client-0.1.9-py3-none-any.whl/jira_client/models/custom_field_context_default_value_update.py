...
class CustomFieldContextDefaultValueUpdate(BaseModel):
    ...
    """ # noqa: E501
    default_values: Optional[List[CustomFieldContextDefaultValue]] = Field(default=None, alias="defaultValues")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultValues": [CustomFieldContextDefaultValue.from_dict(_item) for _item in obj["defaultValues"]] if obj.get("defaultValues") is not None else None
        })
        return _obj
