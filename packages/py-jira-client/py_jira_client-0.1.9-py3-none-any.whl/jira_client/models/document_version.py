...
class DocumentVersion(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The version UUID.")
    version_number: Optional[StrictInt] = Field(default=None, description="The version number.", alias="versionNumber")
