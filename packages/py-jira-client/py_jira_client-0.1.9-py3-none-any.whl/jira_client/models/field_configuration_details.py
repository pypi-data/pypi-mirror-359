...
class FieldConfigurationDetails(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The description of the field configuration.")
    name: Annotated[str, Field(strict=True, max_length=255)] = Field(description="The name of the field configuration. Must be unique.")
