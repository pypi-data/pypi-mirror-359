...
class FieldLayoutConfiguration(BaseModel):
    ...
    """ # noqa: E501
    var_field: Optional[StrictBool] = Field(default=None, description="Whether to show the field", alias="field")
    ...
    __properties: ClassVar[List[str]] = ["field", "pcri", "required"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FieldLayoutConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FieldLayoutConfiguration from a dict"""
        if obj is None:
            return None
