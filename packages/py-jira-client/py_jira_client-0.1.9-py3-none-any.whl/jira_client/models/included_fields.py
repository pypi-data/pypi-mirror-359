...
class IncludedFields(BaseModel):
    ...
    IncludedFields
    """ # noqa: E501
    actually_included: Optional[List[StrictStr]] = Field(default=None, alias="actuallyIncluded")
    excluded: Optional[List[StrictStr]] = None
    included: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["actuallyIncluded", "excluded", "included"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actuallyIncluded": obj.get("actuallyIncluded"),
