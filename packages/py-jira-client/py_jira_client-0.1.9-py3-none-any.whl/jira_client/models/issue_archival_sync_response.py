...
class IssueArchivalSyncResponse(BaseModel):
    ...
    number_of_issues_updated: Optional[StrictInt] = Field(default=None, alias="numberOfIssuesUpdated")
    __properties: ClassVar[List[str]] = ["errors", "numberOfIssuesUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueArchivalSyncResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueArchivalSyncResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "numberOfIssuesUpdated": obj.get("numberOfIssuesUpdated")
        })
        return _obj
