...
class IssueChangelogIds(BaseModel):
    ...
    """ # noqa: E501
    changelog_ids: List[StrictInt] = Field(description="The list of changelog IDs.", alias="changelogIds")
    __properties: ClassVar[List[str]] = ["changelogIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changelogIds": obj.get("changelogIds")
        })
        return _obj
