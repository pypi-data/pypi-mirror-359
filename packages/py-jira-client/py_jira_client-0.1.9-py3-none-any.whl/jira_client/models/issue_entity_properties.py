...
class IssueEntityProperties(BaseModel):
    ...
    """ # noqa: E501
    entities_ids: Optional[Annotated[List[StrictInt], Field(min_length=1, max_length=10000)]] = Field(default=None, description="A list of entity property IDs.", alias="entitiesIds")
    properties: Optional[Dict[str, JsonNode]] = Field(default=None, description="A list of entity property keys and values.")
    __properties: ClassVar[List[str]] = ["entitiesIds", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitiesIds": obj.get("entitiesIds"),
            "properties": dict(
