...
class IssueTypeHierarchyPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hierarchyLevel", "name", "onConflict", "pcri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueTypeHierarchyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueTypeHierarchyPayload from a dict"""
        if obj is None:
            return None
