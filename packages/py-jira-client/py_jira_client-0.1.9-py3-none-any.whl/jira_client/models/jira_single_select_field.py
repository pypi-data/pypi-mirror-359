...
class JiraSingleSelectField(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fieldId", "option"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JiraSingleSelectField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JiraSingleSelectField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "option": JiraSelectedOptionField.from_dict(obj["option"]) if obj.get("option") is not None else None
        })
        return _obj
