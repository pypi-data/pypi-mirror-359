...
class NotificationSchemeNotificationDetails(BaseModel):
    ...
    """ # noqa: E501
    notification_type: StrictStr = Field(description="The notification type, e.g `CurrentAssignee`, `Group`, `EmailAddress`.", alias="notificationType")
    parameter: Optional[StrictStr] = Field(default=None, description="The value corresponding to the specified notification type.")
