...
class OperationMessage(BaseModel):
    ...
    OperationMessage
    """ # noqa: E501
    message: StrictStr = Field(description="The human-readable message that describes the result.")
    status_code: StrictInt = Field(description="The status code of the response.", alias="statusCode")
