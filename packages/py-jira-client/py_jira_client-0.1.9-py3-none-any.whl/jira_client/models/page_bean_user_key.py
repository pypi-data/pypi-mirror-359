...
class PageBeanUserKey(BaseModel):
    ...
    values: Optional[List[UserKey]] = Field(default=None, description="The list of items.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageBeanUserKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageBeanUserKey from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "values": [UserKey.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
