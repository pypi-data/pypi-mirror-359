...
class PageOfWorklogs(BaseModel):
    ...
    worklogs: Optional[List[Worklog]] = Field(default=None, description="List of worklogs.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["maxResults", "startAt", "total", "worklogs"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in worklogs (list)
        _items = []
        if self.worklogs:
            for _item_worklogs in self.worklogs:
                if _item_worklogs:
                    _items.append(_item_worklogs.to_dict())
            _dict['worklogs'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "worklogs": [Worklog.from_dict(_item) for _item in obj["worklogs"]] if obj.get("worklogs") is not None else None
        })
