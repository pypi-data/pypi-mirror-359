...
class ScreenableTab(BaseModel):
    ...
    A screen tab.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the screen tab.")
    name: StrictStr = Field(description="The name of the screen tab. The maximum length is 255 characters.")
