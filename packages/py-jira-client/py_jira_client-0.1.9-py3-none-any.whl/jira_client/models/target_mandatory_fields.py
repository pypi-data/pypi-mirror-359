...
class TargetMandatoryFields(BaseModel):
    ...
    """ # noqa: E501
    fields: Dict[str, Fields] = Field(description="Contains the value of mandatory fields")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TargetMandatoryFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TargetMandatoryFields from a dict"""
        if obj is None:
            return None
