...
class TaskProgressBeanJsonNode(BaseModel):
    ...
    result: Optional[JsonNode] = Field(default=None, description="The result of the task execution.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskProgressBeanJsonNode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskProgressBeanJsonNode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": JsonNode.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "self": obj.get("self"),
