...
class Transitions(BaseModel):
    ...
    """ # noqa: E501
    expand: Optional[StrictStr] = Field(default=None, description="Expand options that include additional transitions details in the response.")
    transitions: Optional[List[IssueTransition]] = Field(default=None, description="List of issue transitions.")
    __properties: ClassVar[List[str]] = ["expand", "transitions"]
