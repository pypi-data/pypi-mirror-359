...
class UpdateUiModificationDetails(BaseModel):
    ...
    """ # noqa: E501
    contexts: Optional[List[UiModificationContextDetails]] = Field(default=None, description="List of contexts of the UI modification. The maximum number of contexts is 1000. If provided, replaces all existing contexts.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the UI modification. The maximum length is 255 characters.")
