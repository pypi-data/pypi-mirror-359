...
class WebhookRegistrationDetails(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The URL that specifies where to send the webhooks. This URL must use the same base URL as the Connect app. Only a single URL per app is allowed to be registered.")
    webhooks: List[WebhookDetails] = Field(description="A list of webhooks.")
    __properties: ClassVar[List[str]] = ["url", "webhooks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "webhooks": [WebhookDetails.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
