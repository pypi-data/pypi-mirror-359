...
class WorkflowOperations(BaseModel):
    ...
    """ # noqa: E501
    can_delete: StrictBool = Field(description="Whether the workflow can be deleted.", alias="canDelete")
    can_edit: StrictBool = Field(description="Whether the workflow can be updated.", alias="canEdit")
    __properties: ClassVar[List[str]] = ["canDelete", "canEdit"]
