...
class WorkflowStatusesApi:
    ...
    def get_status(
        self,
        id_or_name: Annotated[StrictStr, Field(description="The ID or name of the status.")],
        ...
        :param id_or_name: The ID or name of the status. (required)
        :type id_or_name: str
    ...
    def _get_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/3/status/{idOrName}',
    ...
    def get_statuses_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[StatusDetails]]:
        """Get all statuses
    ...
    def _get_statuses_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/api/3/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
