...
class AddAtlassianTeamRequest(BaseModel):
    ...
    planning_style: StrictStr = Field(description="The planning style for the Atlassian team. This must be \"Scrum\" or \"Kanban\".", alias="planningStyle")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddAtlassianTeamRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddAtlassianTeamRequest from a dict"""
        if obj is None:
            return None
