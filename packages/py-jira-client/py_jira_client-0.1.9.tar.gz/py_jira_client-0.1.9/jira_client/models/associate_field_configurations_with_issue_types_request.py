...
class AssociateFieldConfigurationsWithIssueTypesRequest(BaseModel):
    ...
    """ # noqa: E501
    mappings: List[FieldConfigurationToIssueTypeMapping] = Field(description="Field configuration to issue type mappings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mappings": [FieldConfigurationToIssueTypeMapping.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
        return _obj
