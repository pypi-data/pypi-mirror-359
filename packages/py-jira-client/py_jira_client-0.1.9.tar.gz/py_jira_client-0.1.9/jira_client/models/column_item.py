...
class ColumnItem(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="The issue navigator column label.")
    value: Optional[StrictStr] = Field(default=None, description="The issue navigator column value.")
