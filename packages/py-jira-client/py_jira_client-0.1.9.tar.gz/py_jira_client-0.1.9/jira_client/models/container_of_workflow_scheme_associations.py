...
class ContainerOfWorkflowSchemeAssociations(BaseModel):
    ...
    """ # noqa: E501
    values: List[WorkflowSchemeAssociations] = Field(description="A list of workflow schemes together with projects they are associated with.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [WorkflowSchemeAssociations.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
