...
class Context(BaseModel):
    ...
    A context.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the context.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the context.")
    scope: Optional[Scope] = Field(default=None, description="The scope of the context.")
