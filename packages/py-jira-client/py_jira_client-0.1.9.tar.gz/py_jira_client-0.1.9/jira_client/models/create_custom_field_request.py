...
class CreateCustomFieldRequest(BaseModel):
    ...
    """ # noqa: E501
    custom_field_id: StrictInt = Field(description="The custom field ID.", alias="customFieldId")
    filter: Optional[StrictBool] = Field(default=None, description="Allows filtering issues based on their values for the custom field.")
    __properties: ClassVar[List[str]] = ["customFieldId", "filter"]
