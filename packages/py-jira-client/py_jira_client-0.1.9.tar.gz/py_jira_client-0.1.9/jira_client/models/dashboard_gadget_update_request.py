...
class DashboardGadgetUpdateRequest(BaseModel):
    ...
    position: Optional[DashboardGadgetPosition] = Field(default=None, description="The position of the gadget.")
    title: Optional[StrictStr] = Field(default=None, description="The title of the gadget.")
    __properties: ClassVar[List[str]] = ["color", "position", "title"]
