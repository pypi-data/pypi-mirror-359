...
class ExportArchivedIssuesTaskProgressResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fileUrl", "payload", "progress", "status", "submittedTime", "taskId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExportArchivedIssuesTaskProgressResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExportArchivedIssuesTaskProgressResponse from a dict"""
        if obj is None:
            return None
