...
class IdOrKeyBean(BaseModel):
    ...
    IdOrKeyBean
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the referenced item.")
    key: Optional[StrictStr] = Field(default=None, description="The key of the referenced item.")
