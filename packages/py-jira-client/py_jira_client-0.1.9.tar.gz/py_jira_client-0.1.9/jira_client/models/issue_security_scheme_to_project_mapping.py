...
class IssueSecuritySchemeToProjectMapping(BaseModel):
    ...
    """ # noqa: E501
    issue_security_scheme_id: Optional[StrictStr] = Field(default=None, alias="issueSecuritySchemeId")
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["issueSecuritySchemeId", "projectId"]
