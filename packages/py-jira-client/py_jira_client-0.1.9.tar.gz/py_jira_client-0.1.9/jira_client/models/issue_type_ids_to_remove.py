...
class IssueTypeIdsToRemove(BaseModel):
    ...
    """ # noqa: E501
    issue_type_ids: List[StrictStr] = Field(description="The list of issue type IDs. Must contain unique values not longer than 255 characters and not be empty. Maximum of 100 IDs.", alias="issueTypeIds")
    __properties: ClassVar[List[str]] = ["issueTypeIds"]
