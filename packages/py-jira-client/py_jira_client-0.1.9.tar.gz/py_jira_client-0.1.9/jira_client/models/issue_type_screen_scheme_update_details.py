...
class IssueTypeScreenSchemeUpdateDetails(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the issue type screen scheme. The name must be unique. The maximum length is 255 characters.")
