...
class JexpEvaluateCtxJqlIssues(BaseModel):
    ...
    """ # noqa: E501
    max_results: Optional[StrictInt] = Field(default=None, description="The maximum number of issues to return from the JQL query. max results value considered may be lower than the number specific here.", alias="maxResults")
    ...
    query: Optional[StrictStr] = Field(default=None, description="The JQL query, required to be bounded. Additionally, `orderBy` clause can contain a maximum of 7 fields")
    __properties: ClassVar[List[str]] = ["maxResults", "nextPageToken", "query"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JexpEvaluateCtxJqlIssues from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JexpEvaluateCtxJqlIssues from a dict"""
        if obj is None:
            return None
