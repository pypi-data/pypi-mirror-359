...
class JiraColorField(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["color", "fieldId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JiraColorField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JiraColorField from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "color": JiraColorInput.from_dict(obj["color"]) if obj.get("color") is not None else None,
