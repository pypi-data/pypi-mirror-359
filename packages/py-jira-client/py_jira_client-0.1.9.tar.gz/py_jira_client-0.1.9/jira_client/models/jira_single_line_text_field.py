...
class JiraSingleLineTextField(BaseModel):
    ...
    text: StrictStr
    __properties: ClassVar[List[str]] = ["fieldId", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JiraSingleLineTextField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JiraSingleLineTextField from a dict"""
        if obj is None:
            return None
