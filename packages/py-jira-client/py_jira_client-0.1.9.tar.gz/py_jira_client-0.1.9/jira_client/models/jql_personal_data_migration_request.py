...
class JQLPersonalDataMigrationRequest(BaseModel):
    ...
    """ # noqa: E501
    query_strings: Optional[List[StrictStr]] = Field(default=None, description="A list of queries with user identifiers. Maximum of 100 queries.", alias="queryStrings")
