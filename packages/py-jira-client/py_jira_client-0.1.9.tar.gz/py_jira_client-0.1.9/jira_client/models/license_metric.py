...
class LicenseMetric(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key of a specific license metric.")
    value: Optional[StrictStr] = Field(default=None, description="The calculated value of a licence metric linked to the key. An example licence metric is the approximate number of user accounts.")
