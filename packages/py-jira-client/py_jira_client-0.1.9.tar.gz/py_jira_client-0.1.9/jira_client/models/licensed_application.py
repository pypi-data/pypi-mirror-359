...
class LicensedApplication(BaseModel):
    ...
    plan: StrictStr = Field(description="The licensing plan.")
    __properties: ClassVar[List[str]] = ["id", "plan"]

    @field_validator('plan')
    def plan_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['UNLICENSED', 'FREE', 'PAID']):
            raise ValueError("must be one of enum values ('UNLICENSED', 'FREE', 'PAID')")
        return value
