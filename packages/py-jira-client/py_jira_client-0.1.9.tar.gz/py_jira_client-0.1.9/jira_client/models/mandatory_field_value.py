...
class MandatoryFieldValue(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='raw', description="Will treat as `MandatoryFieldValue` if type is `raw` or `empty`")
    value: List[StrictStr] = Field(description="Value for each field. Provide a `list of strings` for non-ADF fields.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MandatoryFieldValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MandatoryFieldValue from a dict"""
        if obj is None:
            return None
