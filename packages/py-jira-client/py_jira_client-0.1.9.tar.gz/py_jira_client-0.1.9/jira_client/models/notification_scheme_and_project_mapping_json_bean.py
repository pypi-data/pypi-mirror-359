...
class NotificationSchemeAndProjectMappingJsonBean(BaseModel):
    ...
    """ # noqa: E501
    notification_scheme_id: Optional[StrictStr] = Field(default=None, alias="notificationSchemeId")
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    __properties: ClassVar[List[str]] = ["notificationSchemeId", "projectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notificationSchemeId": obj.get("notificationSchemeId"),
