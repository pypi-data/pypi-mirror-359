...
class NotificationSchemeNotificationDetailsPayload(BaseModel):
    ...
    parameter: Optional[StrictStr] = Field(default=None, description="The parameter of the notification, should be eiither null if not required, or PCRI.")
    __properties: ClassVar[List[str]] = ["notificationType", "parameter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotificationSchemeNotificationDetailsPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotificationSchemeNotificationDetailsPayload from a dict"""
        if obj is None:
            return None
