...
class PageBeanChangelog(BaseModel):
    ...
    values: Optional[List[Changelog]] = Field(default=None, description="The list of items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "values": [Changelog.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
