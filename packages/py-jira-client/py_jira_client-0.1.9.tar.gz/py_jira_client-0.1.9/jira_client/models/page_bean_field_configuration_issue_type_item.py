...
class PageBeanFieldConfigurationIssueTypeItem(BaseModel):
    ...
    values: Optional[List[FieldConfigurationIssueTypeItem]] = Field(default=None, description="The list of items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "values": [FieldConfigurationIssueTypeItem.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
