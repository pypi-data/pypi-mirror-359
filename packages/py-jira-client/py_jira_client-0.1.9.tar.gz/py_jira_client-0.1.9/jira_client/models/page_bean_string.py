...
class PageBeanString(BaseModel):
    ...
    values: Optional[List[StrictStr]] = Field(default=None, description="The list of items.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageBeanString from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageBeanString from a dict"""
        if obj is None:
            return None
