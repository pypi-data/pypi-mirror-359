...
class PermittedProjects(BaseModel):
    ...
    """ # noqa: E501
    projects: Optional[List[ProjectIdentifierBean]] = Field(default=None, description="A list of projects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "projects": [ProjectIdentifierBean.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj
