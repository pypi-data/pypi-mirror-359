...
class PrioritySchemeChangesWithoutMappings(BaseModel):
    ...
    """ # noqa: E501
    ids: List[StrictInt] = Field(description="Affected entity ids.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrioritySchemeChangesWithoutMappings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrioritySchemeChangesWithoutMappings from a dict"""
        if obj is None:
            return None
