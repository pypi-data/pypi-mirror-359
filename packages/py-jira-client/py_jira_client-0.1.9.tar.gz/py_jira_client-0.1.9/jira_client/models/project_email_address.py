...
class ProjectEmailAddress(BaseModel):
    ...
    email_address_status: Optional[List[StrictStr]] = Field(default=None, description="When using a custom domain, the status of the email address.", alias="emailAddressStatus")
    __properties: ClassVar[List[str]] = ["emailAddress", "emailAddressStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emailAddressStatus": obj.get("emailAddressStatus")
        })
        return _obj
