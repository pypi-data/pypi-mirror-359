...
class ProjectFeatureState(BaseModel):
    ...
    """ # noqa: E501
    state: Optional[StrictStr] = Field(default=None, description="The feature state.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectFeatureState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectFeatureState from a dict"""
        if obj is None:
            return None
