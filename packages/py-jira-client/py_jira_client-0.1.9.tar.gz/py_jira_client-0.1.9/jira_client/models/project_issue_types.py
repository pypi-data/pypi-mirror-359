...
class ProjectIssueTypes(BaseModel):
    ...
    """ # noqa: E501
    issue_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description="IDs of the issue types", alias="issueTypes")
    project: Optional[ProjectId] = None
    __properties: ClassVar[List[str]] = ["issueTypes", "project"]
