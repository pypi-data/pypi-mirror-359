...
class ScopePayload(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of the scope. Use `GLOBAL` or empty for company-managed project, and `PROJECT` for team-managed project")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScopePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScopePayload from a dict"""
        if obj is None:
            return None
