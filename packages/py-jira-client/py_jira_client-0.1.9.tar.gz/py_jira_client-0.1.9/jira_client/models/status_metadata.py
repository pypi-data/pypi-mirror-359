...
class StatusMetadata(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="The category of the status.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatusMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatusMetadata from a dict"""
        if obj is None:
            return None
