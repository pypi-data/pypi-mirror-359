...
class StatusUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    statuses: List[StatusUpdate] = Field(description="The list of statuses that will be updated.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": [StatusUpdate.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
