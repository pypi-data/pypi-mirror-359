...
class TaskProgressBeanRemoveOptionFromIssuesResult(BaseModel):
    ...
    result: Optional[RemoveOptionFromIssuesResult] = Field(default=None, description="The result of the task execution.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": RemoveOptionFromIssuesResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "self": obj.get("self"),
