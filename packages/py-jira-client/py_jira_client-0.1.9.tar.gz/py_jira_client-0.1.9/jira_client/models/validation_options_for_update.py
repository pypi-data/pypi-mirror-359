...
class ValidationOptionsForUpdate(BaseModel):
    ...
    """ # noqa: E501
    levels: Optional[Annotated[List[StrictStr], Field(max_length=2)]] = None
    ...
    def levels_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['WARNING', 'ERROR']):
                raise ValueError("each list item must be one of ('WARNING', 'ERROR')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidationOptionsForUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidationOptionsForUpdate from a dict"""
        if obj is None:
            return None
