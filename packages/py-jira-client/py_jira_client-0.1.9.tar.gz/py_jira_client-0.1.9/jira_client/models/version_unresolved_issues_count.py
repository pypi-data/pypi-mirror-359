...
class VersionUnresolvedIssuesCount(BaseModel):
    ...
    """ # noqa: E501
    issues_count: Optional[StrictInt] = Field(default=None, description="Count of issues.", alias="issuesCount")
    issues_unresolved_count: Optional[StrictInt] = Field(default=None, description="Count of unresolved issues.", alias="issuesUnresolvedCount")
    var_self: Optional[StrictStr] = Field(default=None, description="The URL of these count details.", alias="self")
    __properties: ClassVar[List[str]] = ["issuesCount", "issuesUnresolvedCount", "self"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issuesUnresolvedCount": obj.get("issuesUnresolvedCount"),
            "self": obj.get("self")
        })
        return _obj
