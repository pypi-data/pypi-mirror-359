...
class Webhook(BaseModel):
    ...
    expiration_date: Optional[StrictInt | StrictStr] = Field(default=None, description="The date after which the webhook is no longer sent. Use [Extend webhook life](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-webhooks/#api-rest-api-3-webhook-refresh-put) to extend the date.", alias="expirationDate")
    # FIXME: JIRA API returns expirationDate as a string, but open api spec specifies as an Integer, for now patch to allow both
