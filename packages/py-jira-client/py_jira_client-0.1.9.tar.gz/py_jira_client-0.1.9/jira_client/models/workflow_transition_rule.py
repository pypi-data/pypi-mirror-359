...
class WorkflowTransitionRule(BaseModel):
    ...
    """ # noqa: E501
    configuration: Optional[Any] = Field(default=None, description="EXPERIMENTAL. The configuration of the transition rule.")
    type: StrictStr = Field(description="The type of the transition rule.")
    __properties: ClassVar[List[str]] = ["configuration", "type"]
