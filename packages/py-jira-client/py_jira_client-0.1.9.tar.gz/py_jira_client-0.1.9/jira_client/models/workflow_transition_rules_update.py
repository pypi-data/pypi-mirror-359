...
class WorkflowTransitionRulesUpdate(BaseModel):
    ...
    """ # noqa: E501
    workflows: List[WorkflowTransitionRules] = Field(description="The list of workflows with transition rules to update.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workflows": [WorkflowTransitionRules.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
        return _obj
