...
class WorkflowTrigger(BaseModel):
    ...
    parameters: Dict[str, StrictStr] = Field(description="The parameters of the trigger.")
    rule_key: StrictStr = Field(description="The rule key of the trigger.", alias="ruleKey")
