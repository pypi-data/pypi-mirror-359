...
class WorkflowUsages(BaseModel):
    ...
    workflow_name: Optional[StrictStr] = Field(default=None, description="Workflow name.", alias="workflowName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowUsages from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowUsages from a dict"""
        if obj is None:
            return None
