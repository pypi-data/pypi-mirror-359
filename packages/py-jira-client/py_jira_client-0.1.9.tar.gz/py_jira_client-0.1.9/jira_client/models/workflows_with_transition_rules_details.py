...
class WorkflowsWithTransitionRulesDetails(BaseModel):
    ...
    """ # noqa: E501
    workflows: List[WorkflowTransitionRulesDetails] = Field(description="The list of workflows with transition rules to delete.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workflows": [WorkflowTransitionRulesDetails.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
        return _obj
