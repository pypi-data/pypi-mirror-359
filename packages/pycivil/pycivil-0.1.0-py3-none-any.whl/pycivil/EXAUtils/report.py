...
class Reporter:
    ...
    def makePDF(
        ...
        """
        completeFileName = f"{path}/{fileName}"
        completeFileNameTex = f"{completeFileName}.tex"
        completeFileNamePdf = f"{completeFileName}.pdf"
        ...
        self._run_latex(completeFileNameTex, verbose)
        ...
        if self._run_latex(completeFileNameTex, verbose):
