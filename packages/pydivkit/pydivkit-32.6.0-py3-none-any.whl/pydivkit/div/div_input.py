...
class DivInput(BaseDiv):
    ...
    enter_key_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description=(
            ...
            "override the defaultbehavior. In multiline inputs, pressing "
            "Enter will trigger the actions instead ofadding a new line."
        ),
    )
    ...
    layout_provider: typing.Optional[div_layout_provider.DivLayoutProvider] = Field(
        description=(
            "Provides data on the actual size of the element. The size "
            "is calculated withouttaking into account the margins of the "
            "element itself."
        ),
    )
