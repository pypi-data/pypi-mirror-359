...
<!-- prettier-ignore -->
[open an issue]: https://github.com/DSD-DBS/pylsp-code-actions/issues
[open a pull request]: https://github.com/DSD-DBS/pylsp-code-actions/pulls
...
This includes an installation of the `python-lsp-server`. To test against this
server, point your LSP client to the created virtualenv at `.venv`.

Alternatively, install the plugin into the server's virtualenv with:

```sh
~/virtualenvs/pylsp/bin/pip install -e .
```
