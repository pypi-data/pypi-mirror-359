...
testdata_filepath = 'tests/testdata/water_1.jpg'
...
args = parser.parse_args(['-p', str(testdata_pxldensity),
...
if __name__ == "__main__":
    ...
    imagefile = str(testdata_filepath)
    ...
    if import_success:
        ...
        ppd.logger.debug(f'Directory of script being run: {os.path.dirname(os.path.abspath(__file__))}')
        ppd.logger.debug(f'Current working directory: {os.path.abspath(os.getcwd())}')
        sys.exit(200)
