...
class srad_galaxy2_settings(ctypes.Structure):
    _pack_ = 2
    _fields_ = [
        ...
        ('opEth13', OP_ETH_SETTINGS),
        ('opEth14', OP_ETH_SETTINGS),
        ('opEth15', OP_ETH_SETTINGS),
        ('opEth16', OP_ETH_SETTINGS),
        ('ethernet10g_3', ETHERNET10G_SETTINGS),
        ('ethernet10g', ETHERNET10G_SETTINGS),
        ('ethernet10g_2', ETHERNET10G_SETTINGS),
        ('network_enables_4', ctypes.c_uint16),
        ('reporting', RAD_REPORTING_SETTINGS),
        ('gPTP', RAD_GPTP_SETTINGS),
        ('network_enables_5', ctypes.c_uint64),
        ('lin2', LIN_SETTINGS),
        ('iso_9141_kwp_enable_reserved_2', ctypes.c_uint16),
...
_SRADGalaxy2Settings = srad_galaxy2_settings
SRADGalaxy2Settings = srad_galaxy2_settings
