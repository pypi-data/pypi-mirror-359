...
def as_gen_step[**Args](
    ...
    def wrapper(*args: Args.args, **kwds: Args.kwargs):
        async_ = cast(None | Literal[False, True], kwds.pop("async_", None))
        return run_gen_step(gen_step, async_, *args, **kwds)
    return wrapper
...
def as_gen_step_iter[**Args](
    ...
    def wrapper(*args: Args.args, **kwds: Args.kwargs):
        async_ = cast(None | Literal[False, True], kwds.pop("async_", None))
        return run_gen_step_iter(gen_step, async_, *args, **kwds)
    return wrapper
