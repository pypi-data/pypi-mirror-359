/*
 * Copyright (C) 2007-2009,2014,2017--2020,2025  Kipp C. Cannon
 *
...
PyTypeObject ligolw_RowBuilder_Type = {
	...
	.tp_dealloc = __del__,
	.tp_doc =
"This class provides the logic required to transform a sequence of tokens\n"\
...
">>> rows = tokenizer.RowBuilder(Row, [\"time\", \"snr\"])\n"\
">>> l = list(rows.append(t.append(\"10,6.8,15,29.1,\")))\n"\
">>> l[0].snr\n"\
"6.8\n"\
">>> l[1].time\n"\
"15",
