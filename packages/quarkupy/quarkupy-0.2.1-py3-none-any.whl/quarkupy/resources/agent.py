...
from ..types import agent_create_chat_rag_demo_params
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                agent_create_chat_rag_demo_params.AgentCreateChatRagDemoParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncAgentResource(AsyncAPIResource):
    ...
    async def create_chat_rag_demo(
        self,
        *,
        openai_api_key: str,
        query: str,
...
class AgentResourceWithRawResponse:
    def __init__(self, agent: AgentResource) -> None:
        ...
        self.create_chat_rag_demo = to_raw_response_wrapper(
            agent.create_chat_rag_demo,
        )
...
class AsyncAgentResourceWithRawResponse:
    def __init__(self, agent: AsyncAgentResource) -> None:
        ...
        self.create_chat_rag_demo = async_to_raw_response_wrapper(
            agent.create_chat_rag_demo,
        )
...
class AgentResourceWithStreamingResponse:
    def __init__(self, agent: AgentResource) -> None:
        ...
        self.create_chat_rag_demo = to_streamed_response_wrapper(
            agent.create_chat_rag_demo,
        )
...
class AsyncAgentResourceWithStreamingResponse:
    def __init__(self, agent: AsyncAgentResource) -> None:
        ...
        self.create_chat_rag_demo = async_to_streamed_response_wrapper(
            agent.create_chat_rag_demo,
        )
