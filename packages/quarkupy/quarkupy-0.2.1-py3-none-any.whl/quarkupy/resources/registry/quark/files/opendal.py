...
from .....types.registry.quark.files import QuarkFileObjectStatus, opendal_run_params
from .....types.registry.quark.files.quark_history_item import QuarkHistoryItem
from .....types.registry.quark.files.quark_file_object_status import QuarkFileObjectStatus
...
class OpendalResource(SyncAPIResource):
    ...
    def run(
        ...
        *,
        ...
        return self._post(
            "/registry/quark/files/opendal/run",
    ...
    def schema(
        ...
        *,
        ...
        extra_headers = {"Accept": "application/json; charset=utf-8", **(extra_headers or {})}
        return self._post(
            "/registry/quark/files/opendal/schema",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
