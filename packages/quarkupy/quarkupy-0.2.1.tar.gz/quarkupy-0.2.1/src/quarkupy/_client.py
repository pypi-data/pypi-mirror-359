...
from .resources import agent, source, context, dataset, management
from ._streaming import Stream as Stream, AsyncStream as AsyncStream
from ._exceptions import QuarkupyError, APIStatusError
...
class Quarkupy(SyncAPIClient):
    ...
    with_raw_response: QuarkupyWithRawResponse
    with_streaming_response: QuarkupyWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Quarkupy client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("QUARKUPY_BASE_URL")
        if base_url is None:
            base_url = f"https://demo.quarklabs.ai/api/quark"
        ...
        self.with_raw_response = QuarkupyWithRawResponse(self)
        self.with_streaming_response = QuarkupyWithStreamedResponse(self)
...
class AsyncQuarkupy(AsyncAPIClient):
    ...
    with_raw_response: AsyncQuarkupyWithRawResponse
    with_streaming_response: AsyncQuarkupyWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncQuarkupy client instance.
        ...
        self.with_raw_response = AsyncQuarkupyWithRawResponse(self)
        self.with_streaming_response = AsyncQuarkupyWithStreamedResponse(self)
...
class QuarkupyWithRawResponse:
    def __init__(self, client: Quarkupy) -> None:
...
class AsyncQuarkupyWithRawResponse:
    def __init__(self, client: AsyncQuarkupy) -> None:
...
class QuarkupyWithStreamedResponse:
    def __init__(self, client: Quarkupy) -> None:
...
class AsyncQuarkupyWithStreamedResponse:
    def __init__(self, client: AsyncQuarkupy) -> None:
