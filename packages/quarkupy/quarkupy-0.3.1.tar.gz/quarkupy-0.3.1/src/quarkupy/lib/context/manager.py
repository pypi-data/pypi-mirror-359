...
class ContextManager(pydantic.BaseModel):
    ...
    async def get_classifiers(self, source_id: Optional[pydantic.types.UUID] = None, limit: Optional[int] = None, offset: Optional[int] = None) -> pa.Table:
        ...
        raw = await client.context.classifiers.list(source_id=source_id_param, limit=limit_param, offset=offset_param)
        buf = await raw.read()
        await client.close()
    ...
    async def get_extractors(self, source_id: Optional[pydantic.types.UUID] = None, limit: Optional[int] = None, offset: Optional[int] = None) -> pa.Table:
        ...
        raw = await client.context.extractors.list(source_id=source_id_param, limit=limit_param, offset=offset_param)
        buf = await raw.read()
        await client.close()
    ...
    async def get_classifier_text(self, classifier_id: pydantic.types.UUID) -> pa.Table:
        ...
        raw = await client.context.classifiers.retrieve_text(classifier_id=classifier_id.__str__())
        buf = await raw.read()
        await client.close()
    ...
    async def get_extractor_text(self, extractor_id: pydantic.types.UUID) -> pa.Table:
        ...
        raw = await client.context.extractors.retrieve_text(extractor_id=extractor_id.__str__())
        buf = await raw.read()
        await client.close()
