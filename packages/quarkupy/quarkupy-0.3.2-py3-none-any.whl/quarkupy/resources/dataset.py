...
from ..types import (
    ...
    dataset_retrieve_file_chunks_params,
)
...
class DatasetResource(SyncAPIResource):
    ...
    def clear_generated(
        ...
        *,
        ...
        extra_headers = {"Accept": "application/json; charset=utf-8", **(extra_headers or {})}
        return self._get(
            "/dataset/clear_generated_datasets",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    dataset_retrieve_file_chunks_params.DatasetRetrieveFileChunksParams,
                ),
            ),
            cast_to=BinaryAPIResponse,
        )
...
class DatasetResourceWithRawResponse:
    def __init__(self, dataset: DatasetResource) -> None:
        ...
        self.clear_generated = to_raw_response_wrapper(
            dataset.clear_generated,
        )
        ...
        self.retrieve_file_chunks = to_custom_raw_response_wrapper(
            dataset.retrieve_file_chunks,
            BinaryAPIResponse,
        )
...
class AsyncDatasetResourceWithRawResponse:
    def __init__(self, dataset: AsyncDatasetResource) -> None:
        ...
        self.clear_generated = async_to_raw_response_wrapper(
            dataset.clear_generated,
        )
        ...
        self.retrieve_file_chunks = async_to_custom_raw_response_wrapper(
            dataset.retrieve_file_chunks,
            AsyncBinaryAPIResponse,
        )
...
class DatasetResourceWithStreamingResponse:
    def __init__(self, dataset: DatasetResource) -> None:
        ...
        self.clear_generated = to_streamed_response_wrapper(
            dataset.clear_generated,
        )
        ...
        self.retrieve_file_chunks = to_custom_streamed_response_wrapper(
            dataset.retrieve_file_chunks,
            StreamedBinaryAPIResponse,
        )
...
class AsyncDatasetResourceWithStreamingResponse:
    def __init__(self, dataset: AsyncDatasetResource) -> None:
        ...
        self.clear_generated = async_to_streamed_response_wrapper(
            dataset.clear_generated,
        )
        ...
        self.retrieve_file_chunks = async_to_custom_streamed_response_wrapper(
            dataset.retrieve_file_chunks,
            AsyncStreamedBinaryAPIResponse,
        )
