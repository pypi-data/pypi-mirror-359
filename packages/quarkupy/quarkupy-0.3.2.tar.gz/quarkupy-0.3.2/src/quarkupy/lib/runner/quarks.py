...
class ContextInsertClassifiedSegmentsQuark(QuarkRemoteDriver):
    ...
    async def execute(self) -> QuarkHistoryItem:
        api_client = quarkupy.AsyncClient(base_url=self.BASE_URL)
        res = await api_client.registry.quark.other.context_insert_classified_segments.run(**self.quark_input, timeout=TIMEOUT)
        await api_client.close()
...
class ContextInsertExtractedSegmentsQuark(QuarkRemoteDriver):
    ...
    async def execute(self) -> QuarkHistoryItem:
        api_client = quarkupy.AsyncClient(base_url=self.BASE_URL)
        res = await api_client.registry.quark.other.context_insert_extracted_segments.run(**self.quark_input, timeout=TIMEOUT)
        await api_client.close()
...
class ContextInsertObjectsQuark(QuarkRemoteDriver):
    ...
    async def execute(self) -> QuarkHistoryItem:
        api_client = quarkupy.AsyncClient(base_url=self.BASE_URL)
        res = await api_client.registry.quark.other.context_insert_objects.run(**self.quark_input, timeout=TIMEOUT)
        await api_client.close()
...
class ContextInsertSegmentsQuark(QuarkRemoteDriver):
    ...
    async def execute(self) -> QuarkHistoryItem:
        api_client = quarkupy.AsyncClient(base_url=self.BASE_URL)
        res = await api_client.registry.quark.other.context_insert_segments.run(**self.quark_input, timeout=TIMEOUT)
        await api_client.close()
