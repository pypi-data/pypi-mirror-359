...
class TestOpendal:
    ...
    def test_method_run(self, client: Quarkupy) -> None:
        opendal = client.registry.quark.files.opendal.run(
            config={
                "bucket": "bucket",
                "type": "S3",
            },
    ...
    def test_raw_response_run(self, client: Quarkupy) -> None:
        response = client.registry.quark.files.opendal.with_raw_response.run(
            config={
                "bucket": "bucket",
                "type": "S3",
            },
    ...
    def test_streaming_response_run(self, client: Quarkupy) -> None:
        with client.registry.quark.files.opendal.with_streaming_response.run(
            config={
                "bucket": "bucket",
                "type": "S3",
            },
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_schema(self, client: Quarkupy) -> None:
        opendal = client.registry.quark.files.opendal.schema()
        assert_matches_type(object, opendal, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_schema(self, client: Quarkupy) -> None:
        response = client.registry.quark.files.opendal.with_raw_response.schema()
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_schema(self, client: Quarkupy) -> None:
        with client.registry.quark.files.opendal.with_streaming_response.schema() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncOpendal:
    ...
    async def test_method_run(self, async_client: AsyncQuarkupy) -> None:
        opendal = await async_client.registry.quark.files.opendal.run(
            config={
                "bucket": "bucket",
                "type": "S3",
            },
    ...
    async def test_raw_response_run(self, async_client: AsyncQuarkupy) -> None:
        response = await async_client.registry.quark.files.opendal.with_raw_response.run(
            config={
                "bucket": "bucket",
                "type": "S3",
            },
    ...
    async def test_streaming_response_run(self, async_client: AsyncQuarkupy) -> None:
        async with async_client.registry.quark.files.opendal.with_streaming_response.run(
            config={
                "bucket": "bucket",
                "type": "S3",
            },
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_schema(self, async_client: AsyncQuarkupy) -> None:
        opendal = await async_client.registry.quark.files.opendal.schema()
        assert_matches_type(object, opendal, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_schema(self, async_client: AsyncQuarkupy) -> None:
        response = await async_client.registry.quark.files.opendal.with_raw_response.schema()
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_schema(self, async_client: AsyncQuarkupy) -> None:
        async with async_client.registry.quark.files.opendal.with_streaming_response.schema() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
