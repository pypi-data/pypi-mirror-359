...
class TestContextClassifierPrompt:
    ...
    def test_method_run(self, client: Quarkupy) -> None:
        context_classifier_prompt = client.registry.quark.transformer.context_classifier_prompt.run(
    ...
    def test_raw_response_run(self, client: Quarkupy) -> None:
        response = client.registry.quark.transformer.context_classifier_prompt.with_raw_response.run(
            classifier_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_run(self, client: Quarkupy) -> None:
        with client.registry.quark.transformer.context_classifier_prompt.with_streaming_response.run(
            classifier_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
...
class TestAsyncContextClassifierPrompt:
    ...
    async def test_method_run(self, async_client: AsyncQuarkupy) -> None:
        context_classifier_prompt = await async_client.registry.quark.transformer.context_classifier_prompt.run(
            classifier_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_raw_response_run(self, async_client: AsyncQuarkupy) -> None:
        response = await async_client.registry.quark.transformer.context_classifier_prompt.with_raw_response.run(
            classifier_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_run(self, async_client: AsyncQuarkupy) -> None:
        async with async_client.registry.quark.transformer.context_classifier_prompt.with_streaming_response.run(
            classifier_ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
