...
class TestParseClassifierLlm:
    ...
    def test_method_run(self, client: Quarkupy) -> None:
        parse_classifier_llm = client.registry.quark.transformer.parse_classifier_llm.run(
    ...
    def test_raw_response_run(self, client: Quarkupy) -> None:
        response = client.registry.quark.transformer.parse_classifier_llm.with_raw_response.run(
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_run(self, client: Quarkupy) -> None:
        with client.registry.quark.transformer.parse_classifier_llm.with_streaming_response.run(
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
...
class TestAsyncParseClassifierLlm:
    ...
    async def test_method_run(self, async_client: AsyncQuarkupy) -> None:
        parse_classifier_llm = await async_client.registry.quark.transformer.parse_classifier_llm.run(
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(QuarkHistoryItem, parse_classifier_llm, path=["response"])
    ...
    async def test_raw_response_run(self, async_client: AsyncQuarkupy) -> None:
        response = await async_client.registry.quark.transformer.parse_classifier_llm.with_raw_response.run(
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_run(self, async_client: AsyncQuarkupy) -> None:
        async with async_client.registry.quark.transformer.parse_classifier_llm.with_streaming_response.run(
            flow_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
