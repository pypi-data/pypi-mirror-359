...
class WorkerResourceWithRawResponse:
    ...
    def dataset(self) -> DatasetResourceWithRawResponse:
        return DatasetResourceWithRawResponse(self._worker.dataset)
...
class AsyncWorkerResourceWithRawResponse:
    ...
    def dataset(self) -> AsyncDatasetResourceWithRawResponse:
        return AsyncDatasetResourceWithRawResponse(self._worker.dataset)
...
class WorkerResourceWithStreamingResponse:
    ...
    def dataset(self) -> DatasetResourceWithStreamingResponse:
        return DatasetResourceWithStreamingResponse(self._worker.dataset)
...
class AsyncWorkerResourceWithStreamingResponse:
    ...
    def dataset(self) -> AsyncDatasetResourceWithStreamingResponse:
        return AsyncDatasetResourceWithStreamingResponse(self._worker.dataset)
