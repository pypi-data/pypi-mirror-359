...
from ...types.worker.data_set_info import DataSetInfo
from ...types.worker.dataset_list_response import DatasetListResponse
...
class DatasetResource(SyncAPIResource):
    ...
    def retrieve_chunks(
        ...
        *,
        ...
        extra_headers = {"Accept": "application/x-apache-arrow-stream", **(extra_headers or {})}
        return self._get(
            f"/worker/dataset/{id}/{file_id}/chunks",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def retrieve_clear_generated_datasets(
        self,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        ...
        extra_headers = {"Accept": "application/json; charset=utf-8", **(extra_headers or {})}
        return self._get(
            "/worker/dataset/clear_generated_datasets",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncDatasetResource(AsyncAPIResource):
    ...
    async def retrieve_clear_generated_datasets(
        self,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
...
class DatasetResourceWithRawResponse:
    def __init__(self, dataset: DatasetResource) -> None:
        ...
        self.retrieve_clear_generated_datasets = to_raw_response_wrapper(
            dataset.retrieve_clear_generated_datasets,
        )
...
class AsyncDatasetResourceWithRawResponse:
    def __init__(self, dataset: AsyncDatasetResource) -> None:
        ...
        self.retrieve_clear_generated_datasets = async_to_raw_response_wrapper(
            dataset.retrieve_clear_generated_datasets,
        )
...
class DatasetResourceWithStreamingResponse:
    def __init__(self, dataset: DatasetResource) -> None:
        ...
        self.retrieve_clear_generated_datasets = to_streamed_response_wrapper(
            dataset.retrieve_clear_generated_datasets,
        )
...
class AsyncDatasetResourceWithStreamingResponse:
    def __init__(self, dataset: AsyncDatasetResource) -> None:
        ...
        self.retrieve_clear_generated_datasets = async_to_streamed_response_wrapper(
            dataset.retrieve_clear_generated_datasets,
        )
