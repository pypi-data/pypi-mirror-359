...
class TestDataset:
    ...
    def test_method_retrieve(self, client: Quark) -> None:
        dataset = client.worker.dataset.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Quark) -> None:
        response = client.worker.dataset.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Quark) -> None:
        with client.worker.dataset.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.worker.dataset.with_raw_response.retrieve(
                "",
            )
    ...
    def test_streaming_response_list(self, client: Quark) -> None:
        with client.worker.dataset.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_retrieve_arrow(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get("/worker/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/arrow").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        dataset = client.worker.dataset.retrieve_arrow(
    ...
    def test_raw_response_retrieve_arrow(self, client: Quark, respx_mock: MockRouter) -> None:
        ...
        dataset = client.worker.dataset.with_raw_response.retrieve_arrow(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve_arrow(self, client: Quark, respx_mock: MockRouter) -> None:
        ...
        with client.worker.dataset.with_streaming_response.retrieve_arrow(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
    ...
    def test_path_params_retrieve_arrow(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.worker.dataset.with_raw_response.retrieve_arrow(
                id="",
            )
    ...
    def test_method_retrieve_chunks(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/worker/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        dataset = client.worker.dataset.retrieve_chunks(
    ...
    def test_raw_response_retrieve_chunks(self, client: Quark, respx_mock: MockRouter) -> None:
        ...
        dataset = client.worker.dataset.with_raw_response.retrieve_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve_chunks(self, client: Quark, respx_mock: MockRouter) -> None:
        ...
        with client.worker.dataset.with_streaming_response.retrieve_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
    ...
    def test_path_params_retrieve_chunks(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.worker.dataset.with_raw_response.retrieve_chunks(
                file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                id="",
            )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_clear_generated_datasets(self, client: Quark) -> None:
        dataset = client.worker.dataset.retrieve_clear_generated_datasets()
        assert_matches_type(SuccessResponseMessage, dataset, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_clear_generated_datasets(self, client: Quark) -> None:
        response = client.worker.dataset.with_raw_response.retrieve_clear_generated_datasets()
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_clear_generated_datasets(self, client: Quark) -> None:
        with client.worker.dataset.with_streaming_response.retrieve_clear_generated_datasets() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_retrieve_csv(self, client: Quark) -> None:
        dataset = client.worker.dataset.retrieve_csv(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_retrieve_csv(self, client: Quark) -> None:
        response = client.worker.dataset.with_raw_response.retrieve_csv(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve_csv(self, client: Quark) -> None:
        with client.worker.dataset.with_streaming_response.retrieve_csv(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_csv(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.worker.dataset.with_raw_response.retrieve_csv(
                id="",
            )
    ...
    def test_method_retrieve_files(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get("/worker/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/files").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        dataset = client.worker.dataset.retrieve_files(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert dataset.is_closed
        assert dataset.json() == {"foo": "bar"}
    ...
    def test_raw_response_retrieve_files(self, client: Quark, respx_mock: MockRouter) -> None:
        ...
        dataset = client.worker.dataset.with_raw_response.retrieve_files(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve_files(self, client: Quark, respx_mock: MockRouter) -> None:
        ...
        with client.worker.dataset.with_streaming_response.retrieve_files(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
            assert dataset.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_files(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.worker.dataset.with_raw_response.retrieve_files(
                id="",
            )
    ...
    def test_method_retrieve_json(self, client: Quark) -> None:
        dataset = client.worker.dataset.retrieve_json(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(str, dataset, path=["response"])
    ...
    def test_raw_response_retrieve_json(self, client: Quark) -> None:
        response = client.worker.dataset.with_raw_response.retrieve_json(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve_json(self, client: Quark) -> None:
        with client.worker.dataset.with_streaming_response.retrieve_json(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_json(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.worker.dataset.with_raw_response.retrieve_json(
                id="",
            )
...
class TestAsyncDataset:
    ...
    async def test_method_retrieve(self, async_client: AsyncQuark) -> None:
        dataset = await async_client.worker.dataset.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(DataSetInfo, dataset, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncQuark) -> None:
        response = await async_client.worker.dataset.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncQuark) -> None:
        async with async_client.worker.dataset.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.worker.dataset.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncQuark) -> None:
        dataset = await async_client.worker.dataset.list()
        assert_matches_type(DatasetListResponse, dataset, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list(self, async_client: AsyncQuark) -> None:
        response = await async_client.worker.dataset.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncQuark) -> None:
        async with async_client.worker.dataset.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve_arrow(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        dataset = await async_client.worker.dataset.retrieve_arrow(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert dataset.is_closed
    ...
    async def test_raw_response_retrieve_arrow(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        dataset = await async_client.worker.dataset.with_raw_response.retrieve_arrow(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve_arrow(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        async with async_client.worker.dataset.with_streaming_response.retrieve_arrow(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
            assert dataset.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_arrow(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.worker.dataset.with_raw_response.retrieve_arrow(
                id="",
            )
    ...
    async def test_method_retrieve_chunks(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        dataset = await async_client.worker.dataset.retrieve_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert dataset.is_closed
    ...
    async def test_raw_response_retrieve_chunks(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        dataset = await async_client.worker.dataset.with_raw_response.retrieve_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve_chunks(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        async with async_client.worker.dataset.with_streaming_response.retrieve_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
    ...
    async def test_path_params_retrieve_chunks(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.worker.dataset.with_raw_response.retrieve_chunks(
                file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                id="",
            )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_clear_generated_datasets(self, async_client: AsyncQuark) -> None:
        dataset = await async_client.worker.dataset.retrieve_clear_generated_datasets()
        assert_matches_type(SuccessResponseMessage, dataset, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_clear_generated_datasets(self, async_client: AsyncQuark) -> None:
        response = await async_client.worker.dataset.with_raw_response.retrieve_clear_generated_datasets()
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_clear_generated_datasets(self, async_client: AsyncQuark) -> None:
        async with async_client.worker.dataset.with_streaming_response.retrieve_clear_generated_datasets() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve_csv(self, async_client: AsyncQuark) -> None:
        dataset = await async_client.worker.dataset.retrieve_csv(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(str, dataset, path=["response"])
    ...
    async def test_raw_response_retrieve_csv(self, async_client: AsyncQuark) -> None:
        response = await async_client.worker.dataset.with_raw_response.retrieve_csv(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve_csv(self, async_client: AsyncQuark) -> None:
        async with async_client.worker.dataset.with_streaming_response.retrieve_csv(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_csv(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.worker.dataset.with_raw_response.retrieve_csv(
                id="",
            )
    ...
    async def test_method_retrieve_files(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        dataset = await async_client.worker.dataset.retrieve_files(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert dataset.is_closed
        assert await dataset.json() == {"foo": "bar"}
    ...
    async def test_raw_response_retrieve_files(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        dataset = await async_client.worker.dataset.with_raw_response.retrieve_files(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve_files(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        ...
        async with async_client.worker.dataset.with_streaming_response.retrieve_files(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
            assert dataset.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_files(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.worker.dataset.with_raw_response.retrieve_files(
                id="",
            )
    ...
    async def test_method_retrieve_json(self, async_client: AsyncQuark) -> None:
        dataset = await async_client.worker.dataset.retrieve_json(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(str, dataset, path=["response"])
    ...
    async def test_raw_response_retrieve_json(self, async_client: AsyncQuark) -> None:
        response = await async_client.worker.dataset.with_raw_response.retrieve_json(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve_json(self, async_client: AsyncQuark) -> None:
        async with async_client.worker.dataset.with_streaming_response.retrieve_json(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_json(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.worker.dataset.with_raw_response.retrieve_json(
                id="",
            )
