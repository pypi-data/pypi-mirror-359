...
class RaraSubjectIndexer:
    ...
    def _update_methods(self, methods: dict) -> dict:
        ...
        for keyword_type, _methods in methods.items():
            ...
            allowed_methods = [
                str(getattr(_method, "value", None)) or _methods for _method in ALLOWED_METHODS_MAP.get(keyword_type)
            ]
            _methods = [str(getattr(_method, "value", None)) or _methods for _method in _methods]
