...
class Medication(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "drug_description", "drug_strength", "drug_strength_form", "drug_strength_uom", "program_pricing", "variants", "medication_product_codes", "medication_drug_database_codes"]
