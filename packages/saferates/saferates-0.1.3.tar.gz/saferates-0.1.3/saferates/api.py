...
class SaferatesAPI:
    ...
    async def get_async(self, endpoint, **kwargs):
        return await self._request_async("GET", endpoint, **kwargs)
    async def post_async(self, endpoint, **kwargs):
        return await self._request_async("POST", endpoint, **kwargs)
    async def patch_async(self, endpoint, **kwargs):
        return await self._request_async("PATCH", endpoint, **kwargs)
    async def delete_async(self, endpoint, **kwargs):
        return await self._request_async("DELETE", endpoint, **kwargs)