...
from ...types.v2.ledger_retrieve_outstanding_institution_orders_response import (
...
class LedgerResource(SyncAPIResource):
    ...
    def retrieve_outstanding_institution_orders(
        self,
        institution_id: str,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        ...
        return self._get(
            f"/api/v2/ledger/outstanding-institutional-orders/{institution_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=LedgerRetrieveOutstandingInstitutionOrdersResponse,
        )
...
class AsyncLedgerResource(AsyncAPIResource):
    ...
    async def retrieve_outstanding_institution_orders(
        self,
        institution_id: str,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
...
class LedgerResourceWithRawResponse:
    def __init__(self, ledger: LedgerResource) -> None:
        ...
        self.retrieve_outstanding_institution_orders = to_raw_response_wrapper(
            ledger.retrieve_outstanding_institution_orders,
        )
...
class AsyncLedgerResourceWithRawResponse:
    def __init__(self, ledger: AsyncLedgerResource) -> None:
        ...
        self.retrieve_outstanding_institution_orders = async_to_raw_response_wrapper(
            ledger.retrieve_outstanding_institution_orders,
        )
...
class LedgerResourceWithStreamingResponse:
    def __init__(self, ledger: LedgerResource) -> None:
        ...
        self.retrieve_outstanding_institution_orders = to_streamed_response_wrapper(
            ledger.retrieve_outstanding_institution_orders,
        )
...
class AsyncLedgerResourceWithStreamingResponse:
    def __init__(self, ledger: AsyncLedgerResource) -> None:
        ...
        self.retrieve_outstanding_institution_orders = async_to_streamed_response_wrapper(
            ledger.retrieve_outstanding_institution_orders,
        )
