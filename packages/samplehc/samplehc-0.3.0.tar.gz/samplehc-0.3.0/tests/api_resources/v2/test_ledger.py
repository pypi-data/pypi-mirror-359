...
class TestLedger:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_outstanding_institution_orders(self, client: SampleHealthcare) -> None:
        ledger = client.v2.ledger.retrieve_outstanding_institution_orders(
            "institutionId",
        )
        assert_matches_type(LedgerRetrieveOutstandingInstitutionOrdersResponse, ledger, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_outstanding_institution_orders(self, client: SampleHealthcare) -> None:
        response = client.v2.ledger.with_raw_response.retrieve_outstanding_institution_orders(
            "institutionId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_outstanding_institution_orders(self, client: SampleHealthcare) -> None:
        with client.v2.ledger.with_streaming_response.retrieve_outstanding_institution_orders(
            "institutionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve_outstanding_institution_orders(self, client: SampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `institution_id` but received ''"):
            client.v2.ledger.with_raw_response.retrieve_outstanding_institution_orders(
                "",
            )
...
class TestAsyncLedger:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_outstanding_institution_orders(self, async_client: AsyncSampleHealthcare) -> None:
        ledger = await async_client.v2.ledger.retrieve_outstanding_institution_orders(
            "institutionId",
        )
        assert_matches_type(LedgerRetrieveOutstandingInstitutionOrdersResponse, ledger, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_outstanding_institution_orders(
        self, async_client: AsyncSampleHealthcare
    ) -> None:
        response = await async_client.v2.ledger.with_raw_response.retrieve_outstanding_institution_orders(
            "institutionId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_outstanding_institution_orders(
        self, async_client: AsyncSampleHealthcare
    ) -> None:
        async with async_client.v2.ledger.with_streaming_response.retrieve_outstanding_institution_orders(
            "institutionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve_outstanding_institution_orders(
        self, async_client: AsyncSampleHealthcare
    ) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `institution_id` but received ''"):
            await async_client.v2.ledger.with_raw_response.retrieve_outstanding_institution_orders(
                "",
            )
