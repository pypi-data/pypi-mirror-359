...
class SecurityCapabilityAPI:
    ...
    def update(self, capability_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """更新安全能力"""
        response = self.client.post('/api/security_capability/update', data={"capability_id": capability_id, **data})
        return response
    
    def delete(self, capability_id: str) -> Dict[str, Any]:
        """删除安全能力"""
        response = self.client.post('/api/security_capability/delete', data={"capability_id": capability_id})
        return response 