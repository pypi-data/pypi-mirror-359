...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATATYPE']._serialized_start = 942
    ...
    _globals['_BROADBANDFRAME']._serialized_end = 628
    _globals['_TIMESERIES']._serialized_start = 630
    _globals['_TIMESERIES']._serialized_end = 756
    _globals['_TIMESERIES_DATAPOINT']._serialized_start = 707
    _globals['_TIMESERIES_DATAPOINT']._serialized_end = 756
    _globals['_ANNOTATEDTENSOR']._serialized_start = 759
    _globals['_ANNOTATEDTENSOR']._serialized_end = 940
    _globals['_ANNOTATEDTENSOR_METADATAENTRY']._serialized_start = 869
    _globals['_ANNOTATEDTENSOR_METADATAENTRY']._serialized_end = 940