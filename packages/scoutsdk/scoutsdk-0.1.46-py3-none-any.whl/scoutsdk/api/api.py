...
class ScoutAPI:
    def __init__(
        ...
        self.chat = ChatAPI(self._base_url, self._headers)
        self.assistants = AssistantsAPI(self._base_url, self._headers)
        self.conversations = ConversationsAPI(self._base_url, self._headers)
        self.utils = UtilsAPI(self._base_url, self._headers)
        self.audio = AudioAPI(self._base_url, self._headers)
        self.protected = ProtectedAPI(self._base_url, self._headers)
    ...
    def create_assistant_data(
        ...
        create_response: AssistantResponseType = self.assistants.create_data(
            assistant_id=assistant_id,
            data=converted_data,
        )
        return AssistantResponse(
            message=create_response.message,
            assistant_id=create_response.assistant_id,
        )
