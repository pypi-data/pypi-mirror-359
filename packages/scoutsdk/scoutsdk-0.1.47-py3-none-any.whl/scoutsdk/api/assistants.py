...
class AssistantsAPI:
    ...
    def create_data(
        ...
        Returns:
            AssistantDataMessageResponse: The response from the API after creating the data.
        """
        data_list = (
    ...
    def query_data(self, assistant_id: str, where: dict) -> List[AssistantDataResponse]:
        """
        ...
        Returns:
            List[AssistantDataResponse]: A list of data entries matching the query.
        """
        response, status_code = RequestUtils.get(
            url=f"{self._base_url}/api/assistants/{assistant_id}/data",
            headers=self._headers,
        ...
        return [AssistantDataResponse.model_validate(item) for item in response]
