...
class SMPModel(pl.LightningModule, SemanticSegmentationModel):
    def __init__(self, in_channels: int , out_classes: int, metrics: np.ndarray, selection_metric: str, epochs:int, t_max: int, output_path:str, ignore_index: int=255, model_name: str="unet", encoder_name: str="resnet34", **kwargs):
