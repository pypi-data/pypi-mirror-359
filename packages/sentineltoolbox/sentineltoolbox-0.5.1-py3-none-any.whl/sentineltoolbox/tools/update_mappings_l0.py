...
PACKET_LEGACY_TO_DPR = {
    "S01RFCANC": {
        ...
        "PID": "application_process_identifer",
...
for dic in [PACKET_LEGACY_TO_DPR, INCLUDE_DPR_METADATA]:
    for dpr_type in PRODUCT_TYPES_SM:
        dic[dpr_type] = copy.copy(dic["S01RFCANC"])
...
NAMESPACES = dict(sdf="http://www.gael.fr/2004/12/drb/sdf", xs="http://www.w3.org/2001/XMLSchema")

CHUNK_SIZES = {}

CHUNK_SIZES["default"] = {"packet_number": 1000, "packet_length": 1000}
...
def build_stac_properties(product_type: str, **kwargs: Any) -> dict[str, Any]:
    ...
    stac_properties = {
        "datetime": "Text(null)",
        "start_datetime": "corrected_Date_ISO8601(metadataSection/metadataObject[@ID='acquisitionPeriod']/metadataWrap/xmlData/s1-level0:acquisitionPeriod/s1-level0:startTime)",  # noqa: E501
        "end_datetime": "corrected_Date_ISO8601(metadataSection/metadataObject[@ID='acquisitionPeriod']/metadataWrap/xmlData/s1-level0:acquisitionPeriod/s1-level0:stopTime)",  # noqa: E501
        "created": "corrected_Date_ISO8601(metadataSection/metadataObject[@ID='processing']/metadataWrap/xmlData/s1-level0:processing/@stop)",  # noqa: E501
        "sat:platform_international_designator": "metadataSection/metadataObject[@ID='platform']/metadataWrap/xmlData/s1-level0:platform/s1-level0:nssdcIdentifier",  # noqa: E501
        "sat:anx_datetime": "metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:extension/s1:orbitProperties/s1:ascendingNodeTime",  # noqa: E501
        "sat:relative_orbit": "to_int(metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:relativeOrbitNumber[@type='stop'])",  # noqa: E501
        "sat:absolute_orbit": "to_int(metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:orbitNumber[@type='stop'])",  # noqa: E501
        "sat:orbit_state": "to_sat_orbit_state(metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:extension/s1:orbitProperties/s1:pass)",  # noqa: E501
        "processing:expression": "Text(systematic)",
        "processing:level": "Text(L0)",
        "processing:facility": "metadataSection/metadataObject[@ID='processing']/metadataWrap/xmlData/s1-level0:processing/s1-level0:facility/@name",  # noqa: E501
        "processing:software": "to_processing_software(metadataSection/metadataObject[@ID='processing']/metadataWrap/xmlData/s1-level0:processing/s1-level0:resource[2])",  # noqa: E501
        "platform": "to_str_lower(concat(metadataSection/metadataObject[@ID='platform']/metadataWrap/xmlData/s1-level0:platform/s1-level0:familyName, metadataSection/metadataObject[@ID='platform']/metadataWrap/xmlData/s1-level0:platform/s1-level0:number))",  # noqa: E501
        ...
        "eopf:instrument_mode": "metadataSection/metadataObject[@ID='platform']/metadataWrap/xmlData/s1-level0:platform/s1-level0:instrument/s1-level0:extension/s1sar:instrumentMode/s1sar:mode",  # noqa: E501
        "product:type": f"Text({product_type})",
        "providers": [
            {
                "name": "to_providers(metadataSection/metadataObject[@ID='processing']/metadataWrap/xmlData/s1-level0:processing/s1-level0:facility/@site)",  # noqa: E501
                "roles": ["Text(processor)"],
            },
            {
                "name": "to_providers(metadataSection/metadataObject[@ID='processing']/metadataWrap/xmlData/s1-level0:processing/s1-level0:facility/@organisation)",  # noqa: E501
                "roles": ["Text(producer)"],
            },
        ],
    }
...
block_namespaces = {
    ...
    "s1-level0": "http://www.esa.int/safe/sentinel-1.0",
...
def build_block_other_metadata(dpr_type, **kwargs: Any) -> dict[str, Any]:
    ...
    other_metadata = {
        ...
        # TODO: add product_sensing_consolidation
        ...
        "history": "to_processing_history(metadataSection/metadataObject[@ID='processing']/metadataWrap/xmlData/s1-level0:processing)",  # noqa: E501
        "cycle_number": "to_int(metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:cycleNumber)",  # noqa: E501
        "phase_identifier": "to_int(metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:phaseIdentifier)",  # noqa: E501
        "start_datetime_anx": "metadataSection/metadataObject[@ID='acquisitionPeriod']/metadataWrap/xmlData/s1-level0:acquisitionPeriod/s1-level0:extension/s1:timeANX/s1:startTimeANX",  # noqa: E501
        "stop_datetime_anx": "metadataSection/metadataObject[@ID='acquisitionPeriod']/metadataWrap/xmlData/s1-level0:acquisitionPeriod/s1-level0:extension/s1:timeANX/s1:stopTimeANX",  # noqa: E501
    }
    ...
    for packet in PACKET_FIELD_LIST[dpr_type]:
        ...
        if dpr_name in INCLUDE_DPR_METADATA.get(dpr_type, []) and packet.dpr_type != "var_bytearray":
            other_metadata[dpr_name] = to_memmap_slice(dpr_type, packet, pattern="s1.*-??-.*(?<!annot)(?<!index)\\.dat")
...
def initialize_l0_sar_mapping(dpr_type):
    ...
    mapping = {
        ...
        "stac_discovery": {
            ...
            "geometry": "to_geoJson(metadataSection/metadataObject[@ID='measurementFrameSet']/metadataWrap/xmlData/s1-level0:frameSet/s1-level0:frame/s1-level0:footPrint/gml:coordinates)",  # noqa: E501
            "bbox": "to_bbox(metadataSection/metadataObject[@ID='measurementFrameSet']/metadataWrap/xmlData/s1-level0:frameSet/s1-level0:frame/s1-level0:footPrint/gml:coordinates)",  # noqa: E501
            "properties": {},
        ...
        mapping["other_metadata"].update(
            {
                ...
                # "slice_number": "is_optional(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:sliceNumber)",# noqa: E501
                # "total_number_of_slices": "is_optional(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:totalNumberOfSlices)",# noqa: E501
                # "theoretical_length_of_slice_in_seconds": "is_optional(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:theoreticalSliceLength)",# noqa: E501
                # "slice_overlap_in_seconds": "is_optional(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:sliceOverlap)",# noqa: E501
                # "data_take_start_time": "is_optional(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:dataTakeStartTime)",# noqa: E501
                "echo_compression_type": "is_optional(to_str_lower(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:echoCompressionType))",  # noqa: E501
                "noise_compression_type": "to_str_lower(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:noiseCompressionType)",  # noqa: E501
                "cal_compression_type": "to_str_lower(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:calCompressionType)",  # noqa: E501
                # "first_burst_cycle_number": "is_optional(metadataSection/metadataObject[@ID='generalProductInformation']/metadataWrap/xmlData/s1sar:standAloneProductInformation/s1sar:firstBurstCycleNumber)",# noqa: E501
                "cycle_number": "to_int(metadataSection/metadataObject[@ID='measurementOrbitReference']/metadataWrap/xmlData/s1-level0:orbitReference/s1-level0:cycleNumber)",  # noqa: E501
            },
        )
...
def update_mapping_header(mapping, dpr_type, safe_type):
    ...
    if dpr_type == "S01RFCANC":
        ...
        mapping["other_metadata"]["eopf_category"] = "Text(eoproduct)"
    elif dpr_type in ("S01EWRAW_", "S01IWRAW_", "S01VWRAW_", "S01ENRAW_"):
        code = safe_type[:2]
...
def build_mapping(safe_type: str, **kwargs: Any) -> dict[str, Any]:
    ...
    data_mapping += generate_data_mapping_measurements(dpr_type, main_dat_pattern, signal_types, builder_kwargs, kwargs)
...
if __name__ == "__main__":
    ...
    root_dir = Path("/opt/DATA/L0_DATA")
    ...
    update_mapping("IW_RAW_", add_conditions=True)

    S01RFCANC = (
        "S1A_RF_RAW__0SDH_20220219T011838_20220219T011839_041975_04FFB4_D281.SAFE",
        "S01RFCANC_20220219T011838_0001_A102_T472_4FFB4_DH.zarr",
        "S01RFCANC_20220219T011838_0001_A078_T000_4FFB4_HH",
    )
    S01SM4RAW = (
        "S1A_S4_RAW__0SDH_20220801T234915_20220801T234941_044366_054B70_9349.SAFE",
        "?.zarr",
        "S01SM4RAW_20220801T234915_0025_A019_T000_54B70_HH/S01SM4ANC_20220801T234915_0025_A019_T000_54B70_HH",
    )
    S01SN1RAW_ = ("S1A_N1_RAW__0SHV_20140527T054326_20140527T054406_000779_000BB9_A0A8.SAFE", "?.zarr", "?/?")
    S01GPSRAW = ("S1A_GP_RAW__0____20220801T144549_20220801T204015_044360________164F.SAFE", "?.zarr", "?/?")
    S01HKMRAW = (
        "S1A_HK_RAW__0____20220801T190339_20220801T190340_044363________FB20.SAFE",
        "S01HKMRAW_20250402T125243_0000_A097_T613.zarr",
        "",
    )
    S01AISRAW = (
        "S1C_AI_RAW__0____20200901T032419_20200901T042005_000016________BE2A.SAFE",
        "S01AISRAW_20200901T032401_12031_C2016_T775.zarr",
        "",
    )
    S01EWRAW_ = (
    ...
    S01IWRAW_ = (
        "S1A_IW_RAW__0SDH_20240410T075338_20240410T075451_053368_0678E5_4749.SAFE",
        "?.zarr",
        "",
    )
    S01WVRAW_ = (
        "S1A_WV_RAW__0SSV_20230320T144903_20230320T152048_047729_05BBC7_D5F4.SAFE",
        "?.zarr",
        "",
    )
    for safe_name, zarr_name, prod_path in [
        # S01RFCANC,
        # S01SM4RAW,
        # S01SN1RAW_,
        # S01GPSRAW,
        ...
        path_legacy = root_dir / safe_name
        path_zarr = root_dir / zarr_name
        print(f"load {path_legacy}")
        eoc = load_safe_with_eopf(path_legacy)
        print(eoc.tree())

        zarr_ouptut_path = eoc.get_default_file_name_no_extension() + ".zarr"

        new_prod = eoc[prod_path].to_datatree()
        for gr in new_prod.subtree:
            for var_name, var in gr.data_vars.items():
                if var.coords:
                    print(gr.name + "/" + var_name, var.coords)
        # print(new_prod.coords.hh_fine_time.data[100].compute())
        # data_files = build_data_list(root_dir / safe_name)
