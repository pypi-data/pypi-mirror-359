...
class UploadApi(object):
    ...
    def api_uploads_bytes_post(self, **kwargs):  # noqa: E501
        """Uploads a file by sending a JSON request with the bytes in Base 64 format.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_uploads_bytes_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UploadsUploadBytesRequest body:
        :return: UploadsUploadBytesModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_uploads_bytes_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_uploads_bytes_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_uploads_bytes_post_with_http_info(self, **kwargs):  # noqa: E501
        """Uploads a file by sending a JSON request with the bytes in Base 64 format.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_uploads_bytes_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_uploads_bytes_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='UploadsUploadBytesModel',  # noqa: E501
    ...
    def api_uploads_post(self, **kwargs):  # noqa: E501
        """Uploads a file by sending a multipart/form-data request  # noqa: E501

        The id returned by this API should be used as paremeter to other APIs.  You may also use the location property to display a preview of the uploaded file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_uploads_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_uploads_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_uploads_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_uploads_post_with_http_info(self, **kwargs):  # noqa: E501
        """Uploads a file by sending a multipart/form-data request  # noqa: E501

        The id returned by this API should be used as paremeter to other APIs.  You may also use the location property to display a preview of the uploaded file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_uploads_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_uploads_post" % key
                )
            params[key] = val
        del params['kwargs']
