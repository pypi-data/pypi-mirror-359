...
class DocumentMarkMarksSessionModel(object):
    ...
    swagger_types = {
        'id': 'str',
        'files': 'list[DocumentMarkUploadTicketModel]',
        'data': 'object'
    }
    ...
    def __init__(self, id=None, files=None, data=None):  # noqa: E501
        """DocumentMarkMarksSessionModel - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._files = None
        self._data = None
    ...
    @property
    def id(self):
        """Gets the id of this DocumentMarkMarksSessionModel.  # noqa: E501


        :return: The id of this DocumentMarkMarksSessionModel.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DocumentMarkMarksSessionModel.


        :param id: The id of this DocumentMarkMarksSessionModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def files(self):
        """Gets the files of this DocumentMarkMarksSessionModel.  # noqa: E501


        :return: The files of this DocumentMarkMarksSessionModel.  # noqa: E501
        :rtype: list[DocumentMarkUploadTicketModel]
        """
        return self._files

    @files.setter
    def files(self, files):
        """Sets the files of this DocumentMarkMarksSessionModel.


        :param files: The files of this DocumentMarkMarksSessionModel.  # noqa: E501
        :type: list[DocumentMarkUploadTicketModel]
        """
    ...
    @property
    def data(self):
        """Gets the data of this DocumentMarkMarksSessionModel.  # noqa: E501


        :return: The data of this DocumentMarkMarksSessionModel.  # noqa: E501
        :rtype: object
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this DocumentMarkMarksSessionModel.


        :param data: The data of this DocumentMarkMarksSessionModel.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentMarkMarksSessionModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentMarkMarksSessionModel):
            return False
