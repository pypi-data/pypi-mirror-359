...
class DocumentsPrePositionedMarkModel(object):
    ...
    swagger_types = {
        'flow_action_id': 'str',
        'pre_positioned_document_marks': 'list[DocumentMarkPrePositionedDocumentMarkModel]'
    }

    attribute_map = {
        'flow_action_id': 'flowActionId',
        'pre_positioned_document_marks': 'prePositionedDocumentMarks'
    }

    def __init__(self, flow_action_id=None, pre_positioned_document_marks=None):  # noqa: E501
        """DocumentsPrePositionedMarkModel - a model defined in Swagger"""  # noqa: E501
        self._flow_action_id = None
        self._pre_positioned_document_marks = None
        self.discriminator = None
        if flow_action_id is not None:
            self.flow_action_id = flow_action_id
        if pre_positioned_document_marks is not None:
            self.pre_positioned_document_marks = pre_positioned_document_marks

    @property
    def flow_action_id(self):
        """Gets the flow_action_id of this DocumentsPrePositionedMarkModel.  # noqa: E501


        :return: The flow_action_id of this DocumentsPrePositionedMarkModel.  # noqa: E501
        :rtype: str
        """
    ...
    def flow_action_id(self, flow_action_id):
        """Sets the flow_action_id of this DocumentsPrePositionedMarkModel.


        :param flow_action_id: The flow_action_id of this DocumentsPrePositionedMarkModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pre_positioned_document_marks(self):
        """Gets the pre_positioned_document_marks of this DocumentsPrePositionedMarkModel.  # noqa: E501


        :return: The pre_positioned_document_marks of this DocumentsPrePositionedMarkModel.  # noqa: E501
        :rtype: list[DocumentMarkPrePositionedDocumentMarkModel]
        """
        return self._pre_positioned_document_marks

    @pre_positioned_document_marks.setter
    def pre_positioned_document_marks(self, pre_positioned_document_marks):
        """Sets the pre_positioned_document_marks of this DocumentsPrePositionedMarkModel.


        :param pre_positioned_document_marks: The pre_positioned_document_marks of this DocumentsPrePositionedMarkModel.  # noqa: E501
        :type: list[DocumentMarkPrePositionedDocumentMarkModel]
        """

        self._pre_positioned_document_marks = pre_positioned_document_marks
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentsPrePositionedMarkModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentsPrePositionedMarkModel):
            return False
