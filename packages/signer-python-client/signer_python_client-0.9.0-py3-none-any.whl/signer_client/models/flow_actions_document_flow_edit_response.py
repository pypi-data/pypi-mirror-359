...
class FlowActionsDocumentFlowEditResponse(object):
    ...
    """
    swagger_types = {
        'rectified_participants': 'list[FlowActionsRectifiedParticipantModel]'
    }

    attribute_map = {
        'rectified_participants': 'rectifiedParticipants'
    }

    def __init__(self, rectified_participants=None):  # noqa: E501
        """FlowActionsDocumentFlowEditResponse - a model defined in Swagger"""  # noqa: E501
        self._rectified_participants = None
        self.discriminator = None
        if rectified_participants is not None:
            self.rectified_participants = rectified_participants

    @property
    def rectified_participants(self):
        """Gets the rectified_participants of this FlowActionsDocumentFlowEditResponse.  # noqa: E501


        :return: The rectified_participants of this FlowActionsDocumentFlowEditResponse.  # noqa: E501
        :rtype: list[FlowActionsRectifiedParticipantModel]
        """
        return self._rectified_participants

    @rectified_participants.setter
    def rectified_participants(self, rectified_participants):
        """Sets the rectified_participants of this FlowActionsDocumentFlowEditResponse.


        :param rectified_participants: The rectified_participants of this FlowActionsDocumentFlowEditResponse.  # noqa: E501
        :type: list[FlowActionsRectifiedParticipantModel]
        """

        self._rectified_participants = rectified_participants
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FlowActionsDocumentFlowEditResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FlowActionsDocumentFlowEditResponse):
            return False
