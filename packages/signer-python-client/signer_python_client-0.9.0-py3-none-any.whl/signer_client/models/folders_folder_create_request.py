...
class FoldersFolderCreateRequest(object):
    ...
    def __init__(self, name=None, parent_id=None):  # noqa: E501
        """FoldersFolderCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this FoldersFolderCreateRequest.  # noqa: E501


        :return: The name of this FoldersFolderCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FoldersFolderCreateRequest.


        :param name: The name of this FoldersFolderCreateRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def parent_id(self):
        """Gets the parent_id of this FoldersFolderCreateRequest.  # noqa: E501

        Id of the parent folder. Set as null to create the folder as root.  # noqa: E501

        :return: The parent_id of this FoldersFolderCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_id(self, parent_id):
        """Sets the parent_id of this FoldersFolderCreateRequest.

        Id of the parent folder. Set as null to create the folder as root.  # noqa: E501

        :param parent_id: The parent_id of this FoldersFolderCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FoldersFolderCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FoldersFolderCreateRequest):
            return False
