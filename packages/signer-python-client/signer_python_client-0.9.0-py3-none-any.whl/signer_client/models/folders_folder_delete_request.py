...
class FoldersFolderDeleteRequest(object):
    ...
    def __init__(self, delete_action=None, destination_folder_id=None):  # noqa: E501
        """FoldersFolderDeleteRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def delete_action(self):
        """Gets the delete_action of this FoldersFolderDeleteRequest.  # noqa: E501


        :return: The delete_action of this FoldersFolderDeleteRequest.  # noqa: E501
        :rtype: DeleteAction
        """
        return self._delete_action

    @delete_action.setter
    def delete_action(self, delete_action):
        """Sets the delete_action of this FoldersFolderDeleteRequest.


        :param delete_action: The delete_action of this FoldersFolderDeleteRequest.  # noqa: E501
        :type: DeleteAction
        """
    ...
    def destination_folder_id(self):
        """Gets the destination_folder_id of this FoldersFolderDeleteRequest.  # noqa: E501

        The folder to which the documents will be moved (if Lacuna.Signer.Api.Folders.FolderDeleteRequest.DeleteAction is Lacuna.Signer.Api.DeleteAction.MoveContent).  This value can be null if you want to keep the documents with no folder.  # noqa: E501

        :return: The destination_folder_id of this FoldersFolderDeleteRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def destination_folder_id(self, destination_folder_id):
        """Sets the destination_folder_id of this FoldersFolderDeleteRequest.

        The folder to which the documents will be moved (if Lacuna.Signer.Api.Folders.FolderDeleteRequest.DeleteAction is Lacuna.Signer.Api.DeleteAction.MoveContent).  This value can be null if you want to keep the documents with no folder.  # noqa: E501

        :param destination_folder_id: The destination_folder_id of this FoldersFolderDeleteRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FoldersFolderDeleteRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FoldersFolderDeleteRequest):
            return False
