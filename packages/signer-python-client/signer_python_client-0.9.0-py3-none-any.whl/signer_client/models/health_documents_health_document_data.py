...
class HealthDocumentsHealthDocumentData(object):
    ...
    swagger_types = {
        ...
        'items': 'list[HealthDocumentsHealthItemModel]'
    }
    ...
    def __init__(self, professional=None, items=None):  # noqa: E501
        """HealthDocumentsHealthDocumentData - a model defined in Swagger"""  # noqa: E501
    ...
    def professional(self):
        """Gets the professional of this HealthDocumentsHealthDocumentData.  # noqa: E501


        :return: The professional of this HealthDocumentsHealthDocumentData.  # noqa: E501
        :rtype: HealthDocumentsHealthProfessionalModel
        """
        return self._professional

    @professional.setter
    def professional(self, professional):
        """Sets the professional of this HealthDocumentsHealthDocumentData.


        :param professional: The professional of this HealthDocumentsHealthDocumentData.  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this HealthDocumentsHealthDocumentData.  # noqa: E501

        Additional strutctured information for health documents. Can be used to display medication information.  # noqa: E501

        :return: The items of this HealthDocumentsHealthDocumentData.  # noqa: E501
        :rtype: list[HealthDocumentsHealthItemModel]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this HealthDocumentsHealthDocumentData.

        Additional strutctured information for health documents. Can be used to display medication information.  # noqa: E501

        :param items: The items of this HealthDocumentsHealthDocumentData.  # noqa: E501
        :type: list[HealthDocumentsHealthItemModel]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HealthDocumentsHealthDocumentData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HealthDocumentsHealthDocumentData):
            return False
