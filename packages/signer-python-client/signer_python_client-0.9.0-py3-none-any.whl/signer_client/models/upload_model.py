...
class UploadModel(object):
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UploadModel.

        The upload Id as returned by the <a href=\"#operations-Upload-post_api_uploads\">Upload API</a>  # noqa: E501

        :param id: The id of this UploadModel.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def content_type(self, content_type):
        """Sets the content_type of this UploadModel.

        The file's mime type. Unless overridden, PDF mime types will be signed as PAdES and all other types as CAdES.  # noqa: E501

        :param content_type: The content_type of this UploadModel.  # noqa: E501
        :type: str
        """
