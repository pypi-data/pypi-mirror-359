...
class DocumentsActionUrlResponse(object):
    ...
    def __init__(self, url=None, embed_url=None):  # noqa: E501
        """DocumentsActionUrlResponse - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this DocumentsActionUrlResponse.  # noqa: E501

        The URL to redirect the user to the first pending action found.  # noqa: E501

        :return: The url of this DocumentsActionUrlResponse.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this DocumentsActionUrlResponse.

        The URL to redirect the user to the first pending action found.  # noqa: E501

        :param url: The url of this DocumentsActionUrlResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def embed_url(self):
        """Gets the embed_url of this DocumentsActionUrlResponse.  # noqa: E501

        The URL to embed the action in a iframe to use in your own application.  # noqa: E501

        :return: The embed_url of this DocumentsActionUrlResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def embed_url(self, embed_url):
        """Sets the embed_url of this DocumentsActionUrlResponse.

        The URL to embed the action in a iframe to use in your own application.  # noqa: E501

        :param embed_url: The embed_url of this DocumentsActionUrlResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentsActionUrlResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentsActionUrlResponse):
            return False
