...
class DocumentsMoveDocumentRequest(object):
    ...
    def __init__(self, folder_id=None, new_folder_name=None):  # noqa: E501
        """DocumentsMoveDocumentRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def folder_id(self):
        """Gets the folder_id of this DocumentsMoveDocumentRequest.  # noqa: E501
        ...
        :return: The folder_id of this DocumentsMoveDocumentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def folder_id(self, folder_id):
        """Sets the folder_id of this DocumentsMoveDocumentRequest.

        The Id of the folder to which the document(s) will be moved.  The folder Id can be null if you want to move the document(s) to no folder or if you want to create a new folder using Lacuna.Signer.Api.Documents.MoveDocumentRequest.NewFolderName.  # noqa: E501

        :param folder_id: The folder_id of this DocumentsMoveDocumentRequest.  # noqa: E501
        :type: str
        """
    ...
    def new_folder_name(self):
        """Gets the new_folder_name of this DocumentsMoveDocumentRequest.  # noqa: E501
        ...
        :return: The new_folder_name of this DocumentsMoveDocumentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def new_folder_name(self, new_folder_name):
        """Sets the new_folder_name of this DocumentsMoveDocumentRequest.

        The name of the folder to be created and the documents will be moved to. (If Lacuna.Signer.Api.Documents.MoveDocumentRequest.FolderId is null)  # noqa: E501

        :param new_folder_name: The new_folder_name of this DocumentsMoveDocumentRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentsMoveDocumentRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentsMoveDocumentRequest):
            return False
