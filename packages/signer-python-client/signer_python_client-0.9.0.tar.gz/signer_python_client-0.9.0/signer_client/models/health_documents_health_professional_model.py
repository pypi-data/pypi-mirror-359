...
class HealthDocumentsHealthProfessionalModel(object):
    ...
    def __init__(self, id=None, region=None):  # noqa: E501
        """HealthDocumentsHealthProfessionalModel - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._region = None
    ...
    @property
    def id(self):
        """Gets the id of this HealthDocumentsHealthProfessionalModel.  # noqa: E501

        The professional ID number (e.g CRM)  # noqa: E501

        :return: The id of this HealthDocumentsHealthProfessionalModel.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this HealthDocumentsHealthProfessionalModel.

        The professional ID number (e.g CRM)  # noqa: E501

        :param id: The id of this HealthDocumentsHealthProfessionalModel.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def region(self):
        """Gets the region of this HealthDocumentsHealthProfessionalModel.  # noqa: E501

        The professional ID region (a.k.a UF)  # noqa: E501

        :return: The region of this HealthDocumentsHealthProfessionalModel.  # noqa: E501
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """Sets the region of this HealthDocumentsHealthProfessionalModel.

        The professional ID region (a.k.a UF)  # noqa: E501

        :param region: The region of this HealthDocumentsHealthProfessionalModel.  # noqa: E501
        :type: str
        """
        if region is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HealthDocumentsHealthProfessionalModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HealthDocumentsHealthProfessionalModel):
            return False
