...
class TransactionsPriceRangeModel(object):
    ...
    def __init__(self, limit=None, price=None):  # noqa: E501
        """TransactionsPriceRangeModel - a model defined in Swagger"""  # noqa: E501
        self._limit = None
        self._price = None
    ...
    @property
    def limit(self):
        """Gets the limit of this TransactionsPriceRangeModel.  # noqa: E501

        The upper limit of the price range.  If the limit is null, this is the price when the number of transactions exceed the limit of all the other ranges.  # noqa: E501

        :return: The limit of this TransactionsPriceRangeModel.  # noqa: E501
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this TransactionsPriceRangeModel.

        The upper limit of the price range.  If the limit is null, this is the price when the number of transactions exceed the limit of all the other ranges.  # noqa: E501

        :param limit: The limit of this TransactionsPriceRangeModel.  # noqa: E501
        :type: int
        """
    ...
    @property
    def price(self):
        """Gets the price of this TransactionsPriceRangeModel.  # noqa: E501


        :return: The price of this TransactionsPriceRangeModel.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this TransactionsPriceRangeModel.


        :param price: The price of this TransactionsPriceRangeModel.  # noqa: E501
        :type: float
        """
        if price is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransactionsPriceRangeModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionsPriceRangeModel):
            return False
