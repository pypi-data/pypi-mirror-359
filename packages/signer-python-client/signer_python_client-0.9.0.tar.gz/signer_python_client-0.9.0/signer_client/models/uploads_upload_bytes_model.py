...
class UploadsUploadBytesModel(object):
    ...
    def __init__(self, id=None, size=None, digest=None):  # noqa: E501
        """UploadsUploadBytesModel - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._size = None
        self._digest = None
    ...
    @property
    def id(self):
        """Gets the id of this UploadsUploadBytesModel.  # noqa: E501

        The ID of the uploaded file so it can be used to create documents.  # noqa: E501

        :return: The id of this UploadsUploadBytesModel.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UploadsUploadBytesModel.

        The ID of the uploaded file so it can be used to create documents.  # noqa: E501

        :param id: The id of this UploadsUploadBytesModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this UploadsUploadBytesModel.  # noqa: E501

        The size in bytes of the received file.  # noqa: E501

        :return: The size of this UploadsUploadBytesModel.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this UploadsUploadBytesModel.

        The size in bytes of the received file.  # noqa: E501

        :param size: The size of this UploadsUploadBytesModel.  # noqa: E501
        :type: int
        """
    ...
    @property
    def digest(self):
        """Gets the digest of this UploadsUploadBytesModel.  # noqa: E501

        The MD5 digest (hash) of the received file. Can be used for integrity checks.  # noqa: E501

        :return: The digest of this UploadsUploadBytesModel.  # noqa: E501
        :rtype: str
        """
        return self._digest
    ...
    def digest(self, digest):
        """Sets the digest of this UploadsUploadBytesModel.

        The MD5 digest (hash) of the received file. Can be used for integrity checks.  # noqa: E501

        :param digest: The digest of this UploadsUploadBytesModel.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UploadsUploadBytesModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadsUploadBytesModel):
            return False
