...
class UploadsUploadBytesRequest(object):
    ...
    def __init__(self, bytes=None):  # noqa: E501
        """UploadsUploadBytesRequest - a model defined in Swagger"""  # noqa: E501
        self._bytes = None
    ...
    @property
    def bytes(self):
        """Gets the bytes of this UploadsUploadBytesRequest.  # noqa: E501

        The file bytes encoded in Base 64 format.  # noqa: E501

        :return: The bytes of this UploadsUploadBytesRequest.  # noqa: E501
        :rtype: str
        """
        return self._bytes
    ...
    def bytes(self, bytes):
        """Sets the bytes of this UploadsUploadBytesRequest.

        The file bytes encoded in Base 64 format.  # noqa: E501

        :param bytes: The bytes of this UploadsUploadBytesRequest.  # noqa: E501
        :type: str
        """
        if bytes is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UploadsUploadBytesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadsUploadBytesRequest):
            return False
