...
from ..models import ApplyTokensIn, ThemeBaseIn, Tokens
...
def register_theming_tools(mcp: "FastMCP") -> None:
    ...
    @mcp.tool()
    def theme_base(params: ThemeBaseIn) -> Tokens:
    ...
    @mcp.tool()
    def apply_tokens(params: ApplyTokensIn) -> Tokens:
        ...
        # Apply JSON patch
        try:
            patch = jsonpatch.JsonPatch(params.patch)
