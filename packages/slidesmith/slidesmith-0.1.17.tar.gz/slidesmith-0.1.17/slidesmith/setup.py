...
def setup_slidesmith(force: bool = False, console: Optional[Console] = None) -> None:
    ...
    # In a wheel, templates are at the package root level
    import slidesmith
    package_dir = Path(slidesmith.__file__).parent.parent
    templates_src = package_dir / "templates"
    
    # If not found at package root, try inside slidesmith package
    if not templates_src.exists():
        templates_src = Path(slidesmith.__file__).parent / "templates"
