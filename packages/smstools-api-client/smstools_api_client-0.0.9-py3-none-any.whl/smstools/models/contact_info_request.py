...
class ContactInfoRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactInfoRequest:
        """Create an instance of ContactInfoRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactInfoRequest:
        """Create an instance of ContactInfoRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactInfoRequest.parse_obj(obj)

        _obj = ContactInfoRequest.parse_obj({
            "id": obj.get("ID"),
            "phone": obj.get("phone"),
