...
class ContactInfoResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ID", "phone", "firstname", "lastname", "unsubscribed", "groupid", "email", "extra1", "extra2", "extra3", "extra4", "extra5", "extra6", "extra7", "extra8", "extra9", "extra10", "birthday", "memo"]
