...
class GetConversation200Response(BaseModel):
    ...
    conversation: Optional[List[GetConversation200ResponseAllOfConversationInner]] = None
    __properties: ClassVar[List[str]] = ["total", "shown", "page", "limit", "conversation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "conversation": [GetConversation200ResponseAllOfConversationInner.from_dict(_item) for _item in obj["conversation"]] if obj.get("conversation") is not None else None
        })
        return _obj
