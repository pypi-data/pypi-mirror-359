...
class GetConversation200ResponseAllOfConversationInnerFile(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "image", "mime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetConversation200ResponseAllOfConversationInnerFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetConversation200ResponseAllOfConversationInnerFile from a dict"""
        if obj is None:
            return None
