...
class GetGroup200ResponseContactsInner(BaseModel):
    """
    GetGroup200ResponseContactsInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetGroup200ResponseContactsInner:
        """Create an instance of GetGroup200ResponseContactsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetGroup200ResponseContactsInner:
        """Create an instance of GetGroup200ResponseContactsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetGroup200ResponseContactsInner.parse_obj(obj)

        _obj = GetGroup200ResponseContactsInner.parse_obj({
            "id": obj.get("ID"),
            "phone": obj.get("phone"),
