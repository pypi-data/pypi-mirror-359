...
class GetHistory200Response(BaseModel):
    ...
    messages: Optional[List[GetHistory200ResponseAllOfMessagesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "messages": [GetHistory200ResponseAllOfMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
