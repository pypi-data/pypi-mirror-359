...
class GetWebhook200ResponseInner(BaseModel):
    """
    ...
    message: Optional[GetWebhook200ResponseInnerMessage] = None
    __properties: ClassVar[List[str]] = ["webhook_id", "webhook_type", "username", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWebhook200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWebhook200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "message": GetWebhook200ResponseInnerMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
