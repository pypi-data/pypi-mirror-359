...
class UpdateMessageTemplateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ID", "title", "message", "order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateMessageTemplateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateMessageTemplateRequest from a dict"""
        if obj is None:
            return None
