...
class WhatsappIsWindowOpenRequest(BaseModel):
    ...
    """ # noqa: E501
    to: Optional[StrictStr] = Field(default=None, description="the number that will receive the message in international format (eg: 324xx, 316xx, ...)")
    ...
    __properties: ClassVar[List[str]] = ["to", "sender"]
