...
class FormatNumber200ResponseInner(BaseModel):
    """
    FormatNumber200ResponseInner
    """ # noqa: E501
    is_valid_number: Optional[StrictBool] = Field(default=None, alias="isValidNumber")
    number_type: Optional[StrictStr] = Field(default=None, alias="numberType")
    prefix_code: Optional[StrictInt] = Field(default=None, alias="prefixCode")
    region_code: Optional[StrictStr] = Field(default=None, alias="regionCode")
    formatted_number: Optional[StrictStr] = Field(default=None, alias="formattedNumber")
    __properties: ClassVar[List[str]] = ["isValidNumber", "numberType", "prefixCode", "regionCode", "formattedNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FormatNumber200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FormatNumber200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "isValidNumber": obj.get("isValidNumber"),
            "numberType": obj.get("numberType"),
            "prefixCode": obj.get("prefixCode"),
            "regionCode": obj.get("regionCode"),
            "formattedNumber": obj.get("formattedNumber")
        })
        return _obj
