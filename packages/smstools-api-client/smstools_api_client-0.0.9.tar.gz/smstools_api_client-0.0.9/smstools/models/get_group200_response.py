...
class GetGroup200Response(BaseModel):
    """
    GetGroup200Response
    """ # noqa: E501
    ...
    groupinfo: Optional[GroupInfoResponse] = None
    contacts: Optional[List[ContactInfoResponse]] = None
    __properties: ClassVar[List[str]] = ["total", "shown", "page", "limit", "groupinfo", "contacts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetGroup200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of groupinfo
        if self.groupinfo:
            _dict['groupinfo'] = self.groupinfo.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetGroup200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "groupinfo": GroupInfoResponse.from_dict(obj["groupinfo"]) if obj.get("groupinfo") is not None else None,
            "contacts": [ContactInfoResponse.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None
        })
        return _obj
