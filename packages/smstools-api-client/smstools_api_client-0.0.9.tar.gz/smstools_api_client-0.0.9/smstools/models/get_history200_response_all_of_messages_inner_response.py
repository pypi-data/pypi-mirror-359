...
class GetHistory200ResponseAllOfMessagesInnerResponse(BaseModel):
    """
    GetHistory200ResponseAllOfMessagesInnerResponse
    """ # noqa: E501
    read: Optional[StrictBool] = None
    read_date: Optional[StrictStr] = None
    response: Optional[StrictStr] = None
    response_sms: Optional[StrictStr] = None
    response_sms_date: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["read", "read_date", "response", "response_sms", "response_sms_date"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetHistory200ResponseAllOfMessagesInnerResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetHistory200ResponseAllOfMessagesInnerResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "read": obj.get("read"),
            "read_date": obj.get("read_date"),
            "response": obj.get("response"),
            "response_sms": obj.get("response_sms"),
            "response_sms_date": obj.get("response_sms_date")
        })
        return _obj
