...
class GetInbox200Response(BaseModel):
    """
    GetInbox200Response
    """ # noqa: E501
    ...
    messages: Optional[List[GetInbox200ResponseAllOfMessagesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInbox200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInbox200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "messages": [GetInbox200ResponseAllOfMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
