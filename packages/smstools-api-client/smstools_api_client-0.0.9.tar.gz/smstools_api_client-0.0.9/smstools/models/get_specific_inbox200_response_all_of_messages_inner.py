...
class GetSpecificInbox200ResponseAllOfMessagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ID", "message", "sender", "type", "date"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSpecificInbox200ResponseAllOfMessagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSpecificInbox200ResponseAllOfMessagesInner from a dict"""
        if obj is None:
            return None
