...
class GetWebhook200ResponseInnerMessage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["messageid", "datetime", "content", "sender", "receiver", "reference", "delivery_code", "delivery_status", "delivery_code_detail", "delivery_code_detail_description"]
