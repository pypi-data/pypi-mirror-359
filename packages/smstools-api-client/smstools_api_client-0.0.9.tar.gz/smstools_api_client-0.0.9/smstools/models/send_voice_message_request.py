...
class SendVoiceMessageRequest(BaseModel):
    ...
    language: Optional[StrictStr] = Field(default=None, description="possible languages: en (default), nl, fr or de")
    __properties: ClassVar[List[str]] = ["message", "to", "date", "reference", "test", "subid", "gender", "language"]
    ...
    def language_validate_enum(cls, value):
        ...
        if value not in set(['en', 'nl', 'fr', 'de']):
