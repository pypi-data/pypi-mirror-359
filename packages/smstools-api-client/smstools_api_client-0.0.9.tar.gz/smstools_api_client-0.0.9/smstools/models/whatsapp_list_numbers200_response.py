...
class WhatsappListNumbers200Response(BaseModel):
    """
    WhatsappListNumbers200Response
    """ # noqa: E501
    numbers: Optional[List[WhatsappListNumbers200ResponseNumbersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhatsappListNumbers200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhatsappListNumbers200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "numbers": [WhatsappListNumbers200ResponseNumbersInner.from_dict(_item) for _item in obj["numbers"]] if obj.get("numbers") is not None else None
        })
        return _obj
