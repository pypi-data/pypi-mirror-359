...
class WhatsappListTemplates200Response(BaseModel):
    """
    WhatsappListTemplates200Response
    """ # noqa: E501
    templates: Optional[List[WhatsappListTemplates200ResponseTemplatesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhatsappListTemplates200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhatsappListTemplates200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "templates": [WhatsappListTemplates200ResponseTemplatesInner.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
