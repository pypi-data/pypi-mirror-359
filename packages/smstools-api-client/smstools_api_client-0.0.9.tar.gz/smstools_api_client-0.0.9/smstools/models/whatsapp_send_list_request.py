...
class WhatsappSendListRequest(BaseModel):
    """
    ...
    list: StrictStr = Field(description="Provide an array of objects, where each object includes a title and an associated array of actions.")
    button_text: StrictStr = Field(description="The text displayed on the button. Upon clicking this button, the list will become visible in WhatsApp.")
    ...
    __properties: ClassVar[List[str]] = ["message", "sender", "to", "date", "reference", "test", "subid", "list", "button_text", "header", "footer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhatsappSendListRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhatsappSendListRequest from a dict"""
        if obj is None:
            return None
