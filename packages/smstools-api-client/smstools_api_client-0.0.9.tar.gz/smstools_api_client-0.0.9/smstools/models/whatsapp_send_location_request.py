...
class WhatsappSendLocationRequest(BaseModel):
    """
    ...
    location: WhatsappSendLocationRequestAllOfLocation
    __properties: ClassVar[List[str]] = ["sender", "to", "date", "reference", "test", "subid", "location"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhatsappSendLocationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhatsappSendLocationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subid": obj.get("subid"),
            "location": WhatsappSendLocationRequestAllOfLocation.from_dict(obj["location"]) if obj.get("location") is not None else None
        })
        return _obj
