...
class WhatsappSendTemplateRequest(BaseModel):
    ...
    image: Optional[StrictStr] = Field(default=None, description="Only required if your template has a header_type of 'image'")
    video: Optional[StrictStr] = Field(default=None, description="Only required if your template has a header_type of 'video'")
    document: Optional[StrictStr] = Field(default=None, description="Only required if your template has a header_type of 'document'")
    __properties: ClassVar[List[str]] = ["sender", "to", "date", "reference", "test", "subid", "template_name", "image", "video", "document"]
