...
class StaticRunRegistry:
    ...
    def _register_builtin_tags(self) -> None:
        ...
        self.register_tag('demo', [
            ('pwd && whoami', '顯示目前身分、路徑'),
            ('uvx soldcli@latest info', '查soldcli版系統資訊'),
            ('hostnamectl', '看看內建系統資訊'),
        ])
        ...
        self.register_tag('qtwu1122', [
            ('mkdir -p /dat/runpy/ && cd /dat/runpy/ && uvx soldcli@latest toml qtwu1122 --base-dir .', '確保qtwu風格目錄被建立並製造隔離環境'),
