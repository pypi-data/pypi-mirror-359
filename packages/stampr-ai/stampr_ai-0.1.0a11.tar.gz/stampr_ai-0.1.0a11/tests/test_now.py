"""Test: Most Recent Signature Verification"""
...
@pytest.mark.vcr
def test_now_signature() -> None:
    """Test verification against most recent signature"""
    api_key = get_openai_api_key() or "dummy_api_key"

    result = verify_model("gpt-4o:now", "OpenAI", api_key)
