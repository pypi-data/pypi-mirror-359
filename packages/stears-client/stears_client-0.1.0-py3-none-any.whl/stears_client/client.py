...
class StearsClient:
    ...
    api_key:
        ...
        looks for **STEAR_API_KEY** in the environment (populate it via an
        ``.env`` file).
    base_url:
    ...
    def __init__(
        ...
        *,
        ...
        self.api_key: str | None = api_key or os.getenv("STEAR_API_KEY")
        ...
        if not self.api_key:
            raise StearsClientError(
                "API key not supplied and STEAR_API_KEY not found in environment."
            )
