import{s,k as i,r as m,j as e}from"./index.BHoorvVC.js";import{P as c,R as l}from"./RenderInPortalIfExists.DSEpNV6C.js";const p=""+new URL("../media/flake-0.DgWaVvm5.png",import.meta.url).href,d=""+new URL("../media/flake-1.B2r5AHMK.png",import.meta.url).href,f=""+new URL("../media/flake-2.BnWSExPC.png",import.meta.url).href,o=150,g=150,E=10,S=90,u=4e3,n=(t,a=0)=>Math.random()*(t-a)+a,x=()=>i(`from{transform:translateY(0)
      rotateX(`,n(360),`deg)
      rotateY(`,n(360),`deg)
