...
class DataLoader:
    ...
    def __read_and_put_data(self, source: DataLoaderSource) -> None:
        ...
        if isinstance(data, pd.DataFrame):
            ...
            self._metric_registry.record_metric("ingested_items_with_data_loader_total", len(data), labels=labels)
            ...
            for chunk in data:
                ...
                self._metric_registry.record_metric("ingested_items_with_data_loader_total", len(chunk), labels=labels)
        else:
            error_message = (
