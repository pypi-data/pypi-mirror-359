...
class DatasetColumnUpdate(BaseModel):
    """
    Defines a column update for dataset operations.
    """
    id: Optional[int] = Field(None, description="Column ID (for existing columns)")
    column_name: str = Field(description="Column name")
    description: Optional[str] = Field(None, description="Column description")
    expression: Optional[str] = Field(None, description="SQL expression for calculated columns")
    extra: Optional[str] = Field(None, description="Extra column configuration")
    filterable: Optional[bool] = Field(None, description="Whether the column is filterable")
    groupby: Optional[bool] = Field(None, description="Whether the column can be used for grouping")
    is_active: Optional[bool] = Field(None, description="Whether the column is active")
    is_dttm: Optional[bool] = Field(None, description="Whether the column is a datetime column")
    python_date_format: Optional[str] = Field(None, description="Python date format for datetime columns")
    type: Optional[str] = Field(None, description="Column data type")
    uuid: Optional[str] = Field(None, description="Column UUID")
    verbose_name: Optional[str] = Field(None, description="Human-readable column name")
    advanced_data_type: Optional[str] = Field(None, description="Advanced data type")


class DatasetMetricUpdate(BaseModel):
    """
    Defines a metric update for dataset operations.
    """
    id: Optional[int] = Field(None, description="Metric ID (for existing metrics)")
    metric_name: str = Field(description="Metric name")
    expression: str = Field(description="SQL expression for the metric")
    description: Optional[str] = Field(None, description="Metric description")
    currency: Optional[str] = Field(None, description="Currency format")
    d3format: Optional[str] = Field(None, description="D3 number format")
    extra: Optional[str] = Field(None, description="Extra metric configuration")
    metric_type: Optional[str] = Field(None, description="Metric type")
    uuid: Optional[str] = Field(None, description="Metric UUID")
    verbose_name: Optional[str] = Field(None, description="Human-readable metric name")
    warning_text: Optional[str] = Field(None, description="Warning text for the metric")
...
class DatasetUpdatePayload(BaseModel):
    ...
    columns: Optional[List[DatasetColumnUpdate]] = Field(None, description="List of columns to update/add")
    metrics: Optional[List[DatasetMetricUpdate]] = Field(None, description="List of metrics to update/add")
...
@requires_auth
@handle_api_errors
async def superset_dataset_delete_column(
    ctx: Context,
    dataset_id: int = Field(..., description="The ID of the dataset"),
    column_id: int = Field(..., description="The ID of the column to delete")
) -> Dict[str, Any]:
    """
    Delete a column from a dataset
    """
    response_data = await make_api_request(
        ctx, "delete", f"/api/v1/dataset/{dataset_id}/column/{column_id}"
    )
...
@requires_auth
@handle_api_errors
async def superset_dataset_delete_metric(
    ctx: Context,
    dataset_id: int = Field(..., description="The ID of the dataset"),
    metric_id: int = Field(..., description="The ID of the metric to delete")
) -> Dict[str, Any]:
    """
    Delete a metric from a dataset
    """
    response_data = await make_api_request(
        ctx, "delete", f"/api/v1/dataset/{dataset_id}/metric/{metric_id}"
    )
    return response_data 