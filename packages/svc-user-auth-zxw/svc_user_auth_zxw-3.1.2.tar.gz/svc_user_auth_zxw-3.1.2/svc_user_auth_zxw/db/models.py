...
from sqlalchemy import Column, Integer, String, ForeignKey, Table, UniqueConstraint, PrimaryKeyConstraint, DateTime, Text, Enum, Boolean
...
class MembershipType(Base):
    ...
    price = Column(Integer, comment="价格（分为单位）")
