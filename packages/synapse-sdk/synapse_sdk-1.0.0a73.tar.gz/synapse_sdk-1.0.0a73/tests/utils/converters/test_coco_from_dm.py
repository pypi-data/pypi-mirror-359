...
class TestDMToCOCOConverter:
    ...
    def test_converter_initialization(self, dm_converter_class, not_categorized_dataset_path):
        """Test basic initialization of the converter."""
        converter = dm_converter_class(str(not_categorized_dataset_path))
    ...
    def test_converter_initialization_categorized(self, dm_converter_class, categorized_dataset_path):
        """Test initialization with categorized dataset."""
        converter = dm_converter_class(str(categorized_dataset_path), is_categorized_dataset=True)

        assert converter.root_dir == str(categorized_dataset_path)
        assert converter.is_categorized_dataset is True

    def test_default_info(self, dm_converter_class):
        """Test default info dictionary creation."""
        converter = dm_converter_class('/dummy/path')
    ...
    def test_default_licenses(self, dm_converter_class):
    ...
    def test_reset_state(self, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_poly_to_bbox(self, dm_converter_class):
    ...
    def test_poly_to_segmentation(self, dm_converter_class):
    ...
    def test_get_or_create_category(self, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_process_polylines(self, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_process_bboxes(self, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_process_keypoints(self, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_image_info(self, mock_image_open, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_convert_single_split_no_files(self, dm_converter_class, temp_output_dir):
        """Test conversion with no matching files."""
        converter = dm_converter_class(temp_output_dir)

        with pytest.raises(FileNotFoundError):
            converter._convert_single_split()

    def test_convert_non_categorized_dataset(self, dm_converter_class, not_categorized_dataset_path):
    ...
    def test_convert_categorized_dataset(self, dm_converter_class, categorized_dataset_path):
    ...
    def test_save_to_folder(self, dm_converter_class, not_categorized_dataset_path, temp_output_dir):
    ...
    def test_supported_types(self, dm_converter_class):
    ...
    def test_find_json_file_pairs(self, dm_converter_class, temp_output_dir):
...
class TestDMToCOCOConverterIntegration:
    ...
    def test_full_conversion_workflow(self, dm_converter_class, not_categorized_dataset_path, temp_output_dir):
    ...
    def test_error_handling_invalid_json(self, dm_converter_class, temp_output_dir):
