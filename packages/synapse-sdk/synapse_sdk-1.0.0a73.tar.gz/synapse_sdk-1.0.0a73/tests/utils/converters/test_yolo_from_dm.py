...
from synapse_sdk.utils.converters.yolo.from_dm import DMToYOLOConverter


# Add the missing fixture
@pytest.fixture
def yolo_converter_class():
    return DMToYOLOConverter


class TestDMToYOLOConverter:
    """Test cases for DMToYOLOConverter class.22"""

    def test_converter_initialization(self, yolo_converter_class, not_categorized_dataset_path):
        """Test basic initialization of the YOLO converter."""
        converter = yolo_converter_class(str(not_categorized_dataset_path))
    ...
    def test_get_all_classes(self, yolo_converter_class, categorized_dataset_path):
        """Test collecting all unique class names."""
        converter = yolo_converter_class(str(categorized_dataset_path), is_categorized_dataset=True)
    ...
    def test_polygon_to_bbox(self, yolo_converter_class):
        """Test polygon to bounding box conversion."""
        converter = yolo_converter_class('/dummy/path')
        polygon = [[0, 0], [10, 0], [10, 10], [0, 10]]
        bbox = converter.polygon_to_bbox(polygon)

        assert bbox == [5.0, 5.0, 10, 10]

    def test_keypoints_to_yolo_string(self, yolo_converter_class):
    ...
    def test_convert_split_dir_without_class_map(self, yolo_converter_class, categorized_dataset_path):
    ...
    def test_convert_root_dir(self, yolo_converter_class, not_categorized_dataset_path):
    ...
    def test_save_to_folder(self, yolo_converter_class, not_categorized_dataset_path, temp_output_dir):
    ...
    def test_dataset_yaml_content(self, yolo_converter_class, not_categorized_dataset_path):
