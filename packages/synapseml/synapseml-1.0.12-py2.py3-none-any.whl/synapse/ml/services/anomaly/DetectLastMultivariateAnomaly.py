...
class DetectLastMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastMultivariateAnomaly_8069a1127877_error",
        handler=None,
        inputVariablesCols=None,
        modelId=None,
        outputCol="DetectLastMultivariateAnomaly_8069a1127877_output",
        ...
        self._setDefault(errorCol="DetectLastMultivariateAnomaly_8069a1127877_error")
        self._setDefault(outputCol="DetectLastMultivariateAnomaly_8069a1127877_output")
