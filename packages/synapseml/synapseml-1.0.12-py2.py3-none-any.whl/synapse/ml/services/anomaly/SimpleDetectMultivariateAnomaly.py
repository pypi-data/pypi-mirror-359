...
class SimpleDetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        errorCol="SimpleDetectMultivariateAnomaly_f2b98dc77f40_error",
        handler=None,
        ...
        modelId=None,
        outputCol="SimpleDetectMultivariateAnomaly_f2b98dc77f40_output",
        pollingDelay=300,
        startTime=None,
        ...
        self._setDefault(errorCol="SimpleDetectMultivariateAnomaly_f2b98dc77f40_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="SimpleDetectMultivariateAnomaly_f2b98dc77f40_output")
