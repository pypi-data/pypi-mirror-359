...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_2950963d3bd9_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_2950963d3bd9_output",
        ...
        self._setDefault(errorCol="DetectFace_2950963d3bd9_error")
        self._setDefault(outputCol="DetectFace_2950963d3bd9_output")
