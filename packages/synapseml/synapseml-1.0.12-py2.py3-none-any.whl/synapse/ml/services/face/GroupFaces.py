...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_234389e1a685_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_234389e1a685_output",
        ...
        self._setDefault(errorCol="GroupFaces_234389e1a685_error")
        self._setDefault(outputCol="GroupFaces_234389e1a685_output")
