...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_7dad9e908524_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_7dad9e908524_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_7dad9e908524_error")
        self._setDefault(outputCol="IdentifyFaces_7dad9e908524_output")
