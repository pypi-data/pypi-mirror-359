...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="VerifyFaces_63dfe8fa9e53_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_63dfe8fa9e53_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_63dfe8fa9e53_error")
        self._setDefault(outputCol="VerifyFaces_63dfe8fa9e53_output")
