...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_d9e2f9529d43_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_d9e2f9529d43_output",
        ...
        self._setDefault(errorCol="GetCustomModel_d9e2f9529d43_error")
        self._setDefault(outputCol="GetCustomModel_d9e2f9529d43_output")
