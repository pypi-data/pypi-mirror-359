...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_8f6dc3d51678_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_8f6dc3d51678_output",
        ...
        self._setDefault(errorCol="ListCustomModels_8f6dc3d51678_error")
        self._setDefault(outputCol="ListCustomModels_8f6dc3d51678_output")
