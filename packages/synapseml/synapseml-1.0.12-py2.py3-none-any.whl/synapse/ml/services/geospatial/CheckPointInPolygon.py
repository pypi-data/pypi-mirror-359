...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_5db8bc44d28e_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_5db8bc44d28e_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_5db8bc44d28e_error")
        self._setDefault(outputCol="CheckPointInPolygon_5db8bc44d28e_output")
