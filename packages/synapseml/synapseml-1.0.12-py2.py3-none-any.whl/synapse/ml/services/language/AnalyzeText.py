...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_e614fe5e282a_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_e614fe5e282a_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_e614fe5e282a_error")
        self._setDefault(outputCol="AnalyzeText_e614fe5e282a_output")
