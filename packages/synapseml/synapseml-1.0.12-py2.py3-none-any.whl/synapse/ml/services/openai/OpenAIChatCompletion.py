...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_d1a88898f110_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_d1a88898f110_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_d1a88898f110_error")
        self._setDefault(outputCol="OpenAIChatCompletion_d1a88898f110_output")
