...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_6cd3465f7f8a_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_6cd3465f7f8a_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_6cd3465f7f8a_error")
        self._setDefault(outputCol="OpenAICompletion_6cd3465f7f8a_output")
