...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_a2725b4e7e4d_error",
        handler=None,
        outputCol="OpenAIEmbedding_a2725b4e7e4d_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_a2725b4e7e4d_error")
        self._setDefault(outputCol="OpenAIEmbedding_a2725b4e7e4d_output")
