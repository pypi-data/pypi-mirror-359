...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_66c090b11138_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_66c090b11138_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_66c090b11138_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_66c090b11138_error")
        self._setDefault(messagesCol="OpenAIPrompt_66c090b11138_messages")
        self._setDefault(outputCol="OpenAIPrompt_66c090b11138_output")
