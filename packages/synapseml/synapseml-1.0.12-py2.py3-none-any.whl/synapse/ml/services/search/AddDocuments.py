...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_9d828226942b_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_9d828226942b_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_9d828226942b_error")
        self._setDefault(outputCol="AddDocuments_9d828226942b_output")
