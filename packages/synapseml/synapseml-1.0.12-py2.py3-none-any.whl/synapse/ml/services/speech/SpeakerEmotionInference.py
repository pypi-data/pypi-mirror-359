...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_d4954342027c_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_d4954342027c_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_d4954342027c_error")
        self._setDefault(outputCol="SpeakerEmotionInference_d4954342027c_output")
