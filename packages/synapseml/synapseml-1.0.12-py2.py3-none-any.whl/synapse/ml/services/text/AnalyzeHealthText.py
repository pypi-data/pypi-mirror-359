...
class AnalyzeHealthText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeHealthText_2d53a9833e1f_error",
        ...
        outputCol="AnalyzeHealthText_2d53a9833e1f_output",
        pollingDelay=300,
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="AnalyzeHealthText_2d53a9833e1f_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeHealthText_2d53a9833e1f_output")
