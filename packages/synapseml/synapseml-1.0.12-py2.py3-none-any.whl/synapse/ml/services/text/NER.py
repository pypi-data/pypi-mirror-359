...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_711444dd7962_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_711444dd7962_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_711444dd7962_error")
        self._setDefault(outputCol="NER_711444dd7962_output")
