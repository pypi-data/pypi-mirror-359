...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_e8b7ba038418_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_e8b7ba038418_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_e8b7ba038418_error")
        self._setDefault(outputCol="PII_e8b7ba038418_output")
