...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_c20625cba9d2_error",
        ...
        outputCol="TextAnalyze_c20625cba9d2_output",
        ...
        self._setDefault(errorCol="TextAnalyze_c20625cba9d2_error")
        ...
        self._setDefault(outputCol="TextAnalyze_c20625cba9d2_output")
