...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_d8f771aaa62d_error",
        handler=None,
        outputCol="Detect_d8f771aaa62d_output",
        ...
        self._setDefault(errorCol="Detect_d8f771aaa62d_error")
        self._setDefault(outputCol="Detect_d8f771aaa62d_output")
