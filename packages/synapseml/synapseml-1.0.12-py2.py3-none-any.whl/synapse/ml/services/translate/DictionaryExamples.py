...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_4593337569a8_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_4593337569a8_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_4593337569a8_error")
        self._setDefault(outputCol="DictionaryExamples_4593337569a8_output")
