...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryLookup_69ae33ba940e_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_69ae33ba940e_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_69ae33ba940e_error")
        self._setDefault(outputCol="DictionaryLookup_69ae33ba940e_output")
