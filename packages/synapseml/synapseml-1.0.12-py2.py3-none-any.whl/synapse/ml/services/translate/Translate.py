...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_30095c4e847e_error",
        fromLanguage=None,
        ...
        outputCol="Translate_30095c4e847e_output",
        ...
        self._setDefault(errorCol="Translate_30095c4e847e_error")
        self._setDefault(outputCol="Translate_30095c4e847e_output")
