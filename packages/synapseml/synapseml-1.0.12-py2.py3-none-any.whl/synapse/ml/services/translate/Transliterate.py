...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_38afe37d4d01_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_38afe37d4d01_output",
        ...
        self._setDefault(errorCol="Transliterate_38afe37d4d01_error")
        self._setDefault(outputCol="Transliterate_38afe37d4d01_output")
