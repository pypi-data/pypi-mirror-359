...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_e17d61fb2d0b_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_e17d61fb2d0b_output",
        ...
        self._setDefault(errorCol="DescribeImage_e17d61fb2d0b_error")
        self._setDefault(outputCol="DescribeImage_e17d61fb2d0b_output")
