...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_a3d3fe88b85a_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_a3d3fe88b85a_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_a3d3fe88b85a_error")
        self._setDefault(outputCol="GenerateThumbnails_a3d3fe88b85a_output")
