...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_e4a4cbcd9e3b_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_e4a4cbcd9e3b_output",
        ...
        self._setDefault(errorCol="OCR_e4a4cbcd9e3b_error")
        self._setDefault(outputCol="OCR_e4a4cbcd9e3b_output")
