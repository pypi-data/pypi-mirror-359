...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="RecognizeDomainSpecificContent_a81e5b863549_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_a81e5b863549_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_a81e5b863549_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_a81e5b863549_output")
