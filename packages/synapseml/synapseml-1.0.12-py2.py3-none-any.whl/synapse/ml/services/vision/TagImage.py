...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_358355716b0f_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_358355716b0f_output",
        ...
        self._setDefault(errorCol="TagImage_358355716b0f_error")
        self._setDefault(outputCol="TagImage_358355716b0f_output")
