...
from .feature_facade import FeatureFacade, UpsertJourneyExecutionRequest, UploadScreenshotRequest
import tempfile
import base64
...
class AgentRunner:
    ...
    async def _update_agent_journey_log(self,is_completed=False,is_exception=False):
        ...
        self.feature_facade.upsert_journey_execution(UpsertJourneyExecutionRequest(explorationId=self.exploration_id,
