...
from nptyping import NDArray, Shape, Float, Bool, Str0
...
class SampleLibrary(collections.abc.MutableSequence):
    ...
    @property
    def sample_names(self) -> NDArray[Str0]:
        return np.array([samp.name for samp in self.samples])

    @property
    def unique_phase_names(self) -> NDArray[Str0]:
    ...
    @property
    def multi_sample_phase_names(self) -> NDArray[Str0]:
        """
