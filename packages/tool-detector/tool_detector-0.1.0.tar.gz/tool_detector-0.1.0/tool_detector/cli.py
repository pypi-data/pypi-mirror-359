"""Command-line interface for tool-detector."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Tool Detector - Parse natural language into structured tool calls",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  tool-detector "calculate 2 + 2"
  tool-detector "weather in London" --json
  tool-detector --schema-only
        """,
    )
    ...
    try:
        ...
        if args.verbose:
            ...
            print("Error occurred during tool detection", file=sys.stderr)
        sys.exit(1)
