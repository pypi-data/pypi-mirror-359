...
class ComputerUseClient:
    ...
    def __init__(self, base_url: str = "http://localhost:8102", api_version: str = "2020-04-01", auth_key: str = ""):
        ...
        self.headers = {
            ...
            "Authorization": os.getenv('TOOL_SERVER_AUTH_KEY') or auth_key or '',
        }
...
def new_computer_use_client(endpoint: str, auth_key: str = "") -> ComputerUseClient:
    return ComputerUseClient(base_url=endpoint, auth_key=auth_key)