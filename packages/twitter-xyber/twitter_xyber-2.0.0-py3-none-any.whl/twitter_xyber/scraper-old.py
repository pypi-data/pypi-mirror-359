...
class TwitterScraper:
    ...
    def timeline_tweet(self, username: str, tweet_count: int = 80) -> dict:
        ...
        with sync_playwright() as pw:
                ...
                for tr in tweet_result:
                    try:
                        if any("tweet" in s for s in tr['entryId'].split("-")):
                            ...
                            tweet_hashtag = legacy['full_text']
                            hashtags_data = re.findall(r'#\w+', tweet_hashtag)  # Mencari hashtag dalam teks
                            hashtags_counter.update(hashtags_data)
            ...
            context.close()
            browser.close()
            return {"timeline": timeline, "hashtags": hashtags_results}
...
if __name__ == "__main__":
    ...
    # twitter_bot.login()
    result = twitter_bot.timeline_tweet("BangPino__")
