            ...
            for sr in search_result:
                try:
                    ...
                    users.append({
                        ...
                        "screen_name" : legacy['core']['screen_name'],
                        ...
                        "avatar" : legacy['avatar']['image_url'],
                        "created" : legacy['core']['created_at'],
                    })
                except:
                    pass
...
if __name__ == "__main__":
    ...
    twitter_bot = TwitterScraper(headless=True, username='YonduStarlord9', password='YonduStarlord9!@#')
    # twitter_bot.login()

    # Call the login method to execute the login process
    # twitter_bot.login()
    # result = twitter_bot.timeline_tweet("Mdy_Asmara1701")
    ...
    result = twitter_bot.search_user("prabowo")
