<a id="types-boto3-odb"></a>

# types-boto3-odb

[![PyPI - types-boto3-odb](https://img.shields.io/pypi/v/types-boto3-odb.svg?color=blue)](https://pypi.org/project/types-boto3-odb/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-odb.svg?color=blue)](https://pypi.org/project/types-boto3-odb/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-odb)](https://pypistats.org/packages/types-boto3-odb)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Odb 1.39.1](https://pypi.org/project/boto3/)
...
[types-boto3-odb docs](https://youtype.github.io/types_boto3_docs/types_boto3_odb/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-odb](#types-boto3-odb)
...
- Install `types-boto3[odb]` in your environment:
...
- Install `types-boto3[odb]` with services you use in your environment:
...
`types-boto3-odb` dependency in production. However, there is an issue in
...
from types_boto3_odb import OdbClient
...
`types_boto3_odb.paginator` module contains type annotations for all
paginators.
...
`types_boto3_odb.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `Odb` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_odb/literals/).
...
`types_boto3_odb.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `Odb` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_odb/type_defs/).
...
`types-boto3-odb` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_odb/)
