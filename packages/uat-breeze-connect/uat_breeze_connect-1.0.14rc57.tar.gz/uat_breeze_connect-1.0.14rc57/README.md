...
```
pip install breeze-connect==1.0.14rc57
```
<hr>
...
<p><ol><li>Order Type should be either "limit" or "market". </li>
       <li>The validity date parameter is a placeholder and has no effect on order execution. </li></ol></p>
<a href="#index">Back to Index</a>
...
<h4> NOTE: </h4>
<p><ol><li>The validity date parameter is a placeholder and has no effect on order execution. </li></ol></p>
...
<h4> NOTE: </h4>
<p><ol><li>The validity date parameter is a placeholder and has no effect on order modification. </li></ol></p>
...
<h4> NOTE: </h4>
<p><ol><li>The validity date parameter is a placeholder and has no effect on square off. </li></ol></p>
