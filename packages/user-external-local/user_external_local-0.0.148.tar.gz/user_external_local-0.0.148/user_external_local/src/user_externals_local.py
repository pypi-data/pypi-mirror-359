...
class UserExternalsLocal(GenericCrudMysql, metaclass=MetaLogger, object=object_init):
    ...
    def insert_or_update_user_external_access_token(
        ...
        *,
        ...
        self.logger.deprecation_warning(
            old_name="insert_or_update_user_external_access_token",
            new_name="upsert_user_external_access_token",
        )

        user_external_updated_inserted_id = self.upsert_user_external_access_token(
    ...
    def upsert_user_external_access_token(
        self,
        *,
        profile_id: int,
        system_id: int,
