...
class TestWindow(VFXWindow):
    ...
    def __init__(self, **kwargs):
        ...
        if self.application == 'Maya':
            ...
            self.callbacks.add('texture.export', lambda evt: print('texture.export (message={!r}, status={!r}, textures={!r})'.format(evt.message, evt.status, evt.textures)))
            self.callbacks.add('texture.export.before', lambda evt: print('texture.export.before (textures={!r})'.format(evt.textures)))
            self.callbacks.add('texture.export.after', lambda evt: print('texture.export.after (message={!r}, status={!r}, textures={!r})'.format(evt.message, evt.status, evt.textures)))
