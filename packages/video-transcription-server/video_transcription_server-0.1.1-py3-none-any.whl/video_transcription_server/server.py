...
async def download_video(url: str, output_path: str, cookies_from: str = None) -> str:
    ...
    if cookies_from:
        ...
        logger.info(f"Usando cookies do navegador: {cookies_from}")
...
async def handle_call_tool(name: str, arguments: dict):
    ...
    if name == "transcribe_video":
        ...
        try:
            ...
            cookies_from = arguments.get("cookies_from", None)
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                # Download
                video_path = await download_video(url, temp_dir, cookies_from)
