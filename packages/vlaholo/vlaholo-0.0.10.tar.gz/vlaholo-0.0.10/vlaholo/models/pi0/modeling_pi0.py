...
class PI0Policy(PreTrainedPolicy):
    ...
    def __init__(
        ...
        if not os.path.exists('checkpoints/paligemma-3b-pt-224'):
            ValueError(f'checkpoints/paligemma-3b-pt-224 not found! download from google/paligemma-3b-pt-224')
        self.language_tokenizer = AutoTokenizer.from_pretrained(
            "checkpoints/paligemma-3b-pt-224"
        )
