...
class Reference:
    ...
    def __init__(self, target_collection_name:str, description:str, way_type:str=Reference_Type.ONEWAY, reference_type=Reference_Type.SINGLE, required:bool=False, auto_loading:bool=False, skip_validation:bool=False):
        """
