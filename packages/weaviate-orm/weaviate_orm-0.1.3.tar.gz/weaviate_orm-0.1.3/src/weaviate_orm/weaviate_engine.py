...
class Weaviate_Engine:
    ...
    def __init__(self, connection_method=None, timezone_offset:Optional[timedelta]=None, **connection_params):
        """
        """

        self._set_connetion_method(connection_method, **connection_params)
    ...
    def _set_connetion_method(self, connection_method: Optional[Callable] = None, **connection_params):
        """
        ...
        if return_type is not weaviate.WeaviateClient and return_type is not None:
            ...
            self._connetion_method : Callable = connection_method

    def _set_timezone_offset(self, timezone_offset: Optional[timedelta] = None):
        """
        Set the timezone offset for the WeaviateEngine to use when interacting with Weaviate.
        
        Args:
            timezone_offset (Optional[timedelta]): The timezone offset to use when interacting with Weaviate.
        """
    ...
    def client(self):
        ...
        if self._client is None or not self._client.is_connected():
            self._client = self._connetion_method(**self._connection_params)
