...
class WebRecruitmentSDK(SyncAPIClient):
    ...
    _environment: Literal["local", "production", "staging"] | NotGiven

    def __init__(
        self,
        *,
        bearer_token: str | None = None,
        environment: Literal["local", "production", "staging"] | NotGiven = NOT_GIVEN,
    ...
    def copy(
        ...
        *,
        bearer_token: str | None = None,
        environment: Literal["local", "production", "staging"] | None = None,
