...
import aiohttp
from whisper_transcriber.service import transcribe_audio, save_upload_file, delete_file
from whisper_transcriber.models import TranscriptRequest, ResponseModel
