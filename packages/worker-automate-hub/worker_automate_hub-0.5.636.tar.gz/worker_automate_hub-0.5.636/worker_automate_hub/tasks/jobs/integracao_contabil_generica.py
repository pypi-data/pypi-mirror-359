            ...
            while True:
                try:
                    ...
                    try:
                        ...
                        msgbox = app.window(class_name="TMsgBox")
                        msgbox.set_focus()

                        clicou = False
                        for btn in msgbox.descendants(control_type="Button"):
                            texto = btn.window_text().strip().lower()
                            if "ok" in texto:
                                console.print(f"[green]Clicando no botão OK: {texto}[/green]")
                                btn.click_input()
                                clicou = True
                                break
                        ...
                        if clicou:
                            ...
                            console.print("[yellow]Botão OK não encontrado ainda.[/yellow]")
