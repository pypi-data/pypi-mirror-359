        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "keyword": {
                        "type": "string",
                        "description": "可选模糊查询关键词，不传入该参数默认查询所有漏洞",
                    },
                    "cve":{
                        "type": "string",
                        "description":"可选漏洞的cve编号,可以不传该参数"
                    },
                    "publishTimeStart":{
                        "type": "string",
                        "description":"可选起始时间，查询起始时间后的漏洞,格式为yyyy-MM-dd HH:mm:ss"
                    },
                    "publishTimeEnd":{
                        "type": "string",
                        "description":"可选截止时间，查询截止时间前的漏洞,格式为yyyy-MM-dd HH:mm:ss"
                    },
                    "vulnType":{
                        "type": "string",
                        "description":"漏洞类型，可有可无，默认情况下不传该参数会查询所有类型"
                    },
                    "riskLevels":{
                        "type": "list",
                        "description":"可选漏洞等级，类型为list,，其中只允许\"serious\",\"high_risk\",\"medium_risk\",\"low_risk\",\"unknown\"这五个元素存在，按顺序分别代表\"严重，高危，中危，低危，未知\"。"
                    },
                    "resultSize":{
                        "type": "int",
                        "description":"可选返回漏洞条数，默认情况下返回十条，resultSize的值只能是1-100。"
                    },
                },
            }
        )
...
app._mcp_server.list_tools()(list_tools)
