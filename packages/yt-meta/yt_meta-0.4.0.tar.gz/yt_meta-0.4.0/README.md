...
### 🚀 Video Transcripts and Overhauled Comment System

This release introduces video transcript fetching and includes a complete rewrite of the comment fetching system.

**Key Improvements:**
- ✅ **Video Transcripts**: Fetch video transcripts (subtitles) with language support.
- ✅ **Native Comment Fetching**: Replaced external dependencies with a native implementation for comments and replies, achieving 100% browser parity.
- ✅ **Enhanced Metadata**: Added more metadata for comments, including `author_channel_id`, `author_avatar_url`, and `reply_count`.
- ✅ **Improved Performance and Reliability**: Numerous bug fixes and performance enhancements.
