"""
TODO: Please, improve this code, make it
lighter and improve the functionality.

TODO: Rename to 'generator.py'? If so, 
also the one in 'yta_audio_music' (?)
"""
from yta_audio_base.silences import AudioSilence
from yta_audio_sounds.resources.drive_urls import TYPING_KEYBOARD_3_SECONDS_GOOGLE_DRIVE_DOWNLOAD_URL
...
class SoundGenerator:
    ...
    # TODO: Make this possible with another library
    # and not moviepy (if possible)
