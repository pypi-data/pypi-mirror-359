...
"""
from yta_video_editor.moviepy.duration import set_video_duration
from yta_video_editor.video.settings import COLOR_TEMPERATURE_LIMIT, COLOR_HUE_CHANGE_LIMIT, BRIGHTNESS_LIMIT, CONTRAST_LIMIT, SHARPNESS_LIMIT, WHITE_BALANCE_LIMIT
from yta_video_editor.moviepy.duration.enums import EnshortVideoMode, ExtendVideoMode
from yta_video_editor.video.attribute_modifier import VideoWrappedAttributeModifier
...
from yta_multimedia_core.video.video_wrapped import VideoWrapped as BaseVideoWrapped
...
class VideoWrapped:
    ...
    def color_temperature(
        ...
        """
        The color temperature we want in the video.
        A value of None means no modification while
        another value means that it would be used to
        modify the video.
        """
    ...
    def color_temperature(
        self,
        value: Union[VideoWrappedAttributeModifier, None] = None
    ) -> None:
        """
        Set the modifier of the 'color_temperature'
        attribute, that will be set to generate, when
        needed, the values for each of the frames 
        this video has.
        """
    ...
    def color_hue(
        ...
        """
        The color hue we want in the video. A value
        of None means no modification while another
        value means that it would be used to modify
        the video.
        """
    ...
    def color_hue(
        ...
        """
        Set the modifier of the 'color_hue' attribute,
        that will be set to generate, when needed, the
        values for each of the frames this video has.
        """
        _validate_is_video_attribute_modifier_instance(value)
        _validate_attribute_modifier(value, 'color_hue', COLOR_HUE_CHANGE_LIMIT, self.number_of_frames)

        self._color_hue = value.get_values(self.number_of_frames)
    ...
    def brightness(
        ...
        """
        The brightness we want in the video. A value
        of None means no modification while another
        value means that it would be used to modify
        the video.
        """
    ...
    def brightness(
        ...
        """
        Set the modifier of the 'brightness' attribute,
        that will be set to generate, when needed, the
        values for each of the frames this video has.
        """
        _validate_is_video_attribute_modifier_instance(value)
    ...
    def contrast(
        ...
        """
        The contrast we want in the video. A value
        of None means no modification while another
        value means that it would be used to modify
        the video.
        """
    ...
    def contrast(
        ...
        """
        Set the modifier of the 'contrast' attribute,
        that will be set to generate, when needed, the
        values for each of the frames this video has.
        """
        _validate_is_video_attribute_modifier_instance(value)
    ...
    def sharpness(
        ...
        """
        The sharpness we want in the video. A value
        of None means no modification while another
        value means that it would be used to modify
        the video.
        """
    ...
    def sharpness(
        ...
        """
        Set the modifier of the 'sharpness' attribute,
        that will be set to generate, when needed, the
        values for each of the frames this video has.
        """
        _validate_is_video_attribute_modifier_instance(value)
    ...
    def white_balance(
        ...
        """
        The white balance we want in the video. A
        value of None means no modification while
        another value means that it would be used to
        modify the video.
        """
    ...
    def white_balance(
        ...
        """
        Set the modifier of the 'white balance'
        attribute, that will be set to generate, when
        needed, the values for each of the frames this
        video has.
        """
        _validate_is_video_attribute_modifier_instance(value)
    ...
    def final_video(
        ...
        def modify_video_frame_by_frame(
            ...
            """
            frame = get_frame(t)
            frame_index = VideoFrameTHandler.frame_time_to_frame_index(t, moviepy_video.fps)
        ...
        def modify_audio_frame_by_frame(
            ...
            frame = get_frame(t)
            frame_index = VideoFrameTHandler.get_video_frame_index_from_video_audio_frame_t(t[len(t) // 2], moviepy_video.fps)

            from yta_audio_editor.audio import Audio
