import argparse
from devtools_cli import info, venv_utils, requirements, project_scan, watcher
from devtools_cli import scripts
from devtools_cli.docs_generator import scan_directory_for_docs, generate_markdown_docs
from devtools_cli.utils import is_stdlib_module, detect_venv
import subprocess
import os
import sys
...
def main():
    ...
    if args.command == "info":
        ...
        docs = scan_directory_for_docs("devtools_cli")
